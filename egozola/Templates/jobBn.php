...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ XXXX offre d'emploi: Trouve et Cherche du travaile ou un emploi rapidement au Bénin sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez rapidement une offre d’affaire ou XXXX <?php echo date("Y"); ?> partout au Bénin avec l'application <strong>eGoZola gratuite </strong>
