...
<div class="row" style="font-family: Calibri;margin-top: 30px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
         ...
         <strong style="color: black"> Pour  voir plus des offres d'emplois et d'affaires en Côte d'ivoire, téléchargez notre application gratuite </strong>  <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ XXXX offre d'emploi: Trouve et Cherche du travaile ou un emploi rapidement en Cote d'ivoire sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez rapidement une offre d’affaire ou XXXX <?php echo date("Y"); ?> partout en Cote d'ivoire avec l'application <strong>eGoZola gratuite </strong>
