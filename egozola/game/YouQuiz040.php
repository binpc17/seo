...
<head> 
 ...
 <title>How to Find free unlimited General knowledge quiz multiple choice <?php echo date("Y"); ?> ?</title>
  <meta name="description" content="Get the full General knowledge quiz multiple choice, Play & enrich your knowledge. Download YouQuiz App General knowledge quiz multiple choice for full access and much more every where you go!"/>
  <meta name="keywords" content="General knowledge quiz multiple choice, YouQuiz"/>  
...
<div style="background-color: #5e5e5e;height: 2px;width: 100%;margin-top: 10px"></div>
        <div class="row"  style="text-align: center;border-top: 1px solid #ccc" >
          <div class="col-xs-6" style="border-right: 1px solid #ccc">
            <a href="https://egozola.com/GooglePlayQuiz.php?hl=fr&apId=old" style="color: black">
            <img src="./assets/game.png" style="width:45px;height:45px" class="img-rounded"  alt="General knowledge quiz multiple choice"><br>
 ...
 <div style="text-align:center"> <h1>Get the Best General knowledge quiz multiple choice for free: </h1> </div> 
<br><span class="glyphicon glyphicon-ok-sign"> </span>✓ Find More than 12,000 General knowledge quiz multiple choice in English for free
<br><span class="glyphicon glyphicon-ok-sign"> </span>✓ Play for free and enjoy the General knowledge quiz multiple choice, online trivia quiz for endroid
<br><span class="glyphicon glyphicon-ok-sign"> </span>✓ Are you looking for General knowledge quiz multiple choice get it now for free and get full access using your phone,
<br><span class="glyphicon glyphicon-ok-sign"> </span>✓ General knowledge quiz multiple choice aviable on all mobiles and tablets with Android operating system.
...
<div style="background-color: #5e5e5e;height: 2px;width: 100%"></div>
   <a href="https://egozola.com/GooglePlayQuiz.php?hl=fr&apId=old" style="color: black">
          <div style="text-align: center">
      <strong>Get the free unlimited  General knowledge quiz multiple choice and much more, download our App </strong> <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
            <img src="assets/playStor.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
