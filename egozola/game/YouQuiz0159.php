...
<head> 
 ...
 <title>How to Find free unlimited XXXX <?php echo date("Y"); ?> ?</title>
  <meta name="description" content="Get the full XXXX, Play & enrich your knowledge. Download YouQuiz App XXXX for full access and much more every where you go!"/>
  <meta name="keywords" content="XXXX, YouQuiz"/>  
...
<body style="background-color: whitesmoke;margin-top: 30px">
   <a href="https://egozola.com/GooglePlayQuiz.php?hl=fr&apId=old" style="color: black">
      ...
      <strong>Hey! Get our best XXX games and much more. Download our free app</strong> <strong style="color: darkgreen"> Click here↓↓ </strong> <br>
...
<div style="background-color: #5e5e5e;height: 2px;width: 100%"></div>
 ...
 <div style="text-align:center"> <h1>Get the Best XXXX for free: </h1> </div> 
<br><span class="glyphicon glyphicon-ok-sign"> </span>✓ Find More than 12,000 XXXX in English for free
<br><span class="glyphicon glyphicon-ok-sign"> </span>✓ Play for free and enjoy the XXXX, online trivia quiz for endroid
<br><span class="glyphicon glyphicon-ok-sign"> </span>✓ Are you looking for XXXX get it now for free and get full access using your phone,
<br><span class="glyphicon glyphicon-ok-sign"> </span>✓ XXXX aviable on all mobiles and tablets with Android operating system.
<br><span class="glyphicon glyphicon-ok-sign"> </span>✓ It is completely free! Find XXXX Play and enrich your knowledge <a href="https://egozola.com/GooglePlayQuiz.php?hl=fr&apId=old" style="color:black"> <strong>Get it now <span class="glyphicon glyphicon-hand-right"></span>   Click here ↓↓ </strong> </a>.
			<br>
			<br>
<div style="background-color: #5e5e5e;height: 2px;width: 100%"></div>
   <a href="https://egozola.com/GooglePlayQuiz.php?hl=fr&apId=old" style="color: black">
          <div style="text-align: center">
      <strong>Get the free unlimited  XXXX and much more, download our App </strong> <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
            <img src="assets/playStor.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
