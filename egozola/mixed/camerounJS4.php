...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'Cameroun','JS',' $lang','$mob',4,'ZOLA',NOW())");
    $ps->execute();
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
   <title>Emploi et Easy job cameroun <?php echo date("Y"); ?> à douala, Yaoundé |eGoZola</title>
  <meta name="description" content="✓ Découvrez, Postulez en ligne aux Offre d'emploi et d'affaires: easy job cameroun <?php echo date("Y"); ?> à douala sur eGoZola. Télécharger l'application!"/>
  <meta name="keywords" content="Easy job cameroun"/>
...
?>  
        <div style="margin-top: 30px"></div>	 
          <div style="text-align: center">
		   <a href="<?php echo $botUrl?>" >
            <strong style="color: black">Pour Obtenir toutes les Offres d'emploi et d'Affaire au Caméroun dans ton téléphone </strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>
 ...
 <div style="text-align:center"> <h1> Emploi & Easy job cameroun <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Easy job cameroun <?php echo date("Y"); ?>: Trouve et Cherche travail ou une affaire rapidement à douala, Yaoundé et partout sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Retrouvez ou cherche travaile rapidement et des offre d'emploi et easy job cameroun <?php echo date("Y"); ?>. 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Publier ton annonce, vendez ton savoir et tes services et gagnez de l'argent. Retrouvez des partenaires d'affaire avec l'application eGoZola easy job cameroun <?php echo date("Y"); ?>
  <br> <span class="glyphicon glyphicon-tags"> </span>✓ Easy job cameroun <?php echo date("Y"); ?>. Retrouvez la personne, le travail ou l'affaire qu’il vous faut ou un service à domicile à Douala et Yaoundé.
