...
if($lang>0){
 ...
 if($uDev>0){
  ...
  if($lang!==''){
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (212,'Maroc','SHOP',' $lang','$mob',1,'ZOLA',NOW())");
        $ps->execute();
...
<head>
  ...
  <title>Avito Vente privée, Acheter ou Vendre en ligne au Maroc, Rabat, Marrakech mes produits |eGoZola</title>
  <meta name="description" content="✓ Publier tes produits sur eGoZola Avito, acheter ou Vendre en ligne au Maroc, Rabat, Marrakech, Fès? Trouvez un Client. Vente privée & Achat au Maroc"/>
   <meta name="keywords" content="Avito Vente privée,  Vendre en ligne au Maroc, vendre mes produits "/>
...
<div style="height: 3px;border: 0;border-top: 1px;width:100%;background-color:#ccc"></div>
	  ...
	  <div style="text-align:center"> <h1>Avito Vente privée ou acheter mes produits à Rabat, Marrakech</h1> </div> 
 <br>  <span class="glyphicon glyphicon-tags"> </span> ✓ site web eGoZola Avito d'achat & vente privée à Rabat, Marrakech, Fès et partout au Maroc.
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>  ✓ Trouvez rapidement un client, un preneur pour tes services, véhicule, voiture et produits à vendre à Rabat, Marrakech, Fès ou au Maroc.
 <br>  <span class="glyphicon glyphicon-tags"> </span> ✓ Retrouvez des offres d’affaires, vente privée en ligne de véhicules, voiture, téléphone, ordinateur et autres produits facilement partout au Maroc.
 <br>   <span class="glyphicon glyphicon-tags"> </span>  ✓ eGoZola, le meilleur outil et centre de facilitations des affaires & d’emplois, location et vente privée des produit et services sur Avito à Rabat. 
