...
<head> 
 ...
 <!-- 100K emploi jeune,
  10K offre d emploi -->
 <title>Educarriere Emploi jeune ci à Abidjan, Cote d’ivoire |eGoZola</title>
  <meta name="description" content="✓ Postulez aux d’offres educarriere emploi jeune ci et recrutement à Abidjan et à Yamoussoukro Cote d’ivoire. Télécharger notre application"/>
...
<div class="row" style="font-family: Calibri">
  ...
  <div class="col-md-7" >
    <h4 style="margin-left: 15px;margin-top: 50px">Bienvenue sur eGoZola Educarriere<span class="glyphicon glyphicon-hand-right"></span></h4>
    <div style="margin-left: 20px;margin-top: 12px">
	          <div style="text-align: center">
		   <a href="<?php echo $botUrl?>" >
            <strong style="color: black"> Pour Obtenir toutes les Offres d'emploi et d'Affaire en Cote d'ivoire dans ton téléphone, téléchargez notre application gratuite</strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>			
      ...
      <div style="text-align: center"> <a href="<?php echo $botUrl?>" style="color: black"><strong>Télécharger & installer nos Outils  <span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="<?php echo $botUrl?>" >
          <div style="text-align: right">
            <strong style="color: black"> Pour Obtenir toutes les Offres d'emploi et d'Affaire en Cote d'ivoire dans ton téléphones, téléchargez notre application gratuite </strong>  <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
 <div style="text-align:center;margin-top: 10px"> <h1> Educarriere emploi ci jeune à Abidjan</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Educarriere emploi ci: Trouve et Cherche travaile ou un emploi rapidement à Abidjan Cote d’ivoire sans vous déplacer sur eGoZola
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail jeune sur Educarriere ci
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Publier ton annonce, vendez ton savoir et tes services et gagnez de l'argent. Retrouvez des partenaires d'affaire avec l'application eGoZola
  <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez la personne, le travail ou l'affaire qu’il vous faut ou un service à domicile sur offres offres Educarriere emploi ci à Abidjan, Yamoussoukro. 
