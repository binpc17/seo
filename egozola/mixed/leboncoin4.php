...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (33,'France','AT',' $lang','$mob',4,'ZOLA',NOW())");
    $ps->execute();
...
-->
  ...
  <base href="/">
  <title> Leboncoin44: Business, emploi, immo et location & Vente privée |eGoZola</title>
  <meta name="description" content="✓ Retrouvez ou Publier ton annonce: Leboncoin44: Business, emploi, immo et location voiture, appartement & Maison à vendre à moins cher à Paris, Marseille, Lyon et partout France. Télecharger l'application "/>
    ...
    <div style="margin-left: 20px;margin-top: 12px">
       ...
       Offres d'Emploi & Services  </label>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          ...
          Pour Obtenir toutes les Offres d'emploi et d'Affaire en France, Téléchargez notre application mobile gratuite <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
...
<div style="text-align:center"> <h1>Leboncoin44: Business, emploi, immo & location</h1></div>  
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Leboncoin44: Trouve et Cherche emploi ou une affaire rapidement à Paris, Marseille, Lyon et partout France sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola Leboncoin44: Publier ton annonce, vendez ton savoir et tes services et gagnez de l'argent. Retrouvez des partenaires d'affaire avec l'application eGoZola
  <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez la personne, le travail ou l'affaire qu’il vous faut ou un service à domicile sur Leboncoin44 en France: à Paris, Marseille, Lyon 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi et des affaires Leboncoin44 autour de moi sur eGozola et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
