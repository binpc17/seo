...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (212,'Maroc','HS',' $lang','$mob',1,'ZOLA',NOW())");
   $ps->execute( array());
  }  
 }else{
	 $mob="Web";
...
<head>
  ...
  <base href="/">
 <title> Avito Vente, Location appartement & Maison à louer ou à vendre au Maroc  |eGoZola</title>
  <meta name="description" content="✓ Publier ton annonce. Avito Maison, appartement à Vendre, à louer ou location & vente appartement à Rabat, Marrakech, Fès, Maroc ✓ Gangez confidentiellement ton argent"/>
  <meta name="keywords" content="Avito Vente, Location appartement, Maison à louer, Maison à vendre"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
	...
	<?php   
$ps=$pdo->prepare("SELECT idHouse,sizeV,type,roomSize,hsTitle,price,currency,town,commune,countryCD,photo1 FROM housedb WHERE idHouse>9 AND dateExp >= (select UNIX_TIMESTAMP()) ORDER BY idHouse DESC LIMIT 0,15");
$ps->execute();
...
$urlWS="https://www.egozola.com/hsView.php";
	foreach ($liste as $subjectData) {
      echo '<tr style="height:115px;width: 100%" ><td>  <a href="https://egozola.com/GooglePlay.php?hl=fr&apId=oldP" target="_blank" style="color: black"> '; 
...
<div style="height: 3px;border: 0;border-top: 1px;width:100%;background-color:#ccc"></div>
       ...
       <a href="https://wa.me/243999209870?text=Bonjour_Google_%20%20Obtenir%20de%20l%27aide.%20Je%20n%27arrive%20pas%20%C3%A0%20t%C3%A9l%C3%A9charger%20l%27application"> <div style="text-align: right"> Email: <strong> info@egozola.com</strong> <br> <button  style="background-color: darkgreen;color: white;border-radius: 10px;" > Message WhatsApp<em> <span class="glyphicon glyphicon-phone" ></span>    :</em> </button></div> </a>
			 ...
			 <div style="text-align:center"> <h1>Avito Vente privée et Location appartement, terrain et Maison au Maroc </h1> </div> 
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Site web de vente privée & location appartement à Rabat, Marrakech, Fès et partout au Maroc.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Recherchez-vous un locateur? Publier gratuitement ton appartement ou terrain à vendre ou à faire louer au Maroc sur eGoZola. Faites des affires et gagner des clients et de l'argent
<br><span class="glyphicon glyphicon-tags"> </span> ✓ eGoZola, le meilleur outil et centre de facilitations des affaires, location avito appartement, des maisons et terrain à vendre ou à louer au Maroc. Publier ton annonce gratuitement et ton vœux sera exaucer en quelques minutes. 
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Trouvez facilement une vente privées d'appartement, une maison à louer ou un terrain a vendre à moins chère rapidement et facilement à Rabat, Marrakech, Fès ou au Maroc sur eGoZola avito . Télécharger et utiliser notre application gratuitement <a href="https://egozola.com/GooglePlay.php?hl=fr&apId=old" style="clolor:black"> <strong> Cliquer ici↓↓ </strong> </a>.  
