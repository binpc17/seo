...
<head>
  ...
  <base href="/">
  <title>Location appartement & Maison à louer ou à vendre à Abidjan, Yamoussoukro locanto</title>
  <meta name="description" content="✓ Publier ton annonce: Location ou vente d'un appartement, une maison à louer ou à Vendre à Abidjan sur locanto, Yamoussoukro? Retrouvez un locateur rapidement"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    ...
    <div style="margin-left: 20px;margin-top: 12px">
      ...
      <strong style="color: black"> Pour  voir plus d'appartments & maison à Abidjan, téléchargez notre application gratuite</strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br> 
