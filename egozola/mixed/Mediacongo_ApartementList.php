...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (243,'MediaC','HS',' $lang','$mob',2,'ZOLA',NOW())");
    $ps->execute();
...
<title>Appartement & maison à louer à kinshasa 200$, 100$, 50$ et à Lubumbashi Goma</title>
  <meta name="description" content="✓ Publier ton annonce: vente terrain, appartement et maison à louer à kinshasa 200$, 100$, 50$ à louer à Kinshasa, Lubumbashi ou à Goma? Trouvez un locateur. Télécharger l'application"/>
...
$urlWS="https://www.egozola.com/hsView.php";
	/* '.$urlWS.'/'.$subjectData["idHouse"].'/HS/'.$subjectData["type"].'/DSP
	
	*/
	foreach ($liste as $subjectData) {
      echo '<tr style="height:115px;width: 100%" ><td>  <a href="'.$botUrl.'" style="color: black"> '; 
      echo '<img src='.$urlImg.'/'.$subjectData["type"].'/'.$subjectData["photo1"].' width="133px" height="112px" class="img-rounded"> </a></td>';
       echo ' <td style="width: 100%"> <p style="width: 100%" >';
        ...
        echo '<a href="'.$botUrl.'" style="color: black">';
...
<div style="height: 3px;border: 0;border-top: 1px;width:100%;background-color:#ccc"></div>
       ...
       <strong style="color: black"> Pour  voir plus d'appartments & maison, téléchargez notre application gratuite</strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="maison à louer à kinshasa"> </a>
          </div>
...
<div style="text-align:center"> <h1>Vente terrain ou maison à louer à kinshasa 200$, 100$, 50$ </h1> </div> 
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Site web pour vendre une maison à louer à kinshasa 200$, 100$, 50$ ou à Lubumbashi, Goma et partout en RDC.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Recherchez-vous un locateur? Publier gratuitement ton appartement ou terrain à vendre une maison à louer à kinshasa 200$, 100$, 50$ sur eGoZaola. Faites des affires et gagner des clients et de l'argent
<br><span class="glyphicon glyphicon-tags"> </span> ✓ eGoZola, le meilleur outil et centre de facilitations des affaires, maison à louer à kinshasa ou terrain à vendre en République Démocratique du Congo, RDC. Publier ton annonce gratuitement et ton vœux sera exaucer en quelques minutes. 
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Trouvez facilement une vente privée d'appartement, une maison à louer à kinshasa 200$, 100$, 50$ ou un terrain a vendre à moins chère rapidement et facilement à Lubumbashi, Goma sur eGoZola. Télécharger et utiliser notre application gratuitement <a href="<?php echo $botUrl?>" style="clolor:black"> <strong> Cliquer ici↓↓ </strong> </a>.  
