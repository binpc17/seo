...
if($lang>0){
 ...
 $lang =explode( ',', $_SERVER['HTTP_ACCEPT_LANGUAGE'] )[0];
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (225,'eduCa','locanto',' $lang','$mob',2,'ZOLA',NOW())");
    $ps->execute();
...
<head>
 ...
 <title>Locanto ci: Vente privée, Acheter ou Vendre en ligne à Abidjan, Yamoussoukro |eGoZola</title>
  <meta name="description" content="✓ Publier ton annonce: acheter ou Vendre en ligne tes produits à Abidjan, Yamoussoukro sur Locanto ci eGoZola. Trouvez un Client rapidement. Télécherger l’application gratuitement"/>
...
<?php
if($lang>20){
      echo "<script> var timer = null; function homeData(){ window.location = 'https://egozola.com/locantoCi.php?level=10';} </script>";
