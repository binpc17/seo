...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'eduCa','JS',' $lang','$mob',4,'ZOLA',NOW())");
        $ps->execute();
...
<head>
 ...
 <title>www.ayeler.com recrutement et Offres d'emploi <?php echo date("Y"); ?> au burkina |eGoZola</title>
  <meta name="description" content="✓ Postulez en ligne aux d’offres d'affaires et d'emploi sur eGoZola www.ayeler.com recrutement sans vous déplacer à Ouagadougou sur ton téléphone. Télécharger l'application"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
		...
		<p></p>     
	<?php   
		//$urlWS="https://egozola.com/jobService.php?type=dsp&id=".$subjectData['idJobS'];
		$urlWS=$botUrl;
...
?>
 ...
 <div style="text-align:center"> <h1>www ayeler com recrutement <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ www.ayeler.com recrutement: Postulez! Cherchez une offre d'emploi ou d'affaire à Ouagadougou sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou de travail sur eGoZola www ayeler com recrutement à Ouaga et partout au burkinafaso
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Cherche travaile rapidement et retrouvez un emploi sur eGoZola.
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ www.ayeler.com recrutement: vendez tes services ou ton savoir. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Business.
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi www.ayeler.com recrutement <?php echo date("Y"); ?> au burkina autour de moi à Ouagadougou et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
