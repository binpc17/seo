...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'eduCa','JS',' $lang','$mob',3,'ZOLA',NOW())");
        $ps->execute();
...
<head>
 ...
 <title>Cherche un trvail? Ayeler emploi burkina <?php echo date("Y"); ?> |eGoZola</title>
  <meta name="description" content="✓ Postulez en ligne aux d’offres d'affaires et d'emploi sur eGoZola Ayeler emploi burkina <?php echo date("Y"); ?> sans vous déplacer à Ouagadougou sur ton téléphone. Télécharger l'application"/>
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
     ...
     <strong style="color: black">Hey! Obtenez toutes les offres d'Emploi et d'Affaires au Burkina Faso dans ton téléphone et bien plus encore, téléchargez notre application gratuite </strong>  <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
        ...
        <h4 style="color:darkgreen;text-align: center;"> <strong>Offre Emploi <?php echo date("Y"); ?> & Affaires disponnible</strong></h4> 
...
?>
        <div style="margin-top: 30px"></div>
          ...
          <div style="text-align: center">
          <strong style="color: black"> Pour Obtenir toutes les Offres d'emploi et d'affaires au Burkina faso dans ton téléphones, téléchargez notre application gratuite</strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>
         <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="Ayeler emploi burkina <?php echo date("Y"); ?>">
          </div>
        </a>
 ...
 <div style="text-align:center"> <h1>Ayeler emploi burkina <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Ayeler emploi burkina <?php echo date("Y"); ?>: Postulez! Cherchez une offre d'emploi ou d'affaire à Ouagadougou sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou de travail sur eGoZola ayeler emploi burkina <?php echo date("Y"); ?> à Ouaga et partout au burkinafaso
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Cherche travaile rapidement et retrouvez un emploi sur eGoZola.
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Ayeler emploi burkina <?php echo date("Y"); ?>: vendez tes services ou ton savoir. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Business.
  <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez la personne, le travail ou l'affaire qu’il vous faut ou un service à domicile avec eGoZola ayeler emploi burkina dans ton téléphone. 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi et recrutement en <?php echo date("Y"); ?> autour de moi à Ouagadougou et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
