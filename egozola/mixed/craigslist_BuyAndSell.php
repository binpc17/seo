...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (1,'Craigs','SHOP1',' $lang','$mob',8,'ZOLA',NOW())");
    $ps->execute();
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
   <title>Craigslist houses for rent & best buy near me, Sell your product |eGoZola</title>
  <meta name="description" content="✓ Post, find houses for rent or best buy deals near me on craigslist free classified Ads, sell for free every where in USA and make money "/>
  <meta name="keywords" content="Post & quicksell online for free,best buy deals near me, free classified Ads, craigslist"/>
...
<?php
if($lang>0){
      echo "<script> var timer = null; function homeData(){ } </script>";
  ...
  <div class="col-md-7" >
	   <a href="https://egozola.com/GooglePlay.php?hl=fr&apId=old" style="color: black">
          <div style="text-align: center">
            <strong>Hey!Get and find more Best buy deals near me, download our free Android app </strong> <strong style="color: darkgreen"> Click here ici ↓↓ </strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="job alert eGoZola">
          </div>
        </a>
    <div style="margin-left: 20px;margin-top: 12px">
       <h4 style="color:darkgreen;text-align: center;"> <strong> Best buy deals near me Avilable</strong></h4> 
...
<div style="height: 3px;border: 0;border-top: 1px;width:100%;background-color:#ccc"></div>
        <div style="margin-top: 30px"></div>
          ...
          <div style="text-align: center">
            <strong> To Get and find more Best buy deals near me, download our free Android app</strong> <strong style="color: darkgreen"> Click here ici ↓↓ </strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="job alert eGoZola">
          </div>
        </a>
  ...
  <div style="text-align:center"> <h1> Craigslist houses for rent & best buy near me</h1> </div> 
 <br>  <span class="glyphicon glyphicon-tags"> </span> ✓ Craigslist app for quick sell online your product or service for free every where in USA.
 <br><span class="glyphicon glyphicon-tags"> </span> ✓ Find quickly the Cheap best buy deals near me using your smartphone in chicago, Boston, seattle
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Pots or Sell online your deals or product for free on eGoZola classified Ads easielly 
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Sell your knowlegde, your product and earn money directly on eGoZola App, post your ads for free
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Get best buy deals around me or find Craigslist houses for rent near me in USA: chicago and seattle, easielly using eGoZola App
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Discover the best buy near me, sell a service or a product and easielly find a business pathner 
<br><span class="glyphicon glyphicon-tags"> </span> ✓ In on click, get cheapest Craigslist houses for rent in chicago, Boston and every where allover the USA.
 <br><span class="glyphicon glyphicon-tags"> </span> ✓ eGoZola, the best Business Tools and Business center facilitation for best buy deals near me for free. Get it now  <a href="<?php echo $botUrl?>" style="color: black"> <strong> Download, Click here ↓↓ </strong> </a> 
 
 <div style="height: 3px;border: 0;border-top: 1px;width:100%;background-color:#ccc"></div>
        <div style="margin-top: 30px"></div>
		   <a href="<?php echo $botUrl?>" >
          <div style="text-align: center">
            <strong> For more best buy deals near me listing, download our free Android app </strong> <strong style="color: darkgreen"> Click here ici ↓↓ </strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="job alert eGoZola">
          </div>
        </a>
