...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (212,'Algeria','AT',' $lang','$mob',5,'ZOLA',NOW())");
    $ps->execute();
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">    
     <title>Vente & location: www avito voiture occasion rabat pas cher, à tanger et au Maroc |eGoZola</title>
  <meta name="description" content="✓Publier ton annonce: Vente privée & Location sur www avito voiture occasion rabat pas cher, à tanger et au Maroc re ou à louer au Maroc,tanger, Rabat, Marrakech, Fès"/>
   <meta name="keywords" content="www avito voiture, avito voiture occasion rabat, www avito voiture occasion rabat pas cher"/>
...
<div style="height: 3px;border: 0;border-top: 1px;width:100%;background-color:#ccc"></div>
 ...
 <div style="text-align:center"> <h1>www avito voiture occasion rabat pas cher</h1></div>  
  <br><span class="glyphicon glyphicon-tags"> </span> ✓ Site web de location et vente privée: www avito voiture occasion rabat pas cher, à Marrakech, Tanger et partout au Maroc.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Publier gratuitement ton auto ou véhicule à vendre ou à faire louer à Tanger et Rabat sur eGoZaola www avito voiture occasion rabat pas cher. Faites des affires et gagner des clients et de l'argent
<br><span class="glyphicon glyphicon-tags"> </span> ✓ eGoZola, le meilleur outil et centre de facilitations des affaires www avito voiture occasion rabat pas cher et véhicule à vendre ou à louer au Maroc. Publier ton annonce gratuitement et ton vœux sera exaucer en quelques minutes. 
<br><span class="glyphicon glyphicon-tags"> </span> ✓ www avito voiture occasion rabat pas cher: Trouvez facilement une location, une vente privées de véhicule à louer ou à vendre à moins chère rapidement et facilement à Rabat, Marrakech, Tanger ou au Maroc sur eGoZola. Télécharger et utiliser notre application gratuitement <a href="<?php echo $botUrl?>" style="clolor:black"> <strong> Cliquer ici↓↓ </strong> </a>.  
