...
if($lang>0){
 ...
 $lang =explode( ',', $_SERVER['HTTP_ACCEPT_LANGUAGE'] )[0];
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (33,'France','AT',' $lang','$mob',1,'ZOLA',NOW())");
    $ps->execute();
...
1M: ouedkniss auto,
 ...
 location de voiture -->
  ...
  <base href="/">
  <title>le bon coin voiture occasion: location et Vente privée |eGoZola</title>
   <meta name="viewport" content="width=device-width, initial-scale=1"/>
  <meta name="description" content="✓ Publier ton annonce: Vente privée & Location vehicule le bon coin voiture occasion à Paris, Marseille, Lyon et partout France. Télecharger l'application "/>
...
?>
	...
	//$urlWS="https://www.egozola.com/stdView.php?id=".$subjectData["idProd"].'&cod='.$subjectData["codeName"].'&dsp=DSP';
		$urlWS=$botUrl;
	/* '.$urlWS.'/'.$subjectData["idAuto"].'/AT/'.$subjectData["type"].'/DSP"> */
...
<div style="height: 3px;border: 0;border-top: 1px;width:100%;background-color:#ccc"></div>
    ...
    <a href="<?php echo $botUrl?>"> <strong style="color: black"> Pour  plus de listes des véhicule à vendre ou à louer, téléchargez notre application gratuite</strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>
     ...
     <div style="text-align:center"> <h1>le bon coin voiture occasion </h1></div>  
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Le bon coin voiture occasion: Site web de location et vente privée de véhicule, auto à Paris, Marseille, Lyon et partout France
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Publier gratuitement ton auto ou véhicule à vendre ou à faire louer sur www le bon coin voiture occasion. Faites des affires et gagner des clients et de l'argent
<br><span class="glyphicon glyphicon-tags"> </span> ✓ eGoZola, le meilleur outil et centre de facilitations des affaires Le bon coin voiture occasion, véhicule à vendre ou à louer. Publier ton annonce gratuitement et ton vœux sera exaucer en quelques minutes. 
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Trouvez facilement une location ou une vente privées de véhicule le bon coin voiture occasion à louer ou à vendre à moins chère rapidement et facilementà Paris, Marseille, Lyon et partout France sur eGoZola.  
