...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'Cameroun','JS',' $lang','$mob',1,'ZOLA',NOW())");
    $ps->execute();
...
10K: offre d'emploi au cameroun 2021
10K: job cameroun 2021
 -->
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
   <title>Cherche travail? camerspace offre d emploi <?php echo date("Y"); ?> |eGoZola</title>
  <meta name="description" content="✓ Découvrez, Postulez en ligne aux offres camerspace offre d emploi <?php echo date("Y"); ?> et d'affaires à Douala, Yaoundé et partout au Cameroun. Télécharger l'application"/>
  <meta name="keywords" content="camerspace offre d emploi, camerspace offre d emploi <?php echo date("Y"); ?>, offre d emploi <?php echo date("Y"); ?>"/>
...
?>
        ...
        <div style="margin-top: 30px"></div>
          ...
          <div style="text-align: center">
		   <a href="<?php echo $botUrl?>" >
            <strong style="color: black">Pour Obtenir toutes les Offres d'emploi et d'Affaires au Caméroun dans ton téléphone, téléchargez notre application gratuite </strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>
...
<div style="text-align:center"> <h1> Camerspace offre d emploi <?php echo date("Y"); ?> </h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ camerspace offre d emploi <?php echo date("Y"); ?>: Trouve et Cherche travail ou une affaire rapidement à Douala, Yaoundé et partout au Cameroun sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Retrouvez ou cherche travaile rapidement sur travail sur Camerspace offre d emploi <?php echo date("Y"); ?> partout au Cameroun  
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Publier ton annonce, vendez ton savoir et tes services et gagnez de l'argent. Retrouvez des partenaires d'affaire avec l'application camerspace offre d emploi 2021
  <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez la personne, le travail ou l'affaire qu’il vous faut ou un service à domicile sur camerspace offre d emploi <?php echo date("Y"); ?> à Douala, Yaoundé et au Cameroun
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi cm <?php echo date("Y"); ?> et d'affaires autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
