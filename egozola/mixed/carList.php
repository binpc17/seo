...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (225,'eduCa','AT',' $lang','$mob',1,'ZOLA',NOW())");
    $ps->execute();
...
<head>
  ...
  <title>Locanto ci: Vendre en ligne & location voiture à louer à Abidjan</title>
  <meta name="description" content="✓ Publier ton annonce: Locanto ci, Location voiture ou véhicule occasion à louer ou à Vendre en ligne à Abidjan"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    ...
    <strong style="color: black"> Pour  voir plus de listes des véhicule à vendre ou à louer, téléchargez notre application gratuite</strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="job alert eGoZola">
          </div>
        </a>
    <div style="margin-left: 20px;margin-top: 12px">
       <h4 style="color:darkgreen;text-align: center;"> <strong> Véhicules disponnible à Abidjan</strong></h4> 
