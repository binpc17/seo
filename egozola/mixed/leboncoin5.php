...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (33,'France','AT',' $lang','$mob',5,'ZOLA',NOW())");
    $ps->execute();
...
-->
  ...
  <base href="/">
  <title> www le bon coin: Business, emploi, immo et location & Vente privée |eGoZola</title>
  <meta name="description" content="✓ Retrouvez ou Publier ton annonce: www le bon coin: Business, emploi, immo et location voiture, appartement & Maison à vendre à moins cher à Paris, Marseille, Lyon et partout France. Télecharger l'application "/>
  <meta name="keywords" content="Leboncoin44, Leboncoin44 location, Leboncoin44 emploi"/>
  ...
  <div class="col-md-7" >
    ...
    <div style="margin-left: 20px;margin-top: 12px">
     ...
     Offres d'Emploi & Services  </label>
          ...
          <div class="col-xs-6" >
            <a href="<?php echo $botUrl?>" style="color: black">
              <img src="./assets/7.png"  style="width:45px;height:45px" class="img-rounded" alt="Vendre voiture à Rabat"><br>
              <label style=" overflow: hidden; max-height: 40px;margin-left: 10px">
        ...
        <div class="row"  style="text-align: center;border-top: 1px solid #ccc" >
          <div class="col-xs-6" style="border-right: 1px solid #ccc" >
            <a href="<?php echo $botUrl?>" style="color: black">
              <img src="./assets/HS.png"  style="width:45px;height:45px" class="img-rounded" alt="avito auto,véhicule à louer à Maroce, Marrakech"><br>
              <label style=" overflow: hidden; max-height: 40px;margin-left: 10px">
                Maison & Appartement</label> <!--{{'HS_NAME' | translate}} -->
            </a>
          </div>
          <div class="col-xs-6" >
            <a href="leboncoin1.php?level=10" style="color: black">
              <img src="./assets/auto.png"  style="width:45px;height:45px" class="img-rounded" alt="www avito rabat voiture diesel"><br>
              <label style=" overflow: hidden; max-height: 40px;margin-left: 10px">
        ...
        <div class="row"  style="text-align: center;border-top: 1px solid #ccc">
          ...
          <div class="col-xs-6" style="border-right: 1px solid #ccc" >
            <a href="<?php echo $botUrl?>" style="color: black">
              <img src="./assets/weather.png"  style="width:45px;height:45px" class="img-rounded" alt="location voiture ou à vendre au Maroc"><br>
              <label style=" overflow: hidden; max-height: 40px;margin-left: 10px">  Consulter la Météo <!--{{'HM_WEB' | translate}} -->
              </label>
            </a>
          </div>
          <div class="col-xs-6">
            <a href="<?php echo $botUrl?>" style="color: black" alt="Location, vendre véhicule à Maroce, Marrakech">
        ...
        <div class="row"  style="text-align: center;border-top: 1px solid #ccc">
          <div class="col-xs-6" style="border-right: 1px solid #ccc" >
            <a href="<?php echo $botUrl?>" style="color: black">
              <img src="./assets/money.png"  style="width:45px;height:45px" class="img-rounded" alt="véhicule occasion à Tanger"><br>
              <label style=" overflow: hidden; max-height: 40px;margin-left: 10px">
        ...
        <div class="row"  style="text-align: center;border-top: 1px solid #ccc">
          <div class="col-xs-6" style="border-right: 1px solid #ccc">
            <a href="<?php echo $botUrl?>" style="color: black">
              <img src="./assets/location.png"  style="width:45px;height:45px" class="img-rounded" alt="véhicule occasion au Maroc"><br>
              <label style=" overflow: hidden; max-height: 40px;margin-left: 10px">
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
         ...
         Pour Obtenir toutes les Offres d'emploi et d'Affaire en France dans ton téléphone <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
...
<div style="text-align:center"> <h1>www le bon coin: Business, emploi, immo & location</h1></div>  
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ www le bon coin: Trouve et Cherche emploi ou une affaire rapidement à Paris, Marseille, Lyon et partout France sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola www le bon coin: Publier ton annonce, vendez ton savoir et tes services et gagnez de l'argent. Retrouvez des partenaires d'affaire avec l'application eGoZola
  <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez la personne, le travail ou l'affaire qu’il vous faut ou un service à domicile sur www le bon coin en France: à Paris, Marseille, Lyon 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi et des affaires www le bon coin autour de moi sur eGozola et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
