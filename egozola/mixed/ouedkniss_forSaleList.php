...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (213,'Algeria','SHOP',' $lang','$mob',2,'ZOLA',NOW())");
    $ps->execute();
...
<head>
  ...
  <title>Ouedkniss Vente privée, Acheter ou Vendre en ligne en Algérie mes produits & services </title>
  <meta name="description" content="✓ Publier tes produits sur Ouedkniss, acheter ou Vendre en ligne en Algérie, Alger, Oran, Constantine? Trouvez un Client✓ Vente privée en Algérie"/>
