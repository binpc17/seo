...
<head> 
 ...
 <!-- 100K emploi jeune,
  10K offre d emploi -->
 <title>Educarriere ci: Emploi ci, Business & Offre d'Emploi jeune à Abidjan, Cote d’ivoire|eGoZola</title>
  <meta name="description" content="✓ Postulez aux d’offres emploi jeune educarriere.ci, Business et recrutement à Abidjan et à Yamoussoukro sur educarriere ci eGoZola"/>
...
<strong style="color: black">Hey! Obtenez toutes les offres d'Emploi et d'Affaires en Côte d'ivoire dans ton téléphone et bien plus encore, téléchargez notre application gratuite </strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>			
  ...
  Offres d'Emploi & Services  </label>
      ...
      <div style="text-align: center"> <a href="<?php echo $botUrl?>" style="color: black"><strong>Télécharger & installer nos Outils  <span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
             Pour Obtenir toutes les Offres d'emploi et d'Affaire en Cote d'ivoire dans ton téléphoneTélécharger notre application mobile gratuite <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
