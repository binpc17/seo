...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (212,'Maroc','SHOP',' $lang','$mob',2,'ZOLA',NOW())");
    $ps->execute();
...
<head>
  ...
  <title>Avito Vente privée, Acheter ou Vendre en ligne au Maroc, Rabat, Marrakech |eGoZola</title>
  <meta name="description" content="✓ Publier tes produits sur eGoZola Avito, acheter ou Vendre en ligne au Maroc, Rabat, Marrakech, Fès? Vente privée & Achat au Maroc"/>
