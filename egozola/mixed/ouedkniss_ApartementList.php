...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (213,'Algeria','HS',' $lang','$mob',2,'ZOLA',NOW())");
    $ps->execute();
...
/*
>>10K promotion immobilière alger 2021, promotion immobilière ouedkniss
...
<title> Promotion immobilière alger <?php echo date("Y"); ?>: Vente & Ouedkniss location appartement en Algerie</title>  
  <meta name="description" content="✓ Publier ton annonce: Maison ou terrain à vendre ou à louer et promotion immobilière alger <?php echo date("Y"); ?>. Vente & Ouedkniss location appartement en algérie, Oran et Constantine"/>
 <meta name="keywords" content="promotion immobilière alger, promotion immobilière ouedkniss"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
       ...
       <strong style="color: black">Hey! Pour voir plus d'appartments & maison, téléchargez notre application gratuite</strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="Promotion immobilière alger 2021"> </a>
          </div>
...
$urlWS="https://www.egozola.com/hsView.php";
	foreach ($liste as $subjectData) {
      echo '<tr style="height:115px;width: 100%" ><td>  <a href="'.$botUrl.'" target="_blank" style="color: black"> '; 
...
<div style="height: 3px;border: 0;border-top: 1px;width:100%;background-color:#ccc"></div>
 ...
 <div style="text-align:center"> <h1>Promotion immobilière alger <?php echo date("Y"); ?> </h1> </div> 
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Site web de promotion immobilière alger <?php echo date("Y"); ?>: vente & Ouedkniss location appartement à Alger, Oran, Constantine et partout algérie sur eGoZola.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Promotion immobilière alger <?php echo date("Y"); ?>: Recherchez-vous un locateur? Publier gratuitement ton appartement ou terrain à vendre ou à faire louer à Alger avec eGoZola ou sur Ouedkniss location appartement faites des affires et gagner des clients et de l'argent
<br><span class="glyphicon glyphicon-tags"> </span> ✓ eGoZola, le meilleur outil et centre de facilitations des affaires et promotion immobilière alger <?php echo date("Y"); ?>, ouedkniss location appartement alger, des maisons et terrain à vendre ou à louer en algérie. Publier ton annonce gratuitement. 
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Trouvez facilement une vente privées, Ouedkniss location appartement, une maison à louer ou une promotion immobilière alger <?php echo date("Y"); ?> à moins chère rapidement et facilement à Oran, Constantine ou en Algérie sur eGoZola ouedkniss location appartement.  
