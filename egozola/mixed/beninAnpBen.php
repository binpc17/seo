...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (229,'ANP','JS',' $lang','$mob',4,'ZOLA',NOW())");
    $ps->execute();
...
<head>
 ...
 <title>Anpe Recrutement benin <?php echo date("Y"); ?> et Offres d'emploi <?php echo date("Y"); ?> au Benin |eGoZola</title>
  <meta name="description" content="✓ Postulez en ligne aux d’offres d'affaires et d'emploi sur eGoZola anpe recrutement benin <?php echo date("Y"); ?> sans vous déplacer au benin et Cotonou sur ton téléphone. Télécharger l'application"/>
   <meta name="keywords" content="onef burkina, insd burkina recrutement, Anpe Recrutement benin <?php echo date("Y"); ?>"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
       <h4 style="color:darkgreen;text-align: center;"> <strong> Anpe Recrutement benin & emploi disponnible</strong></h4> 	     
...
?>
 ...
 <div style="text-align:center"> <h1>Anpe Emploi et Recrutement benin <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Anpe Recrutement benin <?php echo date("Y"); ?>: Postulez! Cherchez une offre d'emploi ou d'affaire au benin sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement toutes le Recrutement, une offre d’affaire ou emploi sur eGoZola anpe Recrutement benin <?php echo date("Y"); ?> à Cotonou et partout au Benin
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Cherche travaile rapidement et retrouvez un emploi sur eGoZola.
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sur Anpe Recrutement benin <?php echo date("Y"); ?>: vendez tes services ou ton savoir. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Business.
  <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez la personne, le travail ou l'affaire qu’il vous faut ou un service à domicile avec Anpe Recrutement benin <?php echo date("Y"); ?> dans ton téléphone. 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi et Anpe Recrutement benin <?php echo date("Y"); ?> autour de moi à Cotonou et bien plus encore. <a href="<?php echo $botUrl?>" style="color:black"> <strong>Télécharger l'application Cliquer ici↓↓ </strong> </a>.
       						<br><p></p>
