...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'Cameroun','JS',' $lang','$mob',5,'ZOLA',NOW())");
    $ps->execute();
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
   <title>Emploi et Everjobs cameroun <?php echo date("Y"); ?> à douala, Yaoundé |eGoZola</title>
  <meta name="description" content="✓ Découvrez, Postulez en ligne aux Offre d'emploi et d'affaires: Everjobs cameroun <?php echo date("Y"); ?> à douala sur eGoZola. Télécharger l'application!"/>
...
?>  
 ...
 <div style="text-align:center"> <h1> Emploi & Everjobs cameroun <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Everjobs cameroun <?php echo date("Y"); ?>: Trouve et Cherche travail ou une affaire rapidement à douala, Yaoundé et partout sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Retrouvez ou cherche travaile rapidement et des offre d'emploi et everjobs cameroun. 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Publier ton annonce, vendez ton savoir et tes services et gagnez de l'argent. Retrouvez des partenaires d'affaire avec l'application eGoZola everjobs cameroun <?php echo date("Y"); ?>.
  <br> <span class="glyphicon glyphicon-tags"> </span>✓ Everjobs cameroun <?php echo date("Y"); ?>. Retrouvez la personne, le travail ou l'affaire qu’il vous faut ou un service à domicile à Douala et Yaoundé.
