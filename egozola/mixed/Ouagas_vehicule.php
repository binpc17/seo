...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (213,'Algeria','AT1',' $lang','$mob',1,'ZOLA',NOW())");
    $ps->execute();
...
<title>Vente privée, location, voiture ou véhicule à Ouagadougou |eGoZola</title>
  <meta name="description" content="✓ Publier ton annonce: Vente privée & Location ouedkniss auto, voiture occasion à vendre ou à louer à Ouagadougou"/>
 <meta name="keywords" content="Vente privée, véhicule à louer à Burkina faso, Vendre voiture au Ouagadougou"/>
...
<strong style="color: black">Hey! Obtenez toutes les offres d'Emploi et d'Affaires au Burkina faso dans ton téléphone et bien plus encore, téléchargez notre application gratuite </strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>			
	...
	<?php   
$ps=$pdo->prepare("SELECT idAuto,sizeV,type,autoTitle,price,currency,placeSize,year,town,photo1,countryCD FROM autodb  WHERE idAuto>9 AND dateExp >= (select UNIX_TIMESTAMP()) ORDER BY idAuto DESC LIMIT 0,10");
$ps->execute();
...
<div style="height: 3px;border: 0;border-top: 1px;width:100%;background-color:#ccc"></div>
    ...
    <strong style="color: black"> Pour  plus de listes des véhicule à vendre ou à louer, téléchargez notre application gratuite</strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>
       ...
       <div style="text-align:center"> <h1> Locabto voiture: Vente privée auto & Location véhicule occasion à Ouagadougou</h1></div>  
  <br><span class="glyphicon glyphicon-tags"> </span> ✓ Site web de vente privée, Locabto auto & location de voiture occasion à Ouagadougou et partout au Burkina faso.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Publier gratuitement ton auto ou véhicule à vendre ou à faire louer à Alger sur eGoZaola. Faites des affires et gagner des clients et de l'argent
<br><span class="glyphicon glyphicon-tags"> </span> ✓ eGoZola, le meilleur outil et centre de facilitations des affaires sur Locabto voiture occasion, véhicule à vendre ou à louer à Ouagadougou. Publier ton annonce gratuitement et ton vœux sera exaucer en quelques minutes. 
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Trouvez facilement une vente privées de véhicule ou une location de voiture à louer ou à vendre à moins chère rapidement et facilement à Ouagadougou ou au Burkina faso sur eGoZola. Télécharger et utiliser notre application gratuitement <a href="<?php echo $botUrl?>" style="clolor:black"> <strong> Cliquer ici↓↓ </strong> </a>.  
