...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (1,'Craigs','POS',' $lang','$mob',8,'EGO',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<div style="margin-top: 7px;margin-left: 15px;background-color: #5e5e5e;width: 100%;position: fixed;font-family: Calibri">
  <a href="https://egozola.com"> <img src="../assets/logo.PNG" style="border-radius: 7px;width:97px;height:42px" alt="Stock management free point of sale systems"></a>
  <span style="margin-left: 20px"></span>
  <span> <a  class="btn btn-primary" href="https://egozola.com/APP/eGoZola.apk"> Download <span class="glyphicon glyphicon-download"></span> </a> </span>
</div>
...
<div class="row" style="font-family: Calibri">
  ...
  <div class="col-md-7" >
    ...
    <h4 style="margin-left: 15px;margin-top: 30px"> Welcome on Craigslist-Chicago  <span class="glyphicon glyphicon-hand-right"></span></h4>
 ...
 <h4 style="color:darkgreen;text-align: center;"> <strong> What are you looking for?</strong></h4> 
      ...
      <div class="row"  style="text-align: center;border-top: 1px solid #ccc" >
        ...
        <div class="col-xs-6" >
          <a href="forSaleList.php" style="color: black">
      ...
      <div class="row"  style="text-align: center;border-top: 1px solid #ccc" >
        <div class="col-xs-6" style="border-right: 1px solid #ccc" >
          <a href="ApartementList.php" style="color: black">
        ...
        <div class="col-xs-6" >
          <a href="carList.php" style="color: black">
      ...
      <div style="text-align: center"> <a href="https://play.google.com/store/apps/details?id=app.eGoZola" style="color: black"><strong>Télécharger & installer nos Outils  <span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
      <div class="row"  style="text-align: center;border-top: 1px solid #ccc">
        <div style="margin-bottom: 2px;background-color:slategray;color:white;height: 3px "></div>
        <div class="col-xs-6" style="border-right: 1px solid #ccc" >
          <a href="https://play.google.com/store/apps/details?id=app.eGoZola" style="color: black">
      ...
      <a href="https://play.google.com/store/apps/details?id=app.eGoZola" >
        <div style="text-align: right">
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ eGoZola the best mobile free app for finding and selling used vehicle rental near me in USA: chicago, Boston, seattle. Get it now for free <a href="https://play.google.com/store/apps/details?id=app.eGoZola" style="color: black"> <strong> Download, Click here ↓↓ </strong> </a>
  <div style="background-color: #5e5e5e;height: 2px;width: 100%"></div>
 <h4 style="color:darkgreen;text-align: center;"> <strong> What are you looking for?</strong></h4> 
        <div style="text-align: center;color: darkgreen"><strong> Please choose a category↓↓ </strong></div> 
      <div style="margin-bottom: 2px;background-color:slategray;color:white;height: 3px "></div>
