...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (243,'MediaC','JS',' $lang','$mob',1,'ZOLA',NOW())");
    $ps->execute();
	...
	Mediacongo Offre d'Emploi et d'affaires partout en RDC
	-->
<!doctype html>
<html lang="fr">
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
   <title> www mediacongo net offre d'emploi <?php echo date("Y"); ?> partout en RDC |eGoZola</title>
  <meta name="description" content="✓ Postulez en ligne aux offres d'emploi ou d'affaire sur www mediacongo net offre d emploi <?php echo date("Y"); ?> à Kinshasa, Goma, Lubumbashi. Télécharger notre application gratuitement"/>  <meta name="keywords" content="job hunting near me,"/>
  <meta name="keywords" content="Cherche Emploi, Mediacongo Offre d'Emploi à Kinshasa, Goma, Mediacongo"/> 
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    <h4 style="margin-left: 15px">Bienvenue sur Mediacongo emploi <?php echo date("Y"); ?><span class="glyphicon glyphicon-hand-right"></span></h4>
...
?>
        ...
        <div style="margin-top: 30px"></div>
	          <div style="text-align: center">
		   <a href="<?php echo $botUrl?>" >
            <strong style="color: black"> Pour Obtenir toutes les Offres d'emploi et d'Affaire en RDCongo dans ton téléphone, téléchargez notre application gratuite</strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>			
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="job alert eGoZola"> </a>
          </div>
       ...
       <div style="text-align:center"> <h1> Mediacongo offre d'emploi <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ www mediacongo net offre d emploi: Trouve et Cherche un travail ou une affaire rapidement à Kinshasa, Goma, Lubumbashi et partout en RDC. Sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou de travail sur www mediacongo net offre d'emploi avec eGoZola
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Publier ton annonce, vendez ton savoir et tes services et gagnez de l'argent. Retrouvez des partenaires d'affaire avec l'application www mediacongo app.eGoZola 
  <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez la personne, le travail ou l'affaire qu’il vous faut ou un service à domicile sur www mediacongo net offre d'emploi à Kinshasa, Goma et à Lubumbashi. 
