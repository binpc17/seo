...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (212,'Maroc','HS',' $lang','$mob',2,'ZOLA',NOW())");
    $ps->execute();
...
<head>
  ...
  <base href="/">
<title> Appartement a louer marrakech daoudiate pas cher au Maroc  |eGoZola</title>
  <meta name="description" content="✓ Publier ton annonce. Appartement a louer marrakech daoudiate pas cher au Maroc, maison à louer ou à vendre à Rabat, Marrakech, Fès. Gangez confidentiellement ton argent"/>
...
<div style="height: 3px;border: 0;border-top: 1px;width:100%;background-color:#ccc"></div>
       ...
       <strong style="color: black"> Pour  voir plus d'appartments & maison, téléchargez notre application gratuite</strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="Appartement a louer marrakech daoudiate pas cher"> </a>
          </div>
      ...
      <div style="text-align:center"> <h1>Appartement a louer marrakech daoudiate pas cher</h1> </div> 
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Site web pour trouver un appartement a louer marrakech daoudiate pas cher à Rabat, Fès et partout au Maroc sur eGoZola.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Appartement a louer marrakech daoudiate pas cher: Recherchez-vous un locateur? Publier gratuitement ton appartement ou terrain à vendre ou à faire louer au Maroc sur eGoZola. faites des affires et gagner des clients et de l'argent
<br><span class="glyphicon glyphicon-tags"> </span> ✓ eGoZola, le meilleur outil et centre de facilitations des affaires et vente & location appartement a louer marrakech daoudiate et terrain à vendre ou à louer au Maroc . Publier ton annonce gratuitement. 
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Trouvez facilement une vente privées, un appartement a louer à marrakech daoudiate pas cher, une maison à louer rapidement et facilement partout au Maroc sur eGoZola.  
