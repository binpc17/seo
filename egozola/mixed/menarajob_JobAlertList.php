...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (212,'Maroc','JS',' $lang','$mob',2,'ZOLA',NOW())");
    $ps->execute();
...
<head>
 ...
 <title>Cherche travail? Uemf emploi et Cnss Recrutement <?php echo date("Y"); ?> à Casablanca, Rabat et au Maroc</title>
  <meta name="description" content="✓ Découvrez, Postulez aux offres emploi, uemf emploi et cnss recrutement <?php echo date("Y"); ?> à Casablanca, Rabat et partout au Maroc. Télécharger eGozola"/>
  <meta name="keywords" content="Uemf emploi <?php echo date("Y"); ?>, Cnss Recrutement <?php echo date("Y"); ?>"/>
  ...
  <div class="col-md-7" >
	...
	<?php   
		//$urlWS="https://www.egozola.com/jobService.php?type=dsp&id=".$subjectData['idJobS'];
			$urlWS=$botUrl;
$ps=$pdoJS->prepare("SELECT idJobS,sizeV,jobTitle,town,dateExp,urlJS,userN FROM jobservice  WHERE idJobS>9 AND dateExp >= (select UNIX_TIMESTAMP()) ORDER BY idJobS DESC LIMIT 0,15");
$ps->execute();
...
?>
        ...
        <div style="margin-top: 30px"></div>
		  ...
		  <a href="<?php echo $botUrl?>">
            ...
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="Cnss Recrutement 2021"> </a>
          </div>
 ...
 <div style="text-align:center"> <h1> uemf emploi & Cnss Recrutement <?php echo date("Y"); ?> </h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Cnss Recrutement <?php echo date("Y"); ?>: Trouve et Cherche travail, uemf emploi ou une affaire rapidement au Maroc, rabat, tanger et casablanca  sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Retrouvez ou cherche travaile ou Cnss Recrutement <?php echo date("Y"); ?> rapidement sur eGoZola uemf emploi tanger, casablanca, rabat et partout au Maroc  
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Publier ton annonce, vendez ton savoir et tes services et gagnez de l'argent. Retrouvez des partenaires d'affaire avec l'application eGoZola
  <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez la personne, le travail ou l'affaire qu’il vous faut ou un service à domicile uemf emploi et Cnss Recrutement <?php echo date("Y"); ?> à tanger, casablanca et à Rabat. 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres uemf emploi et de Cnss Recrutement <?php echo date("Y"); ?> et d'affaires autour de moi et bien plus encore.
...
<footer style="background: #5e5e5e;color: white;text-align: center;font-family: Calibri">
  ...
  Powered by © eGoZola MenaraJob</span><br>
