...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (213,'Algeria','JS',' $lang','$mob',4,'ZOLA',NOW())");
    $ps->execute();
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
   <title>Cherche travail? sur emploitic dz ou Ouedkniss emploi blida <?php echo date("Y"); ?> |eGoZola</title>
  <meta name="description" content="✓ Découvrez, Postulez en ligne aux offres emploitic dz <?php echo date("Y"); ?> et d'affaires Ouedkniss emploi blida, blida et oran sur eGoZola. Télécharger l'application"/>
  <meta name="keywords" content="Ouedkniss emploi blida, emploitic dz, Cherche travail,emploitic dz <?php echo date("Y"); ?>"/>
...
<strong style="color: black">Hey! Obtenez toutes les offres d'Emploi et d'Affaires en Algérie dans ton téléphone et bien plus encore, téléchargez notre application gratuite </strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>
	...
	//$urlWS="https://www.egozola.com/jobService.php?type=dsp&id=".$subjectData['idJobS'];
		$urlWS=$botUrl;
$ps=$pdoJS->prepare("SELECT idJobS,sizeV,jobTitle,town,dateExp,urlJS,userN FROM jobservice  WHERE countryCD=213 AND dateExp >= (select UNIX_TIMESTAMP()) ORDER BY idJobS DESC LIMIT 0,10");
$ps->execute();
...
?>
        ...
        <div style="margin-top: 30px"></div>
          ...
          <div style="text-align: center">
		   <a href="<?php echo $botUrl?>" >
            <strong style="color: black"> Pour Obtenir toutes les Offres d'Emploi et d'Affaires dans ton téléphon dz, téléchargez notre application gratuite </strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="Ouedkniss emploi alger"> 
			    </a>
          </div>
...
<div style="text-align:center"> <h1> Cherche travail sur emploitic dz <?php echo date("Y"); ?>? </h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Emploitic dz <?php echo date("Y"); ?>: Trouve et Cherche travail ou une affaire rapidement sur Ouedkniss emploi blida en algérie, Oran, Constantine sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Retrouvez ou cherche travaile rapidement sur emploitic dz <?php echo date("Y"); ?> et Ouedkniss emploi blida, Oran, Constantine et partout en Algérie  
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Publier ton annonce, vendez ton savoir et tes services et gagnez de l'argent. Retrouvez des partenaires d'affaire avec l'application emploitic dz <?php echo date("Y"); ?> eGoZola
  <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez la personne, le travail ou l'affaire qu’il vous faut ou un service à domicile emploitic dz sur Ouedkniss emploi blida <?php echo date("Y"); ?>, et Oran. 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi dz <?php echo date("Y"); ?> sur Ouedkniss blida et d'affaires autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
