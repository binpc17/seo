...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (33,'France','AT',' $lang','$mob',3,'ZOLA',NOW())");
    $ps->execute();
...
-->
  ...
  <base href="/">
  <title>Maison à vendre le bon coin: location et Vente privée |eGoZola</title>
  <meta name="description" content="✓ Publier ton annonce: Appartement & Maison à vendre le bon coin à moins cher à Paris, Marseille, Lyon et partout France. Télecharger l'application "/>
...
<div style="height: 3px;border: 0;border-top: 1px;width:100%;background-color:#ccc"></div>
    ...
    <a href="<?php echo $botUrl?>"> <strong style="color: black"> Pour  voir plus d'appartments & maison, téléchargez notre application gratuite</strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>
     ...
     <div style="text-align:center"> <h1>Maison à vendre le bon coin à moins cher</h1></div>  
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Site web de location et vente privée d'appartement ou Maison à vendre le bon coin à moins cher et terrain à Paris, Marseille, Lyon et partout France
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Publier gratuitement ton appartement, terrain à vendre ou à faire louer sur Maison à vendre le bon coin à moins cher. Faites des affires et gagner des clients et de l'argent
<br><span class="glyphicon glyphicon-tags"> </span> ✓ eGoZola, le meilleur outil et centre de facilitations des affaires ou Maison à vendre le bon coin à moins cher, terrain et appartement à vendre ou à louer. Publier ton annonce gratuitement en quelques minutes. 
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Trouvez facilement une maison à vendre le bon coin à moins cher ou une location d'appartement, terrain rapidement et facilementà Paris, Marseille, Lyon et partout France sur eGoZola.  
