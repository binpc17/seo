...
if($lang>0){
 ...
 if($uDev>0){
	 $mob="Mob";
  if($lang!==''){
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'Cameroun','JS',' $lang','$mob',2,'ZOLA',NOW())");
    $ps->execute();
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
   <title>Akwajobs douala & Offre d'emploi au cameroun <?php echo date("Y"); ?> |eGoZola</title>
  <meta name="description" content="✓ Découvrez, Postulez en ligne aux Offre d'emploi au cameroun <?php echo date("Y"); ?> et d'affaires sur Akwajobs douala, Yaoundé et partout au Cameroun. Télécharger l'application"/>
...
?>
        ...
        <div style="margin-top: 30px"></div>
		  ...
		  <div style="text-align:center"> <h1> Offre d'emploi au cameroun <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Offre d'emploi au cameroun <?php echo date("Y"); ?>: Trouve et Cherche travail ou une affaire rapidement  sur Akwajobs Douala, Yaoundé et partout au Cameroun sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Retrouvez ou cherche travaile rapidement des offre d'emploi au cameroun <?php echo date("Y"); ?> sur Akwajobs douala avec eGoZola Yaoundé et partout au Cameroun  
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Publier ton annonce, vendez ton savoir et tes services et gagnez de l'argent. Retrouvez des partenaires d'affaire avec l'application eGoZola Akwajobs Douala
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des Offre d'emploi au cameroun <?php echo date("Y"); ?> et d'affaires sur eGoZola Akwajobs douala autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
