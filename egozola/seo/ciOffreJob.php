...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (225,'ciOffreJob','JS',' $lang','$mob',98,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
  ...
  <title>Recherche emploi? ou educarriere job ci abidjan? en Cote d'ivoir |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi ci et d'affaires sur educarriere job ci à abidjan et partout en cote d'ivoir facilement. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, educarriere job ci, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div style="text-align:center;margin-top: 10px"> <h1> Emploi & Educarriere job ci</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Offre d'emploi sur Educarriere job ci: Trouve et Cherche travaile ou un emploi rapidement à abidjan sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une Offre d'emploi abidjan sur Educarriere job ci et partout Cote d'ivoir avec eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez des opportuinités d'offres d'emploi Educarriere job ci avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Abidjan et partout en Cote d'ivoir. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez facilement des Offres d'emploi abidjan sur Educarriere job ci en Cote d'ivoir et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
