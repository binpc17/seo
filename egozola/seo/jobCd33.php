...
<head> 
 ...
 <title>Obtenez toutes les offres recrutement <?php echo date("Y"); ?> kinshasa | RDC congo eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres recrutement <?php echo date("Y"); ?> kinshasa complet, Téléchargez l'applicatio recrutement 2022 kinshasa pour un accès sans internet et bien plus encore partout avec ton téléphone"/>
  <meta name="keywords" content="Cherche Emploi, recrutement 2022 kinshasa "/>
...
<div class="row" style="font-family: Calibri;margin-top: 30px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1>Obtenez toutes les offres recrutement <?php echo date("Y"); ?> kinshasa</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Recrutement <?php echo date("Y"); ?> kinshasa offre d'emploi: Trouve et Cherche du travaile ou un emploi rapidement en RDC sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez rapidement une offre d’affaire ou recrutement <?php echo date("Y"); ?> kinshasa partout en RDC avec l'application <strong>eGoZola gratuite </strong>
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail sur recrutement 2022 kinshasa avec votre téléphone sans inernet et gratuit.
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire ou tes services partout en RDC. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ <strong>Télecharger eGoZola et retrouvez toutes les offres recrutement <?php echo date("Y"); ?> kinshasa </strong> et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong style="color: darkgreen">Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
