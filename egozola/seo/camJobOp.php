...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'jsOp','JS',' $lang','$mob',16,'ZOLA',NOW())");
    $ps->execute();
...
<title>Recherche emploi? Retrouvez des job opportunities in douala <?php echo date("Y"); ?> au cameroun |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi, des job opportunities in douala <?php echo date("Y"); ?> et recrutement à Youndé et partout au cameroun sans vous déplacer. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, job opportunities in douala 2021, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Find job opportunities in douala <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get job opportunities in douala <?php echo date("Y"); ?>: Trouve et Cherche travaile ou un emploi rapidement à Yaoundé, Douala au cameroun sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou d' emploiet des job opportunities in douala <?php echo date("Y"); ?> et partout au cameroun avec eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement, retrouvez un emploi et des job opportunities in douala <?php echo date("Y"); ?> and or in cameroon et offre d'emploi avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce in  Douala et partout au cameroun. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi, job opportunities in douala <?php echo date("Y"); ?> et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
