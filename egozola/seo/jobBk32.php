...
<head> 
 ...
 <title>Obtenez toutes Offres et Recrutement ensoa  <?php echo date("Y"); ?> burkina faso |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres Recrutement ensoa burkina faso <?php echo date("Y"); ?> complet, Téléchargez l'application Recrutement ensoa 2022 burkina faso pour un accès sans internet et bien plus encore partout avec ton téléphone"/>
  <meta name="keywords" content="Cherche Emploi, Recrutement ensoa 2022 burkina faso "/>
...
<div class="row" style="font-family: Calibri;margin-top: 30px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
         ...
         <strong style="color: black"> Pour  voir plus des offres d'emplois et d'affaires au Burkina faso, téléchargez notre application gratuite </strong>  <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
 ...
 <div style="text-align:center;margin-top: 10px"> <h1>Obtenez toutes les offres et Recrutement ensoa  <?php echo date("Y"); ?> burkina faso</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Recrutement ensoa 2022 burkina faso : Trouve et Cherche du travaile ou un emploi rapidement au Burkina faso sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez rapidement une offre d’affaire ou Recrutement ensoa burkina faso <?php echo date("Y"); ?> partout au Burkina avec l'application <strong>eGoZola gratuite </strong>
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail sur Recrutement ensoa <?php echo date("Y"); ?> burkina faso avec votre téléphone sans inernet et gratuit.
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire ou tes services partout au Burkina. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ <strong>Télecharger eGoZola et retrouvez toutes les offres Recrutement ensoa 2022 burkina faso <?php echo date("Y"); ?></strong> et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong style="color: darkgreen">Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
         <strong style="color: black"> Pour  voir plus des offres d'emplois et d'affaires au Burkina, téléchargez notre application gratuite </strong>  <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
		
			<?php   
$ps=$pdoJS->prepare("SELECT idJobS,sizeV,jobTitle,town,dateExp,urlJS,userN FROM jobservice  WHERE countryCD=226 AND dateExp >= (select UNIX_TIMESTAMP()) ORDER BY idJobS DESC LIMIT 0,8");
$ps->execute();
