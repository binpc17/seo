...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'venteLigneCam','SHOP',' $lang','$mob',80,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Recherchez-vous une application de vente en ligne au cameroun? Télécharger l'appli|eGoZola</title>
  <meta name="description" content="✓ Application de vente en ligne au cameroun: Retrouvez ou Publier ton annonce, Business, emploi, vendez en ligne tes services, produits, maison ou appartement et retrouvez un partenaire d'affaires. Télécharger notre application gratuite"/>
  <meta name="keywords" content="application de vente en ligne, camerspace offre d'emploi, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
         ...
         <strong>Hey! Obtenez notre meilleur Application de vente en ligne au cameroun et bien plus encore, téléchargez notre application gratuite</strong>  <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
      ...
      <div style="text-align: center"> <a href="<?php echo $botUrl?>" style="color: black"><strong>Télécharger & installer nos Outils  <span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
    <strong>Télécharger l'Application de vente en ligne Gratuit </strong> <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
<div style="text-align:center"> <h1>Application de vente en ligne</h1></div>  
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Application de vente en ligne au cameroun: Cherchez ou faites des affaire rapidement sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola l'Application de vente en ligne au cameroun: Publier ton annonce, vendez ton savoir et tes services. Retrouvez des partenaires d'affaire avec l'application eGoZola
  <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez la personne ou l'affaire qu’il vous faut ou un service à domicile. 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes produits, tes services ou annonce. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness avec eGoZola l'Application de vente en ligne au cameroun
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez des offres d'affaires autour de moi sur eGozola et bien plus encore. Télecharger l'application eGoZola <a href="<?php echo $botUrl?>" style="clolor:black"> <strong>Cliquer ici↓↓ </strong> </a>.
