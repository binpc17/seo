...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'debtLoan','JS',' $lang','$mob',55,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>GET Best Simple free loan tracker app for android & web browser |eGoZola</title>
  <meta name="description" content="✓ Transform your smartphone into a real Simple free best loan tracker app and start taking control of your money saving with an expense app integrated for free with eGoZola. Download it now"/>
  <meta name="keywords" content="Cherche Emploi, loan tracker app, Emploi au cameroun"/>
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
      ...
      <div style="text-align: center"> <a href="<?php echo $botUrl?>" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
           <strong>To Get more business offers, download our Free loan tracker app </strong> <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
            <img src="assets/playStor.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
  	    <div style="text-align:center"> <h1>Best free loan tracker app </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best free loan tracker app, track your debts, expense, your income and all your dailly expenses, debt with free report. Download and get it for free
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your Business, with our Best free loan tracker app. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ It's free and easy with eGoZola free loan tracker app, download free link all your account into one and track your dailly income and debts repport.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free loan tracker app for android with budgeting app and extra tools in real time. Get it now for free. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
