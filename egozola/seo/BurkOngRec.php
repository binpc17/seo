...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'BurkOngRec','JS',' $lang','$mob',111,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Recherchez-vous un Emploi ou Ong recrutement burkina <?php echo date("Y"); ?>? c'est facile et rapide  |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez à toutes les offres d'emploi humanitaire et Ong recrutement burkina <?php echo date("Y"); ?> à Ouaga et partout au Burkinafaso. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, Ong recrutement burkina <?php echo date("Y"); ?>, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Ong recrutement burkina <?php echo date("Y"); ?> </h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ offres d'emploi humanitaire au Burkina: Trouve et Cherche travaile ou un emploi et recrutement burkina <?php echo date("Y"); ?> sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou toutes les offres d'emploi humanitaire, Ong recrutement burkina avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez des offres d'affaires ou recrutement Ong burkina sur eGoZola 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Ouaga et partout au Burkina RDC. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'affaires et toutes les offres d'emploi humanitaire, Ong recrutement burkina <?php echo date("Y"); ?> autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
