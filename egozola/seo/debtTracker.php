...
<head> 
 ...
 <title>GET Best Simple free Debt Tracker app for android & web browser |eGoZola</title>
  <meta name="description" content="✓ Transform your smartphone into a real Simple free best Debt Tracker app and start taking control of your money saving with an expense app integrated for free with eGoZola. Download it now"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
	  ...
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best free debt tracker app, track your debts, expense, your income and all your dailly expenses, debt with free report. Download and get it for free
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free debt tracker app for android with budgeting app and extra tools in real time. Get it now for free <a href="<?php echo $botUrl?>" style="color: black"> <strong> Download, Click here ↓↓ </strong> </a>
		<br>
		<br>
      ...
      <h4 style="color:darkgreen;text-align: center;"> <strong> What are you looking for? <strong></h4> 
        ...
        <div class="row"  style="text-align: center;border-top: 1px solid #ccc" >
          <div class="col-xs-6" style="border-right: 1px solid #ccc">
            ...
            <img src="./assets/JS.png" style="width:45px;height:45px" class="img-rounded"  alt="jobs in Yaoundé 2021"><br>
