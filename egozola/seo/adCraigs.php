...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'adCraigs','JS',' $lang','$mob',64,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Looking for free classified sites like craigslist <?php echo date("Y"); ?> near me? Post unlimited Ads </title>
  <meta name="description" content="✓ Find or Make deal, Business offer or post free classified sites like craigslist near me <?php echo date("Y"); ?>, sell your services or your product for free. Get classified sites like with your smart phone. Get it now, download our free eGoZola app"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get free classified sites, Post or Quickly find a business or hot deal, services and post for free classified sites like craigslist online advertising near me 2021 everywhere around you with your eGoZola app. Get it for free
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your knowledge, your services or advertising online everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find best deal, post free classified sites like craigslist near me <?php echo date("Y"); ?> and business around me and much more. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
