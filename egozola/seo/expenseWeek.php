...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expenseWeek','JS',' $lang','$mob',47,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>GET Simple best weekly expense tracker app for android <?php echo date("Y"); ?>. Get it Now |eGoZola</title>
  <meta name="description" content="✓ Transform your android smartphone into a real free Simple weekly expense tracker app or daily expenses <?php echo date("Y"); ?> for android and start saving your money smartly for free with eGoZola."/>
  <meta name="keywords" content="Cherche Emploi, weekly expense tracker, Emploi au cameroun"/>
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
		   ...
		   <a href="<?php echo $botUrl?>" style="color: black">
            <strong>Find more job, business offers and much more, download our free app </strong> <strong style="color: darkgreen"> Click here↓↓</strong> <br>
      ...
      <div style="text-align: center"> <a href="<?php echo $botUrl?>" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
  	    ...
  	    <div style="text-align:center"> <h1>Free weekly expense tracker app <?php echo date("Y"); ?> </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best Free weekly expense tracker, track your daily and weekly spending Expenses with free report, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your money saving, with our Simple best weekly expense tracker for weekly, daily expenses record for android. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete Simple best weekly expense tracker app record for android mobile and extra tools in real time.  <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
