...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (212,'MarocUemef','JS',' $lang','$mob',114,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Recherche emploi? ou uemf emploi <?php echo date("Y"); ?> en Algérie? c'est facile et rapide |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi uemf <?php echo date("Y"); ?> et recrutement uemf  partout en algériea. Découvrez des emploi uemf et petits travaux autour de vous. Télécharger notre application gratuite"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
	...
	<strong style="color: black">Hey! Obtenez toutes les offres d'Emploi et d'Affaires en Algérie dans ton téléphone et bien plus encore, téléchargez notre application gratuite </strong>
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> uemf Offre d'emploi <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Offre d'emploi uemf en algérie: Trouve et Cherche travaile, petit travaux ou un emploi rapidement partout en algérie sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou Offre d'emploi uemf en algérie avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail ou Offre d'emploi uemf <?php echo date("Y"); ?> avec votre téléphone
<br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des Offres d'emploi uemf <?php echo date("Y"); ?> et d'affaire  partout en algérie autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
