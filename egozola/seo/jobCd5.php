...
<head> 
 ...
 <title>Obtenez toutes les offres radio okapi emploi  <?php echo date("Y"); ?> |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres radio okapi emploi <?php echo date("Y"); ?> complet, Téléchargez l'applicatio radio okapi emploi pour un accès sans internet et bien plus encore partout avec ton téléphone"/>
  <meta name="keywords" content="Cherche Emploi, radio okapi emploi "/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1>Obtenez toutes les offres radio okapi emploi <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ radio okapi emploi offre d'emploi: Trouve et Cherche du travaile ou un emploi rapidement en RDC sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez rapidement une offre d’affaire ou radio okapi emploi <?php echo date("Y"); ?> partout en RDC avec l'application <strong>eGoZola gratuite </strong>
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail sur radio okapi emploi avec votre téléphone sans inernet et gratuit.
