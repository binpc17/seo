...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkRecinsd','JS',' $lang','$mob',106,'ZOLA',NOW())");
      $ps->execute();
...
<title>Recherche emploi? Découvrez insd Burkina recrutement <?php echo date("Y"); ?> et emploi autour de moi |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi, insd burkina recrutement <?php echo date("Y"); ?>, petit travaux et d'affaires sur les meilleur sites d'emploi au burkina faso. Télécharger notre application et decouvrez des emploi et petit travaux"/>
