...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'CamKerawa','JS',' $lang','$mob',6,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
  ...
  <title>Recherche emploi? kerawa Offre d'emploi au cameroun <?php echo date("Y"); ?> à Youndé et Douala |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d emploi kerawa <?php echo date("Y"); ?> et recrutement à Youndé et Douala en ligne. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, kerawa Offre d'emploi au cameroun, Emploi au cameroun"/>
...
<strong style="color: black">Hey! Obtenez toutes les offres d'Emploi et d'Affaires au Caméroun dans ton téléphone et bien plus encore, téléchargez notre application gratuite </strong>  <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
  ...
  <div style="text-align:center;margin-top: 10px"> <h1> Kerawa Offre d'emploi au cameroun <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Kerawa Offre d'emploi: Trouve et Cherche travaile ou un emploi rapidement à Yaoundé, Douala au cameroun sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou Kerawa Offre d'emploi au cameroun <?php echo date("Y"); ?> à Yaoundé, Douala avec eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail sur Kerawa Offre d'emploi au cameroun <?php echo date("Y"); ?> avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Yaoundé, Douala et partout au cameroun. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez Kerawa offres d'emploi <?php echo date("Y"); ?> au cameroun et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
