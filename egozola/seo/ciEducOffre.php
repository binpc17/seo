...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (225,'ciEducOffre','JS',' $lang','$mob',91,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
  ...
  <title>Recherche emploi? ou Educarriere emploi ci <?php echo date("Y"); ?>? en Cote d'ivoir |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi et d'affaires sur educarriere emploi ci <?php echo date("Y"); ?> à abidjan <?php echo date("Y"); ?>. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, educarriere emploi ci <?php echo date("Y"); ?>, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div style="text-align:center;margin-top: 10px"> <h1> Educarriere emploi ci <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ educarriere emploi ci: Trouve et Cherche travaile ou un emploi rapidement à abidjan sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une Offre d'emploi abidjan <?php echo date("Y"); ?>  et partout Cote d'ivoia vec eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez des opportuinités d'offres d'emploi ci <?php echo date("Y"); ?> sur Educarrier à abidjan avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Abidjan et partout en Cote d'ivoir. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sur Educarriere emploi ci <?php echo date("Y"); ?>, télecharger l'application eGoZola et retrouvez facilement des Offres d'emploi abidjan en Cote d'ivoir et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
