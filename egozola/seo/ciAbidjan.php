...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (225,'ciAbidjan','JS',' $lang','$mob',95,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
  ...
  <title>Recherche emploi <?php echo date("Y"); ?>? ou educarriere ci abidjan en Cote d'ivoir |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi et d'affaires sur educarriere ci abidjan <?php echo date("Y"); ?>. Télécharger notre application gratuite"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div style="text-align:center;margin-top: 10px"> <h1> Educarriere ci abidjan</h1> </div> 
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une Offre d'emploi sur Educarriere ci abidjan <?php echo date("Y"); ?> et partout Cote d'ivoir avec eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez des opportuinités d'offres d'emploi <?php echo date("Y"); ?> sur Educarrier ci abidjan avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Abidjan et partout en Cote d'ivoir. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger l'application eGoZola et retrouvez facilement des Offres d'emploi sur Educarriere ci abidjan en Cote d'ivoir et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
