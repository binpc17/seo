...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (225,'ciOffreRecru','JS',' $lang','$mob',97,'JS',NOW())");
    $ps->execute();
...
<head> 
  ...
  <title> Recherche emploi? Boulot ou recrutement <?php echo date("Y"); ?> en cote d'ivoire? C'est facile et rapide|eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi ci ou d'affaires et recrutement <?php echo date("Y"); ?> en cote d'ivoirer de moi sans me déplacer. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, recrutement <?php echo date("Y"); ?> en cote d'ivoire, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div style="text-align:center;margin-top: 10px"> <h1> Recrutement <?php echo date("Y"); ?> en cote d'ivoire</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ recrutement <?php echo date("Y"); ?> en cote d'ivoire: Trouve et Cherche travaile ou un emploi rapidement à abidjan sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire un recrutement <?php echo date("Y"); ?> en cote d'ivoire ou une Offre d'emploi abidjan et partout Cote d'ivoia vec eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez des opportuinités d'offres d'emploi abidjan ou recrutement <?php echo date("Y"); ?> en cote d'ivoire avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Abidjan et partout en Cote d'ivoir. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez facilement des Offres d'emploi abidjan  ou recrutement <?php echo date("Y"); ?> en cote d'ivoire et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
