...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'frAppart2','HS',' $lang','$mob',83,'ZOLA',NOW())");
      $ps->execute();
...
<head> 
 ...
 <title>Location appartement de particulier a particulier sans agence 974? Télécharger l'appli|eGoZola</title>
  <meta name="description" content="✓ Location appartement de particulier a particulier sans agence 974: Retrouvez ou Publier ton annonce, Business, appartement, maison en ligne tes services, produits et retrouvez un partenaire d'affaires. Télécharger notre application gratuite"/>
