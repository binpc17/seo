...
<head> 
 ...
 <title>Obtenez toutes les offres emploi au burkina faso  <?php echo date("Y"); ?> |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres emploi au burkina faso <?php echo date("Y"); ?> complet, Téléchargez l'application emploi au burkina faso pour un accès sans internet et bien plus encore partout avec ton téléphone"/>
  <meta name="keywords" content="Cherche Emploi, emploi au burkina faso "/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1>Obtenez toutes les offres emploi au burkina faso <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ emploi au burkina faso offre d'emploi: Trouve et Cherche du travaile ou un emploi rapidement au Burkina sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez rapidement une offre d’affaire ou emploi au burkina faso <?php echo date("Y"); ?> partout au Burkina avec l'application <strong>eGoZola gratuite </strong>
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail sur emploi au burkina faso avec votre téléphone sans inernet et gratuit.
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire ou tes services partout au Burkina. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ <strong>Télecharger eGoZola et retrouvez toutes les offres emploi au burkina faso <?php echo date("Y"); ?></strong> et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong style="color: darkgreen">Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
