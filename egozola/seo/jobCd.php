...
<head> 
 ...
 <title>Obtenez toutes les offres XXXX  <?php echo date("Y"); ?> |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres XXXX <?php echo date("Y"); ?> complet, Téléchargez l'applicatio XXXX pour un accès sans internet et bien plus encore partout avec ton téléphone"/>
 ...
 <link href="bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
   ...
   <script data-ad-client="ca-pub-2681997690755181" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
...
<div class="row" style="font-family: Calibri;margin-top: 30px">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ XXXX offre d'emploi: Trouve et Cherche du travaile ou un emploi rapidement en RDC sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez rapidement une offre d’affaire ou XXXX <?php echo date("Y"); ?> partout en RDC avec l'application <strong>eGoZola gratuite </strong>
...
<ins class="adsbygoogle"
     style="display:block"
     data-ad-client="ca-pub-2681997690755181"
