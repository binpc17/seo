...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkRec','JS',' $lang','$mob',105,'ZOLA',NOW())");
    $ps->execute();
...
<title>Recherche emploi? Découvrez les sites d'emploi et recrutement insd <?php echo date("Y"); ?> autour de moi et partout au Burkina |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi, petit travaux et d'affaires sur les meiileur sites d'emploi et recrutement insd <?php echo date("Y"); ?> au burkina faso et autour de moi. Télécharger notre application et decouvrez des emploi et petit travaux"/>
  <meta name="keywords" content="Cherche Emploi, les sites d'emploi, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Recrutement insd <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Decouvrez les meilleur sites d'emploi: Trouve et Cherche travaile, un emploi ou recrutement insd <?php echo date("Y"); ?> rapidement sans vous déplacer avec l'application eGoZola partout au Burlina faso
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou d'emploi et recrutement insd <?php echo date("Y"); ?>  sur les sites d'emploi grace à son meilleur application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce autour de moi. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi, recrutement insd <?php echo date("Y"); ?> et meilleurs sites d'emploi et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
