    ...
    <div style="margin-left: 20px;margin-top: 12px">
        ...
        <div class="row"  style="text-align: center;border-top: 1px solid #ccc" >
          <div class="col-xs-6" style="border-right: 1px solid #ccc">
            <a href="https://play.google.com/store/apps/details?id=app.youQuiz" style="color: black">
...
<br><span class="glyphicon glyphicon-ok-sign"> </span>✓ It is completely free! Find XXXX Play and enrich your knowledge <a href="https://play.google.com/store/apps/details?id=app.youQuiz" style="color:black"> <strong>Get it now <span class="glyphicon glyphicon-hand-right"></span>   Click here ↓↓ </strong> </a>.
			<br>
			<br>
