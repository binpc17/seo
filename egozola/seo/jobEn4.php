...
<head> 
 ...
 <title>Find all Personal classified ads near me <?php echo date("Y"); ?> |eGoZola</title>
  <meta name="description" content="✓ Get great Business offers from Personal classified ads near me <?php echo date("Y"); ?>  complete, Download this app for Personal classified ads near me and much more everywhere with your phone"/>
  <meta name="keywords" content="Cherche Emploi, Personal classified ads near me "/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1>Get all business Offers from Personal Classified ads Near me <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Personal classified ads near me : Find aand get jobs or business offer easily and quickly without moving
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Quickly find a business offer or Personal classified ads near me <?php echo date("Y"); ?> everywhere with the free <strong>eGoZola app</strong>
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ With eGoZola, Search a job, a business quickly and find a business partner on Personal classified ads near me with your phone without internet and free.
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your know-how or your services everywhere and earn your money confidentially and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ <strong>Download eGoZola and find our Personal classified ads near me <?php echo date("Y"); ?></strong> and business around me and much more.<a href="<?php echo $botUrl?>" style="clolor:black"> Download the app <strong style="color: darkgreen">Click here↓↓ </strong> </a>.
		<br>
		<br>
