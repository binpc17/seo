...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	...
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'adSite','JS',' $lang','$mob',63,'ZOLA',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
...
<head> 
 ...
 <title>Looking for free online advertising sites <?php echo date("Y"); ?>? i'ts fast and easy |eGoZola</title>
  <meta name="description" content="✓ Find or Make deal, Business offer or free free online advertising sites online <?php echo date("Y"); ?>, sell your services or your product for free with your smart phone. Get it now, download our free eGoZola app"/>
  <meta name="keywords" content="Cherche Emploi, free online advertising sites, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
      ...
      <div style="text-align: center"> <a href="<?php echo $botUrl?>" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
      <strong>To Get more business offers, download our Free Advertising App </strong> <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
            <img src="assets/playStor.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
 <div style="text-align:center;margin-top: 10px"> <h1> Find free online advertising sites</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get free online advertising sites: Are you looking for new deal or Business opportuinity near me? Try ou app eGoZola for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Post or Quickly find a business or hot deal, services and free online advertising sites near me <?php echo date("Y"); ?> everywhere around you with your eGoZola app. Get it for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ With eGoZola it's easy to find hot deal, services or free online advertising sites online near me and everywhere you go with your phone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your knowledge, your services or advertising online everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find best deal, local free online advertising sites near me <?php echo date("Y"); ?> and business around me and much more. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
