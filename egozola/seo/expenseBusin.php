...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expenseBusin','JS',' $lang','$mob',38,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>GET Simple Best business Expense tracker app <?php echo date("Y"); ?> for android |eGoZola</title>
  <meta name="description" content="✓ Transform your android smartphone into a real free best business expense tracker app and start saving your money smartly for free with eGoZola."/>
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile Best business Expense tracker app and extra tools in real time.  <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
