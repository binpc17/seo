...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'adOlxUsa','JS',' $lang','$mob',70,'ZOLA',NOW())");
    $ps->execute();
...
<title>Looking for websites like olx in usa <?php echo date("Y"); ?> Near me? i'ts fast and easy |eGoZola</title>
  <meta name="description" content="✓ Find or Make deal, Business offer or post on free classified websites like olx in usa, sell your services or your product near me for free with your smartphone. Get it now, download our free eGoZola app"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Free websites like olx in usa</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get or Post free Ads on Free websites like olx in usa: Are you looking for new deal or Business opportuinity near me? Try ou app eGoZola for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Post or Quickly find a business or hot deal, services and post free ads on websites like olx in usa advertising near me <?php echo date("Y"); ?> everywhere around you with your eGoZola app. Get it for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ With eGoZola it's easy to find hot deal, services or post for free your ads on Free websites like olx in usa near me and everywhere you go with your phone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell your knowledge, your services or advertising online everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find best deal, post free ads on Free classified websites like olx in usa near me <?php echo date("Y"); ?> and business around me and much more. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
