...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'posOffline','JS',' $lang','$mob',54,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>GET Best Simple free offline pos software download for android & web browser |eGoZola</title>
  <meta name="description" content="✓ Transform your smartphone into a real Simple free offline pos software download for sale app <?php echo date("Y"); ?> and start taking control of your business with an expense app integrated for free with eGoZola."/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
     ...
     <strong>Hey! Get and find more business offers, download our Free Best Simple free offline pos software </strong> <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
      ...
      <div style="text-align: center"> <a href="<?php echo $botUrl?>" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
  	    ...
  	    <div style="text-align:center"> <h1>Best free offline pos software </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best free offline pos software, track your salling, Business, your income and all your dailly expenses with free report. Download and get it for free
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your Business, with our Best free offline pos softwar for sale app. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ It's free and easy with eGoZola free offline pos software download free link all your shop into one and track your dailly income and profit repport.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free offline pos software downlaod for sale with budgeting app and extra tools in real time. Get it now for free. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
