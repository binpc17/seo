...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'jsYaounde','JS',' $lang','$mob',12,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Recherche emploi? Offre d'emploi à yaoundé <?php echo date("Y"); ?> et Douala en ligne |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi Youndé <?php echo date("Y"); ?> et recrutement jobinfocamer à Douala en ligne. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, Offre d'emploi à yaoundé <?php echo date("Y"); ?>, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
		  ...
		  <strong style="color: black">Hey! Obtenez toutes les offres d'Emploi et d'Affaires au Caméroun dans ton téléphone et bien plus encore, téléchargez notre application gratuite </strong>
<strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Offre d'emploi à yaoundé <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Offre d'emploi à yaoundé <?php echo date("Y"); ?>: Trouve et Cherche travaile ou un emploi rapidement à Yaoundé, Douala au cameroun sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une Offre d'emploi à yaoundé <?php echo date("Y"); ?> ou Douala et partout au cameroun avec eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail sur jobinfocamer <?php echo date("Y"); ?> offre d'emploi yaoundé avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Yaoundé, Douala et partout au cameroun. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi jobinfocamer et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
