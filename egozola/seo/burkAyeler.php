...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkAyeler','JS',' $lang','$mob',109,'ZOLA',NOW())");
      $ps->execute();
...
<head> 
 ...
 <title>Recherche emploi? sur Ayeler emploi burkina <?php echo date("Y"); ?> et à Ouga?</title>
  <meta name="description" content="✓ Retrouvez et Postulez sur Ayeler aux d’offres d'emploi au burkina <?php echo date("Y"); ?> et recrutement à Ouga. Découvrez des emplois et petits travaux Aayeler autour de vous. Télécharger l'application gratuite eGoZola"/>
  <meta name="keywords" content="Cherche Emploi, Ayeler emploi burkina <?php echo date("Y"); ?>, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Ayeler emploi burkina <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Offre d'emploi au burkina: Trouve et Cherche travaile, petit travaux ou Ayeler emploi burkina <?php echo date("Y"); ?> à Ouaga et partout au Burkina faso sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou Offre d'emploi burkina <?php echo date("Y"); ?> à Ouaga avec l'application Ayeler eGoZola.
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Ayeler emploi burkina <?php echo date("Y"); ?>, Cherche travaile rapidement et retrouvez un travail avec votre téléphone, télécharger l'application
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Ayeler et partout au Burkina. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
<br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des Offres d'emploi Ayeler au burkina <?php echo date("Y"); ?> et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
