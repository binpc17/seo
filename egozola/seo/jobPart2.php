...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'jOPen2','JS',' $lang','$mob',18,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Looking for deal or part-time jobs near me hiring immediately? i'ts fast and easy|eGoZola</title>
  <meta name="description" content="✓ Find or Apply for deal, Business offer or part-time jobs near me hiring immediately with your smart phone. Get it now, download our free eGoZola app"/>
  <meta name="keywords" content="Cherche Emploi, part-time jobs near me hiring immediately, Emploi au cameroun"/>
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
		   ...
		   <a href="<?php echo $botUrl?>" style="color: black">
            <strong>Hey! Get and Find more job, business offers and much more, download our free app </strong> <strong style="color: darkgreen"> Click here↓↓</strong> <br>
        ...
        <div class="row"  style="text-align: center;border-top: 1px solid #ccc" >
          <div class="col-xs-6" style="border-right: 1px solid #ccc">
            ...
            <label style=" overflow: hidden; max-height: 40px;margin-left: 10px font-weight: normal;">
             Jobs Offers & Busness</label> <!--{{'JSH' | translate}} -->
            </a>
          </div>
          <div class="col-xs-6" >
            <a href="<?php echo $botUrl?>" style="color: black">
...
<div style="text-align:center;margin-top: 10px"> <h1> Find deal, part-time jobs near me hiring immediately <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get part-time jobs near me hiring immediately: Are you looking for new Jobs, deal or Business opportuinity near me? Try ou app eGoZola for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Quickly find a business or job offer, services and part-time jobs near me hiring immediately <?php echo date("Y"); ?> everywhere around you with your eGoZola app. Get it for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ With eGoZola, Cherche work quickly, find hot deal, services or part-time jobs near me hiring immediately and job opportunities everywhere you go with your phone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your knowledge, your services or advertise everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find job offers, part-time jobs near me hiring immediately <?php echo date("Y"); ?> and business around me and much more. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
