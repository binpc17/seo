...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	...
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'adRent','JS',' $lang','$mob',66,'ZOLA',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
...
<head> 
 ...
 <title>Looking for Classified for Rent Near me? i'ts fast and easy |eGoZola</title>
  <meta name="description" content="✓ Find or Make deal, Business offer or post on free classified for rent near me online <?php echo date("Y"); ?>, sell your services or your product for free with your smart phone. Get it now, download our free eGoZola app"/>
  <meta name="keywords" content="Cherche Emploi, classified for rent near me, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Find Classified for Rent Near me <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get or Post for free on classified for rent near me: Are you looking for new deal or Business opportuinity near me? Try ou app eGoZola for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Post or Quickly find a business or hot deal, services and Free classified for rent near me online advertising everywhere around you with your eGoZola app. Get it for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ With eGoZola it's easy to find hot deal, services or Free classified for rent near me near me and everywhere you go with your phone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your knowledge, your services or advertising online everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find best deal, post for free on classified for rent near me <?php echo date("Y"); ?> and business around me and much more. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
