...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'weather','Tool',' $lang','$mob',74,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Simple Application Méteo france android gratuite |eGoZola</title>
  <meta name="description" content="✓ Télécharger la meilleur simple Application Méteo france android gratuite, avec coordonées GPS et en bonus une application de gestion dépenses quotidiennes intégrée"/>
  <meta name="keywords" content="Cherche Emploi, Application Méteo france android gratuite, Emploi au cameroun"/>
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
          ...
          <div style="text-align: center">
               <strong style="color: black">Hey! Obtenez notre Application Méteo france android gratuite et bien plus encore, téléchargez notre application gratuite </strong>  <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
      ...
      <div style="text-align: center"> <a href="<?php echo $botUrl?>" style="color: black"><strong>Télécharger & installer nos Outils  <span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
            <strong>Télécharger l'Application Méteo Gratuit</strong> <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
  	    <div style="text-align:center"> <h1>Application Méteo france android gratuite</h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Consulter la météo ou la prevision méteo pour demain avec la meilleur l'Application Méteo france android gratuite, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Obtenez les prévision météo jusqu'à 15 jours sans internet avec eGoZola l'Application Méteo france android.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Utiliser le GPS pour une meilleur pécision météo avec ton téléphone gràce à eGoZola l'Application Méteo france android gratuite la plus simplifié. Télécharger l'application <a href="<?php echo $botUrl?>" style="color: black"> <strong> Cliquer, ici ↓↓ </strong> </a>
