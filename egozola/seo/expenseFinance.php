...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expenseFinance','JS',' $lang','$mob',42,'ZOLA',NOW())");
    $ps->execute();
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
      ...
      <div style="text-align: center"> <a href="<?php echo $botUrl?>" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
           <strong>To Get more job and business offers, download our free Finance tracking app </strong> <strong style="color: darkgreen">  Click here ↓↓ </strong> <br>
            <img src="assets/playStor.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
  	    <div style="text-align:center"> <h1>Best Free Finance tracking apps <?php echo date("Y"); ?> </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best Free Finance tracking apps to manage expenses & debts, track your dailly spending Expenses with free report, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your money saving, with our Best Free android finance tracking apps. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best Free complete simple mobile finance tracking apps and extra tools in real time. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
