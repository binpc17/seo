...
<head> 
 ...
 <title>Obtenez toutes les offres emploi chauffeur <?php echo date("Y"); ?> à abidjan |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres emploi chauffeur <?php echo date("Y"); ?> à abidjan  complet, Téléchargez l'application emploi chauffeur <?php echo date("Y"); ?> à abidjan pour un accès sans internet et bien plus encore partout avec ton téléphone"/>
  <meta name="keywords" content="Cherche Emploi, emploi chauffeur <?php echo date("Y"); ?> à abidjan "/>
...
<strong style="color: black">Hey! Obtenez toutes les offres d'Emploi et d'Affaires en Côte d'ivoire dans ton téléphone et bien plus encore, téléchargez notre application gratuite </strong>  <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
 ...
 <div style="text-align:center;margin-top: 10px"> <h1>Obtenez toutes les offres emploi chauffeur <?php echo date("Y"); ?> à abidjan</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ emploi chauffeur <?php echo date("Y"); ?> à abidjan offre d'emploi: Trouve et Cherche du travaile ou un emploi rapidement en Cote d'ivoire sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez rapidement une offre d’affaire ou emploi chauffeur <?php echo date("Y"); ?> à abidjan et partout en Cote d'ivoire avec l'application <strong>eGoZola gratuite </strong>
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail sur emploi chauffeur <?php echo date("Y"); ?> à abidjan avec votre téléphone sans inernet et gratuit.
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire ou tes services partout en Cote d'ivoire. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ <strong>Télecharger eGoZola et retrouvez toutes les offres emploi chauffeur <?php echo date("Y"); ?> à abidjan</strong> et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong style="color: darkgreen">Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
         <strong>Pour voir plus des offres d'emplois et d'affaires en Cote d'ivoire, téléchargez notre application gratuite </strong>  <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
...
//echo ">>".sizeof($liste,0) >>> {$subjectData['urlJS']};
       ...
       foreach ($liste as $subjectData){
            echo "<li class='list-group-item'> <a href='<?php echo $botUrl?>' target='_blank' style='color: black'> <strong>".$subjectData['jobTitle']."</strong><br> <span class='glyphicon glyphicon-user'></span> ".$subjectData['userN']."| <em> Vieu(".$subjectData['sizeV'].") <span class='glyphicon glyphicon-map-marker'></span> ".$subjectData['town']."</em>";
