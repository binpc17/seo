...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkAyelerAnc','JS',' $lang','$mob',703,'JSEGO',NOW())");
        $ps->execute();
...
<head> 
 ...
 <title>Ayeler burkina faso petites annonces toutes les offres d'emploi <?php echo date("Y"); ?></title>
  <meta name="description" content="✓ Postulez et Retrouvez sur ayeler burkina faso petites annonces toutes les offres d'emploi et d'affaires. Découvrez tous les petites annonces d'offre d'emploi et petits bulots <?php echo date("Y"); ?> autour de vous."/>
  <meta name="keywords" content="Cherche Emploi, ayeler burkina faso petites annonces toutes les offres"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Ayeler burkina faso petites annonces toutes les offres d'emploi</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Ayeler burkina faso petites annonces toutes les offres: Trouve et Cherche travaile, petit boulot ou un emploi rapidement à Ouaga et partout au Burkina faso sans vous déplacer sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez rapidement une offre d’affaire ayeler burkina faso petites annonces toutes les offres d'emploi et des affaires à Ouaga avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche petit boulots et affaires rapidement sur ayeler burkina faso petites annonces toutes les offres facile et rapide avec votre téléphone
<br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des Offres d'emploi ayeler au burkina et recrutement <?php echo date("Y"); ?>, des opportuinités d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
