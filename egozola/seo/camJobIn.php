...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'Akwajobs','JS',' $lang','$mob',3,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Recherche emploi? Offre d'emploi jobinfocamer <?php echo date("Y"); ?> à Youndé et Douala en ligne |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d emploi <?php echo date("Y"); ?> et recrutement jobinfocamer à Youndé et Douala en ligne. Télécharger notre application gratuite"/>
...
<div style="text-align:center;margin-top: 10px"> <h1> Offres d'emploi jobinfocamer <?php echo date("Y"); ?> à Yaoundé, Douala</h1> </div> 
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou jobinfocamer offre d emploi à Yaoundé, Douala et partout au cameroun avec eGoZola
