...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'rdcHumanitaire','JS',' $lang','$mob',75,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Recherche travail? Retrouvez toutes les offres d'emploi humanitaire en rdc <?php echo date("Y"); ?> |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez à toutes les offres d'emploi humanitaire en rdc <?php echo date("Y"); ?> et recrutement en ligne partout en RDC. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, toutes les offres d'emploi humanitaire en rdc, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
          ...
          <div style="text-align: center">
               <strong style="color: black">Hey! Obtenez toutes les offres d'Emploi humanitaire en RDC dans ton téléphone et bien plus encore, téléchargez notre application gratuite </strong>  <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Toutes les offres d'emploi humanitaire en rdc </h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ offres d'emploi humanitaire en rdc <?php echo date("Y"); ?>: Trouve et Cherche travaile ou un emploi rapidement à kinshasa, Lubumbashi et Goma en RDC sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou outes les offres d'emploi humanitaire en rdc à kinshasa,Goma ou à Lubumbashi et partout au congo avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez des offres d'affaires ou Toutes les offres d'emploi humanitaire en rdc kinshasa avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à kinshasa, Lubumbashi et partout en RDC. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'affaires et toutes les offres d'emploi humanitaire en rdc kinshasa, Goma et Lubumbashi autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
