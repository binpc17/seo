...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'budgetSoft','JS',' $lang','$mob',36,'ZOLA',NOW())");
      $ps->execute();
...
<head> 
 ...
 <title>GET Simple private free Personal budget software <?php echo date("Y"); ?> for android & web browser |eGoZola</title>
  <meta name="description" content="✓ Transform your smartphone into a real private free Personal budget software apps <?php echo date("Y"); ?> and start saving your expense, money smartly for free with eGoZola."/>
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
		   ...
		   <a href="<?php echo $botUrl?>" style="color: black">
            <strong>Hey! Get our best free Personal budget software and much more, download our free app </strong> <strong style="color: darkgreen"> Click here↓↓</strong> <br>
     ...
     <strong>To get more Job and Business offers in your phone, download our free Personal Budgeting app </strong> <strong style="color: darkgreen"> Click here↓↓</strong> <br>
  	    ...
  	    <div style="text-align:center"> <h1>Best Free Personal budget software <?php echo date("Y"); ?> </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best android free Personal budget software <?php echo date("Y"); ?>, track your dailly budget spending expenses with free report, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your money saving, with our Best Free Personal budget software. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free Personal budget software <?php echo date("Y"); ?> and extra tools in real time.  <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
