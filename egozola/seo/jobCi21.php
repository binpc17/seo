...
<head> 
 ...
 <title>Obtenez toutes les offres Recrutement rp <?php echo date("Y"); ?> ci  |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres recrutement rp <?php echo date("Y"); ?> ci complet, Téléchargez l'application recrutement rp <?php echo date("Y"); ?> ci pour un accès sans internet et bien plus encore partout avec ton téléphone"/>
  <meta name="keywords" content="Cherche Emploi, recrutement rp <?php echo date("Y"); ?> ci "/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1>Obtenez toutes les offres recrutement rp <?php echo date("Y"); ?> ci</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Recrutement rp <?php echo date("Y"); ?> ci offre d'emploi: Trouve et Cherche du travaile ou un emploi rapidement en Cote d'ivoire sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez rapidement une offre d’affaire ou recrutement rp <?php echo date("Y"); ?> ci partout en Cote d'ivoire avec l'application <strong>eGoZola gratuite </strong>
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail sur recrutement rp <?php echo date("Y"); ?> ci avec votre téléphone sans inernet et gratuit.
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire ou tes services partout en Cote d'ivoire. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ <strong>Télecharger eGoZola et retrouvez toutes les offres recrutement rp <?php echo date("Y"); ?> ci</strong> et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong style="color: darkgreen">Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
