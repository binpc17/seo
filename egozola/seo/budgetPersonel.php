...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'budgetPersonel','JS',' $lang','$mob',35,'ZOLA',NOW())");
       $ps->execute();
...
<head> 
 ...
 <title>GET Simple personal accounting software free download full version <?php echo date("Y"); ?></title>
  <meta name="description" content="✓ Transform your smartphone into a real private Simple personal accounting software free download <?php echo date("Y"); ?> and start saving your accounting expense & money smartly for free on Android with eGoZola."/>
  <meta name="keywords" content="Cherche Emploi, free Personal budget software, Emploi au cameroun"/>
    ...
    <div style="margin-left: 20px">
		 <div style="text-align: center">
		   <a href="<?php echo $botUrl?>" style="color: black">
            <strong>Hey! Get and find more job or business offers and much more, download our free app </strong> <strong style="color: darkgreen"> Click here↓↓</strong> <br>
      ...
      <div style="text-align: center"> <a href="<?php echo $botUrl?>" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
    <strong>To get more Job and Business offers in your phone, download our free Personal Budgeting app </strong> <strong style="color: darkgreen"> Click here↓↓</strong> <br>
            <img src="assets/playStor.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
  	    <div style="text-align:center"> <h1>Simple personal accounting software free download full version </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best android personal accounting software free <?php echo date("Y"); ?>, track your dailly budget spending expenses with free report, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Get free accounting app and take control of your money saving, with our Best Free personal accounting software for android. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free Personal accounting software and extra tools for android in real time.  <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
