...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'Burkunicef','JS',' $lang','$mob',113,'ZOLA',NOW())");
        $ps->execute();
...
<title>Offre d'emploi unicef & recrutement au burkina? C'est facile et rapide |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’Offre d'emploi unicef à Ouaga et ou recrutement unicef burkina en ligne. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, unicef burkina recrutement, Emploi au cameroun"/>
...
<div style="text-align:center;margin-top: 10px"> <h1> unicef burkina recrutement <?php echo date("Y"); ?> </h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Offre d'emploi unicef rdc <?php echo date("Y"); ?>: Trouve et Cherche travaile ou un emploi rapidement à Ouaga et partout au Burkinafaso sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une Offre d'emploi unicef ou recrutement ou Burkina avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez des offres d'affaires, recrutement ou des Offres d'emploi unicef Burkina avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Ouaga et partout au Burkina. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'affaires et Offre d'emploi unicef Burkina ou recrutement <?php echo date("Y"); ?>, kinshasa, lumbumashi et autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
