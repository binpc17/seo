...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'Camerspace','JS',' $lang','$mob',5,'JS',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Recherche emploi? Offre d'emploi camerjob <?php echo date("Y"); ?> à Youndé et Douala en ligne |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d emploi <?php echo date("Y"); ?> et recrutement camerjob à Youndé et Douala en ligne. Télécharger notre application gratuite"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou camerjob offre d emploi à Yaoundé, Douala et partout au cameroun avec eGoZola
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Yaoundé, Douala et partout au cameroun. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi camerjob et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
