...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'venteLigne','SHOP',' $lang','$mob',81,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Recherchez-vous une application de vente en ligne autour de moi? Télécharger l'appli|eGoZola</title>
  <meta name="description" content="✓ Application de vente en ligne: Retrouvez ou Publier ton annonce, Business, emploi, vendez en ligne tes services, produits, maison ou appartement et retrouvez un partenaire d'affaires. Télécharger notre application gratuite"/>
  <meta name="keywords" content="application de vente en ligne, vente en ligne, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
         ...
         <strong>Hey! Obtenez toutes les offres d'Emploi et d'Affaires dans ton téléphone et bien plus encore, téléchargez notre application gratuite </strong>  <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
...
<div style="text-align:center"> <h1>Application de vente en ligne</h1></div>  
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Application de vente en ligne autour: Cherchez ou faites des affaire rapidement sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola l'Application de vente en ligne: Publier ton annonce, vendez ton savoir et tes services. Retrouvez des partenaires d'affaire avec l'application eGoZola
  <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez la personne ou l'affaire qu’il vous faut ou un service à domicile. 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes produits, tes services ou annonce. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness avec l'Application de vente en ligne: 
