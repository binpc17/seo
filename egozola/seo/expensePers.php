...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expensePers','JS',' $lang','$mob',40,'ZOLA',NOW())");
    $ps->execute();
...
<title>GET Simple Best personal expense tracker app <?php echo date("Y"); ?> for android |eGoZola</title>
  <meta name="description" content="✓ Transform your android smartphone into a real free personal expense tracker app and start saving your money smartly for free with eGoZola."/>
  <meta name="keywords" content="Cherche Emploi, personal expense tracker app, Emploi au cameroun"/>
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
      ...
      <div style="text-align: center"> <a href="<?php echo $botUrl?>" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
     <strong>To Get more job and business offers, download our free Personal expense app </strong> <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
            <img src="assets/playStor.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
  	    <div style="text-align:center"> <h1>Best Personal expense tracker app <?php echo date("Y"); ?> </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Free personal expense tracker app android, track your dailly spending Expenses with free report, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your money saving, with our Free personal expense tracker app. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete Free simple mobile Best personal expense tracker app and extra tools in real time. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
