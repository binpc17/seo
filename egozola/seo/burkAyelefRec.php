...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkAyelefRec','JS',' $lang','$mob',110,'ZOLA',NOW())");
       $ps->execute();
...
<head> 
 ...
 <title>Recherche emploi? ou Offre d'emploi au burkina & ayeler recrutement <?php echo date("Y"); ?>? eGoZola</title>
  <meta name="description" content="✓ Retrouvez, Postulez aux d’offres d'emploi au burkina et sur ayeler recrutement <?php echo date("Y"); ?> à Ouga. Découvrez des emploi et petits travaux autour de vous. Télécharger notre application gratuite"/>

  <meta name="keywords" content="Cherche Emploi, Ayeler recrutement <?php echo date("Y"); ?>, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Offre d'emploi Ayeler recrutement <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Ayeler recrutement <?php echo date("Y"); ?> au Burkina: Trouve et Cherche travaile, petit travaux ou un emploi rapidement à Ouaga et partout au Burkina faso sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une Offre d'emploi sur ayeler recrutement <?php echo date("Y"); ?> au burkina à Ouaga avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez une Offre d'emploi ou ayeler recrutement au burkina avec votre téléphone
<br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des Offres d'emploi ayeler au burkina et recrutement <?php echo date("Y"); ?>, des opportuibités d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
