...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (213,'algPublique','JS',' $lang','$mob',102,'ZOLA',NOW())");
        $ps->execute();
...
<title>Recherche emploi? Offre emploi algerie fonction publique. C'est facile et rapide |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi algerie fonction publique, petit travaux et d'affaires sur les meiileur sites d'emploi autour de moi. Télécharger notre application et decouvrez des emploi et petit travaux"/>
  <meta name="keywords" content="Cherche Emploi, algerie fonction publique, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Offre emploi algerie fonction publique</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Decouvrez les meilleur sites d'emploi: Trouve et Cherche travaile ou une Offre emploi algerie fonction publique rapidement sans vous déplacer avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire, une Offre emploi algerie fonction publique sur les sites d'emploi grace à son meilleur application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce autour de moi. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi algerie fonction publique, et meilleurs sites d'emploi et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
