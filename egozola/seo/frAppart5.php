...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'frAppart5','HS',' $lang','$mob',87,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Location appartement de particulier a particulier sans agence martinique | eGoZola</title>
  <meta name="description" content="✓ Location appartement de particulier a particulier sans agence martinique: Retrouvez ou Publier ton annonce d'appartement ou maison en ligne et et retrouvez un locataire à martinique. Télécharger notre application gratuite"/>
