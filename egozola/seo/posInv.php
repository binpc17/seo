...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'posInv','JS',' $lang','$mob',50,'ZOLA',NOW())");
    $ps->execute();
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
     ...
     <strong>Hey! Get more business offers, download our Free POS System inventory app </strong> <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
