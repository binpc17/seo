...
<head> 
 ...
 <title>Find all Online Business Opportunities from home <?php echo date("Y"); ?> |eGoZola</title>
  <meta name="description" content="✓ Get greate Business offers from Online Business Opportunities from home <?php echo date("Y"); ?>  complete, Download this app for online business opportunities from home and much more everywhere with your phone"/>
  <meta name="keywords" content="Cherche Emploi, online business opportunities from home "/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
         ...
         <strong style="color: black">  Get and find more Job and Business offers in your phone and much more, download our free app</strong>  <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
 ...
 <div style="text-align:center;margin-top: 10px"> <h1>Get all business Offers from Online Business Opportunities from home <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ online business opportunities from home : Fiand aand get jobs or business offer easily and quickly without moving
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Quickly find a business offer or online business opportunities from home <?php echo date("Y"); ?> everywhere with the free <strong>eGoZola app</strong>
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ With eGoZola, Search a job, a business quickly and find a business partner on online business opportunities from home with your phone without internet and free.
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your know-how or your services everywhere and earn your money confidentially and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ <strong>Download eGoZola and find our online business opportunities from home <?php echo date("Y"); ?></strong> and business around me and much more.<a href="<?php echo $botUrl?>" style="clolor:black"> Download the app <strong style="color: darkgreen">Click here↓↓ </strong> </a>.
		<br>
		<br>
