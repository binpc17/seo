...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkJobEtude','JS',' $lang','$mob',701,'JSEGO',NOW())");
        $ps->execute();
...
<head> 
 ...
 <title>Recherchez-vous un emploi? jobetudes.net offre d'emploi <?php echo date("Y"); ?></title>
  <meta name="description" content="✓ Trouvez et Postulez aux d’offres d'emploi ou jobetudes.net offre d'emploi burkina <?php echo date("Y"); ?> à Ouga. Découvrez tous les jobetudes.net offre d'emploi et petits boulots autour de vous sans vous déplacer"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ jobetudes.net offre d'emploi: Trouve et Cherche travaile, petit travaux ou un emploi rapidement à Ouaga et partout au Burkina faso sans vous déplacer sur jobetudes.net offre d'emploi 2021 eGoZola
