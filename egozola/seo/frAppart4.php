...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'frAppart','HS',' $lang','$mob',82,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Location appartement de particulier a particulier sans agence montpellier? Télécharger l'appli|eGoZola</title>
  <meta name="description" content="✓ Location appartement de particulier a particulier sans agence montpellier: Retrouvez ou Publier ton annonce, Business, appartement, maison en ligne tes services, produits et retrouvez un partenaire d'affaires. Télécharger notre application gratuite"/>
...
<div style="text-align:center"> <h1>location appartement de particulier</h1></div>  
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola l'Application de location appartement de particulier a particulier sans agence montpellier: Publier ton annonce, appartement ou maison ou vendez ton savoir et tes services. Retrouvez des partenaires d'affaire avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou ton appartement, maison. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness avec egoZola l'Application de location appartement de particulier a particulier sans agence montpellier. 
