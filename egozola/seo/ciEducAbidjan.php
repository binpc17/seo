...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (225,'ciEducAbidjan','JS',' $lang','$mob',93,'ZOLA',NOW())");
    $ps->execute( array());
...
<head> 
  ...
  <title>Recherche emploi abidjan? et partout en Cote d'ivoir, C'est facile et rapide |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi abidjan et d'affaires sur educarriere emploi ci en Cote d'ivoire. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, Recherche emploi abidjan, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div style="text-align:center;margin-top: 10px"> <h1> Recherche emploi Abidjan</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Emploi abidjan: Trouve et Cherche travaile ou un emploi rapidement à abidjan sans vous déplacer, Télécharger notre appli gratuite
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une Offre d'emploi abidjan <?php echo date("Y"); ?> et partout Cote d'ivoir avec eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez des opportuinités d'offres d'emploi à abidjan avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Abidjan et partout en Cote d'ivoir. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger l'application eGoZola et retrouvez facilement des Offres d'emploi abidjan en Cote d'ivoir et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
