...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expenseSimple','JS',' $lang','$mob',46,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>GET Best Simple expense tracker app android <?php echo date("Y"); ?>. Get it Now |eGoZola</title>
  <meta name="description" content="✓ Transform your android smartphone into a real free Simple expense tracker app android for your daily spending and start saving your money smartly for free with eGoZola."/>
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
		   ...
		   <a href="<?php echo $botUrl?>" style="color: black">
            <strong>Get more job, business offers and much more, download our free app </strong> <strong style="color: darkgreen"> Click here↓↓</strong> <br>
      ...
      <div style="text-align: center"> <a href="<?php echo $botUrl?>" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
           <strong>To Get more business offers, download our Free Expense Tracker app </strong> <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
            <img src="assets/playStor.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
  	    <div style="text-align:center"> <h1>Free Simple expense tracker app <?php echo date("Y"); ?> </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best Free Simple expense tracker app <?php echo date("Y"); ?> for android, track your daily spanding with free report, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your money saving, with our best Simple expense tracker app <?php echo date("Y"); ?> for all your daily expenses record. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete Simple expense tracker app android <?php echo date("Y"); ?> mobile and extra tools in real time. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
