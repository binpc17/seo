...
require_once ("./connJS.php");
 ...
 if($uDev>0){
 $mob="Mob";
 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'adNear','JS',' $lang','$mob',59,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Looking for Free Classified Ads near me <?php echo date("Y"); ?>? i'ts fast and easy |eGoZola</title>
  <meta name="description" content="✓ Find or Make deal, Business offer or post for free on classified ads near me <?php echo date("Y"); ?> & worlwide online, sell your services or your product for free with your smart phone. Get it now, download our free eGoZola app"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Post or Quickly find a business or hot deal, services and post free classified ads near me <?php echo date("Y"); ?> & everywhere around you with your eGoZola app. Get it for free
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your knowledge, your services or advertising online everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find best deal, post for free on the Best full classified ads near me <?php echo date("Y"); ?> and business around me and much more. Get it now for free. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
