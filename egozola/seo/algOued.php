...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (213,'algOued','JS',' $lang','$mob',101,'ZOLA',NOW())");
     $ps->execute();
...
<title>Cherche travail ouedkniss? Retrouvez les sites d'emploi et Petit travaux autour de moi |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi, petit travaux sur les meiileur sites d'emploi et travail ouedkniss autour de moi. Télécharger notre application et decouvrez des emploi et petit travaux"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Cherche travail ouedkniss ou emploi?</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Decouvrez les meilleur sites d'emploi: Trouve et Cherche travaile ouedkniss ou un emploi rapidement sans vous déplacer avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou d'emploi sur les sites d'emploi ou travail ouedkniss grace à son meilleur application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce autour de vous. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi, travail ouedkniss et d'autres meilleurs sites d'emploi et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
