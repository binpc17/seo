...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'frAppart','HS',' $lang','$mob',86,'ZOLA',NOW())");
      $ps->execute();
...
<title>Location appartement de particulier a particulier sans agence 93? Télécharger l'appli|eGoZola</title>
  <meta name="description" content="✓ Location appartement de particulier a particulier sans agence 93: Retrouvez ou Publier ton annonce, Business, appartement, maison en ligne tes services, produits et retrouvez un partenaire d'affaires. Télécharger notre application gratuite"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    ...
    <strong style="color: black"> Pour  voir plus des maisons et location appartement de particulier</strong> <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
