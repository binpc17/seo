...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'budgetingSimple','JS',' $lang','$mob',43,'ZOLA',NOW())");
      $ps->execute();
...
<title>GET Free Simple budgeting app <?php echo date("Y"); ?> for android & web browser |eGoZola</title>
  <meta name="description" content="✓ Transform your smartphone into a real private free Simple budgeting app <?php echo date("Y"); ?> and start saving your expense, money smartly for free with eGoZola."/>
  <meta name="keywords" content="Cherche Emploi, free Simple budgeting app <?php echo date("Y"); ?>, Emploi au cameroun"/>
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
      ...
      <div style="text-align: center"> <a href="<?php echo $botUrl?>" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
           <strong>To get more Job and Business offers in your phone, download our Free Simple budgeting app </strong> <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
            <img src="assets/playStor.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
  	    <div style="text-align:center"> <h1>Best Free Simple budgeting app <?php echo date("Y"); ?> </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best Personal Free Simple budgeting app <?php echo date("Y"); ?>, track your dailly budget spending expenses with free report, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your money saving, with our Best Free Personal Simple budgeting app. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free Personal Simple budgeting app and extra tools in real time. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
