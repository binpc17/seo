...
<head> 
 ...
 <title>Get the best Personal expense tracker app free  <?php echo date("Y"); ?> |eGoZola</title>
  <meta name="description" content="✓ Manage your money intelligently with our Personal expense tracker app free <?php echo date("Y"); ?> complet. Download the app Personal expense tracker app free free and much more everywhere with your phone"/>
  <meta name="keywords" content="Cherche Emploi, Personal expense tracker app free "/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
         ...
         <strong style="color: black">Hey! Get the best tool for Personal expense tracker app free, download our free app now </strong>  <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
        ...
        <div class="row"  style="text-align: center;border-top: 1px solid #ccc" >
          ...
          <a href="https://egozola.com/GooglePlay.php?hl=fr&apId=old" style="color: black">
            ...
            <label style=" overflow: hidden; max-height: 40px;margin-left: 10px">
              <strong>Manage my Expense</strong></label> 
          </a>
        </div>.
		        <div class="col-xs-6">
          <a href="https://egozola.com/GooglePlay.php?hl=fr&apId=old" style="color: black">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1>Get the best Personal expense tracker app free  <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Personal expense tracker app free of finance: Manage your savings and your money intelligently through your phone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Regularly monitor all your Personal expense tracker app free <?php echo date("Y"); ?> everywhere with the free <strong> eGoZola </strong> app
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ With the eGoZola application, spend less and save more thanks to its Personal expense tracker app free with your phone without internet and free.
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Access and Personal expense tracker app free Budget Manager, Daily Expenses and Monthly Debt Inventory with your phone using the free eGoZola app.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ <strong>Download eGoZola and find all the Personal expense tracker app free <?php echo date("Y"); ?></strong> And much more. <a href="<?php echo $botUrl?>" style="clolor:black"> Download the app now<strong style="color: darkgreen">Click here↓↓ </strong> </a>.
		<br>
		<br>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
         <strong style="color: black"> To see more job and business offers, download our free app </strong>  <strong style="color: darkgreen"> Click here↓↓ </strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
