...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'budgetApp2','JS',' $lang','$mob',34,'ZOLA',NOW())");
        $ps->execute();
...
<head> 
 ...
 <title>GET Simple Free best budget app android <?php echo date("Y"); ?>, saving your money smartly </title>
  <meta name="description" content="✓ Track, Transform your smartphone into a real Free best budget app android <?php echo date("Y"); ?> and start saving your money smartly for free using eGoZola free download ."/>
  <meta name="keywords" content="Cherche Emploi, Free best budget app android, Emploi au cameroun"/>
    ...
    <div style="margin-left: 20px">
		 <div style="text-align: center">
		   <a href="<?php echo $botUrl?>" style="color: black">
            <strong>Hey! get our Free best budget app android and much more, download our free app </strong> <strong style="color: darkgreen"> Click here↓↓</strong> <br>
      ...
      <div style="text-align: center"> <a href="<?php echo $botUrl?>" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
                <strong>To get more Job and Business offers in your phone, download our Free best budget app </strong>  <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
            <img src="assets/playStor.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
  	    <div style="text-align:center"> <h1> Free Best budget app android <?php echo date("Y"); ?> </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best budget app android, track your expense and dailly spending Budget with free report, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your budget and money saving, with our simple Best Budget app android <?php echo date("Y"); ?>. Get it now and increase your income with free download.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile budget app android and extra tools in real time. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
