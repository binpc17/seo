...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'jsInYounde','JS',' $lang','$mob',14,'ZOLA',NOW())");
    $ps->execute();
...
<title>Recherche emploi? Retrouvez jobs in Yaoundé <?php echo date("Y"); ?>, Douala au cameroun |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi, jobs in Yaoundé <?php echo date("Y"); ?> et recrutement à Youndé et Douala sans vous déplacer. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, jobs in Yaoundé <?php echo date("Y"); ?>, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Find jobs in Yaoundé <?php echo date("Y"); ?> ou à Douala</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get jobs in Yaoundé <?php echo date("Y"); ?>: Trouve et Cherche travaile ou un emploi rapidement à Yaoundé, Douala au cameroun sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou d' emploi jobs in Yaoundé <?php echo date("Y"); ?> ou in Douala et partout au cameroun avec eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail, jobs in Yaoundé <?php echo date("Y"); ?> et offre d'emploi avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce in Yaoundé, Douala et partout au cameroun. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi, jobs in Yaoundé <?php echo date("Y"); ?> et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
