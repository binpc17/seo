...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'jobNoExp','JS',' $lang','$mob',32,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Looking for jobs that require no experience near me <?php echo date("Y"); ?>? i'ts fast and easy |eGoZola</title>
  <meta name="description" content="✓ Find or Apply for deal, Business offer or jobs that require no experience near me with your smart phone. Get it now, download our free eGoZola app"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Find deal, jobs that require no experience near me <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get jobs that require no experience near me: Are you looking for new Jobs, deal or Business opportuinity near me? Try ou app eGoZola for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Quickly find a business or job offer, services and jobs that require no experience near me <?php echo date("Y"); ?> everywhere around you with your eGoZola app. Get it for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ With eGoZola, Cherche work quickly, find hot deal, services or jobs that require no experience near me everywhere you go with your phone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your knowledge, your services or advertise everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find job offers, jobs that require no experience near me <?php echo date("Y"); ?> and business around me and much more. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
