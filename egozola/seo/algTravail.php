...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (213,'algTravail','JS',' $lang','$mob',99,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Recherche emploi? ou je cherche un travail en Algérie? C'est facile et rapide |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi et recrutement en algérie, Cherchez un travail autour de moi. Télécharger notre application gratuite"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Chercher facilement un travaile, trouvez rapidement une offre d’affaire ou une Offre d'emploi dz en algérie gràce à l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez des offre d'emploi ou d'affaire partout en algérie avec votre téléphone
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi, travail et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
