...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (243,'ksKin','JS',' $lang','$mob',10,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Recherche emploi? Offre d'emploi kinshasa <?php echo date("Y"); ?> et partout en RDC |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi <?php echo date("Y"); ?> Kinshasa et recrutement en ligne partout en RDC. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, Offre d'emploi kinshasa <?php echo date("Y"); ?>, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Businnes et Offre d'emploi kinshasa <?php echo date("Y"); ?> </h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Offre d'emploi kinshasa <?php echo date("Y"); ?>: Trouve et Cherche travaile ou un emploi rapidement à kinshasa, Lubumbashi et Goma en RDC sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une Offre d'emploi kinshasa <?php echo date("Y"); ?>, ou à Lubumbashi et partout en RDC avec l'application eGoZola
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à kinshasa, Lubumbashi et partout en RDC. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'affaires et Offre d'emploi kinshasa <?php echo date("Y"); ?> autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
