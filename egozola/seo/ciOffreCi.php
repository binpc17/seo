...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (225,'ciOffreCi','JS',' $lang','$mob',92,'JS',NOW())");
    $ps->execute();
...
<head> 
  ...
  <title>Recherche emploi? ou une Offre d'emploi en cote d'ivoire <?php echo date("Y"); ?>? C'est facile et rapide |eGoZola</title>
  <meta name="description" content="✓ Retrouvez des Ofrres emploi en cote d'ivoire <?php echo date("Y"); ?> et Postulez aux d’offres d'emploi ci et d'affaires à Abidjan sans vous déplacer. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, emploi en cote d'ivoire <?php echo date("Y"); ?>, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div style="text-align:center;margin-top: 10px"> <h1> Offre d'emploi en cote d'ivoire <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Offre d'emploi en cote d'ivoire: Trouve et Cherche travaile ou un emploi rapidement à abidjan sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou des offres d'emploi en cote d'ivoire <?php echo date("Y"); ?> et à Abidjant avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez des opportuinités d'offres emploi en cote d'ivoire <?php echo date("Y"); ?> avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Abidjan et partout en Cote d'ivoir. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez facilement des Offres emploi en cote d'ivoire <?php echo date("Y"); ?> et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
