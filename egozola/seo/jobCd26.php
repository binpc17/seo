...
<head> 
 ...
 <title>Obtenez toutes les offres Appartement à louer à kinshasa  <?php echo date("Y"); ?> |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et découvrez des d’offres appartement à louer à kinshasa <?php echo date("Y"); ?> complet, Téléchargez l'application appartement à louer à kinshasa pour un accès sans internet et bien plus encore partout avec ton téléphone"/>
  <meta name="keywords" content="Cherche Emploi, appartement à louer à kinshasa "/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1>Obtenez toutes les offres appartement à louer à kinshasa <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Appartement à louer à kinshasa:  Trouve et Cherche un appartement ou une maison rapidement en RDC sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez rapidement une offre d’affaire ou appartement à louer à kinshasa <?php echo date("Y"); ?> partout en RDC avec l'application <strong>eGoZola gratuite </strong>
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche maison rapidement et retrouvez un appartement à louer à kinshasa avec votre téléphone sans inernet et gratuit.
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire ou tes services partout en RDC. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ <strong>Télecharger eGoZola et retrouvez toutes les offres appartement à louer à kinshasa <?php echo date("Y"); ?></strong> et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong style="color: darkgreen">Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
