...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkOnefRec','JS',' $lang','$mob',108,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Recherche emploi? ou Offre d'emploi au burkina Onef recrutement <?php echo date("Y"); ?>? C'est facile et rapide |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi au burkina et onef recrutement <?php echo date("Y"); ?> à Ouga. Découvrez des emploi et petits travaux autour de vous. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, Offre d'emploi au burkina <?php echo date("Y"); ?>, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Offre d'emploi onef recrutement <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Onef recrutement <?php echo date("Y"); ?> au Burkina: Trouve et Cherche travaile, petit travaux ou un emploi rapidement à Ouaga et partout au Burkina faso sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou Offre d'emploi sur onef recrutement <?php echo date("Y"); ?> au burkina à Ouaga avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail ou Offre d'emploi, onef recrutement <?php echo date("Y"); ?> au burkina avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Ouaga et partout au Burkina. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
<br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des Offres d'emploi au burkina et onef recrutement <?php echo date("Y"); ?>, des opportuibités d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
