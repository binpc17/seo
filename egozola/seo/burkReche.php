...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkReche','JS',' $lang','$mob',112,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Recherche d'emploi au burkina faso ouagadougou? c'est facile et rapide |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi au burkina <?php echo date("Y"); ?> et recrutement à ouagadougou. Découvrez des emploi et petits travaux autour de vous partout au Burkina. Télécharger notre application gratuite"/>
...
<br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des Offres d'emploi au burkina faso <?php echo date("Y"); ?> et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
