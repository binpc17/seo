...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (243,'mediacongo','JS',' $lang','$mob',8,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Recherche travail? offre d'emploi mediacongo <?php echo date("Y"); ?> et partout en RDC |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi mediacongo <?php echo date("Y"); ?> et recrutement à Kishasa, Goma, et Lubumbashi en ligne partout en RDC. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, Offre d'emploi mediacongo, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div style="text-align:center;margin-top: 10px"> <h1> Offre d'emploi mediacongo </h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓Offre d'emploi mediacongo <?php echo date("Y"); ?>: Trouve et Cherche travaile ou un emploi rapidement à kinshasa, Lubumbashi et Goma en RDC sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une Offre d'emploi mediacongo <?php echo date("Y"); ?> à kinshasa, Goma et à Lubumbashi et ou partout en RDC avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez des offres d'affaires ou des Offres d'emploi kinshasa avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à kinshasa, Lubumbashi et partout en RDC. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'affaires et Offre d'emploi mediacongo <?php echo date("Y"); ?> à kinshasa, Lubumbashi et autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
