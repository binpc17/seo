...
<head> 
 ...
 <title>Obtenez toutes les offres nouveau site de petites annonces <?php echo date("Y"); ?> |eGoZola</title>
  <meta name="description" content="✓ Retrouvez des offres d'affaires sur le nouveau site de petites annonces <?php echo date("Y"); ?> complet, Téléchargez l'application nouveau site de petites annonces pour un accès sans internet et bien plus encore partout avec ton téléphone"/>
  <meta name="keywords" content="Cherche Emploi, nouveau site de petites annonces "/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1>Obtenez toutes les offres  d'affaires sur nouveau site de petites annonces <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Nouveau site de petites annonces offre d'emploi: Trouve et Cherche du travaile ou une affaire rapidement sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez rapidement une offre d’affaire ou nouveau site de petites annonces <?php echo date("Y"); ?> partout avec l'application <strong>eGoZola gratuite </strong>
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile, une affaire rapidement et retrouvez un partenaire d'affaire sur le nouveau site de petites annonces avec votre téléphone sans inernet et gratuit.
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire ou tes services partout et Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ <strong>Télecharger eGoZola et retrouvez notre nouveau site de petites annonces <?php echo date("Y"); ?></strong> et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong style="color: darkgreen">Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
         <strong style="color: black"> Pour voir plus des offres d'emplois et d'affaires en Cote d'ivoire, téléchargez notre application gratuite </strong>  <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
