...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (243,'unicef','ZOLA',' $lang','$mob',9,'JS',NOW())");
    $ps->execute();
...
<title>Obtenez toutes les Offre d'emploi unicef rdc <?php echo date("Y"); ?>, Kishasa, Lubumbshi et Goma |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’Offre d'emploi unicef rdc et recrutement en ligne partout en RDC, Kinshasa, Goma, Lubumbashi. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, Akwajobs, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
        ...
        <strong style="color: black">Hey! Obtenez toutes les offres d'Emploi et d'Affaires en RDC dans ton téléphone et bien plus encore, téléchargez notre application gratuite </strong>  <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
          <div style="text-align: center">
            <strong style="color: black"> Pour Obtenir toutes les Offres d'emploi dans ton téléphone et d'affaires en RDC, téléchargez notre application gratuite </strong> <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
            <img src="assets/playStore.png" style="border-radius: 7px;width:170px;height:42px" alt="eGoZola">
          </div>
        </a>
<div style="text-align:center;margin-top: 10px"> <h1> Offre d'emploi unicef rdc <?php echo date("Y"); ?> </h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Offre d'emploi unicef rdc <?php echo date("Y"); ?>: Trouve et Cherche travaile ou un emploi rapidement à kinshasa, Lubumbashi et Goma en RDC sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une Offre d'emploi unicef rdc,à kinshasa, goma et à Lubumbashi et ou partout en RDC avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez des offres d'affaires ou des Offres d'emploi unicef rdc avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à kinshasa, Lubumbashi et partout en RDC. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'affaires et Offre d'emploi unicef rdc <?php echo date("Y"); ?>, kinshasa, lumbumashi et autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
