...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expenseManager','JS',' $lang','$mob',72,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>GET Simple app to Manage Expenses <?php echo date("Y"); ?> for android |eGoZola </title>
  <meta name="description" content="✓ Transform your android smartphone into a real free Best app to manage expenses <?php echo date("Y"); ?> and start saving your money smartly for free with eGoZola."/>
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
      ...
      <strong>To Get more business offers, download our Free Expenses Manager App</strong> <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
  	    ...
  	    <div style="text-align:center"> <h1>Best Free app to manage expenses <?php echo date("Y"); ?> </h1> </div> 
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best Free complete simple mobile app to manage expenses and extra tools in real time. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
