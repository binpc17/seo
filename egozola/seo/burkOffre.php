...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkOffre','JS',' $lang','$mob',107,'JS',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Recherche emploi? ou Offre d'emploi au burkina <?php echo date("Y"); ?> et à Ouga?</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi au burkina <?php echo date("Y"); ?> et recrutement à Ouga. Découvrez des emploi et petits travaux autour de vous. Télécharger notre application"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Offre d'emploi au burkina: Trouve et Cherche travaile, petit travaux ou un emploi rapidement à Ouaga et partout au Burkina faso sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement des offres d’affaire ou Offre d'emploi au burkina <?php echo date("Y"); ?> à Ouaga avec l'application eGoZola emploi
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail ou Offre d'emploi au burkina <?php echo date("Y"); ?> avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Yaoundé, Douala et partout au Burkina. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
<br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des Offres d'emploi au burkina <?php echo date("Y"); ?> et d'affaire autour de moi et bien plus encore. <a href="<?php echo $botUrl?>" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
