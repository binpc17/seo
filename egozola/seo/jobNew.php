...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'jobNew','JS',' $lang','$mob',26,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>Looking for new job openings near me? i'ts fast and easy |eGoZola</title>
  <meta name="description" content="✓ Find or Apply for deal, Business offer or new job openings near me no experience with your smart phone. Get it now, download our free eGoZola app"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Find deal, new job openings near me <?php echo date("Y"); ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get new job openings near me: Are you looking for new Jobs, deal or Business opportuinity near me? Try ou app eGoZola for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Quickly find a business or job offer, services and new job openings near me <?php echo date("Y"); ?> everywhere around you with your eGoZola app. Get it for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ With eGoZola, Cherche work quickly, find hot deal, services or new job openings near me everywhere you go with your phone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your knowledge, your services or advertise everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find job offers, new job openings near me and business around me and much more. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
