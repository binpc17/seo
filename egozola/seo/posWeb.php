...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'posWeb','JS',' $lang','$mob',52,'ZOLA',NOW())");
    $ps->execute();
...
<head> 
 ...
 <title>GET Best Free Simple web based pos system <?php echo date("Y"); ?> |eGoZola</title>
  <meta name="description" content="✓ Transform your smartphone into a real free Simple Best web based pos system and inventory system for sale <?php echo date("Y"); ?> and start taking control of your business with an expense app integrated for free with eGoZola. Download it now"/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
  ...
  <div class="col-md-7" >
    <div style="margin-left: 20px">
     ...
     <strong>Hey! Get more business offers, download our Free web based pos system app </strong> <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
      ...
      <div style="text-align: center"> <a href="<?php echo $botUrl?>" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="<?php echo $botUrl?>" style="color: black">
  	    ...
  	    <div style="text-align:center"> <h1>Best Free Simple web based pos system</h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best Free Simple web based pos system and inventory system app, track your salling, Business, your income and all your dailly expenses with free report, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your Business, with our Best Free web based pos system for android device. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ It's free and easy with eGoZola web based pos system and inventory system link all your shop into one and track your dailly income and profit repport.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free web based pos system for sale with budgeting app and extra tools in real time. <a href="<?php echo $botUrl?>" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
