...
<head> 
 ...
 <title>Obtenez toutes les offres recrutement <?php echo date("Y"); ?> ci  |eGoZola</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres recrutement <?php echo date("Y"); ?> ci complet, Téléchargez l'application recrutement <?php echo date("Y"); ?> ci pour un accès sans internet et bien plus encore partout avec ton téléphone"/>
  <meta name="keywords" content="Cherche Emploi, recrutement <?php echo date("Y"); ?> ci "/>
...
<div class="row" style="font-family: Calibri;margin-top: 50px">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1>Obtenez toutes les offres recrutement <?php echo date("Y"); ?> ci</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Recrutement <?php echo date("Y"); ?> ci offre d'emploi: Trouve et Cherche du travaile ou un emploi rapidement en Cote d'ivoire sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez rapidement une offre d’affaire ou recrutement <?php echo date("Y"); ?> ci partout en Cote d'ivoire avec l'application <strong>eGoZola gratuite </strong>
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail sur recrutement <?php echo date("Y"); ?> ci avec votre téléphone sans inernet et gratuit.
