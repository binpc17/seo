...
$ps=$pdo->prepare("SELECT count(DISTINCT mm.score)  AS myRank FROM  scorechallenge mm  INNER JOIN user uu ON mm.idUser=uu.idUser WHERE uu.province='$place' AND  category='$category' AND mm.score>='$scoreMax' ORDER BY mm.score DESC ");
