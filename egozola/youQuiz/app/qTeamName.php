...
$ps=$pdo->prepare("SELECT m.idTeam,cc.nameTeam,m.idUser,cc.photoName FROM qTeamData m  INNER JOIN  qteam cc  ON m.idTeam=cc.idTeam WHERE  m.idUser=? AND cc.dateCreated >$theDate");
//$ps=$pdo->prepare("SELECT m.idTeam,cc.nameTeam,m.idUser,cc.photoName FROM qTeamData m  INNER JOIN  qteam cc  ON m.idTeam=cc.idTeam WHERE  m.idUser=? AND m.dateCreated >$theDate");
