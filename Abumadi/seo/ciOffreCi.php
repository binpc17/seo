...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (225,'ciOffreCi','JS',' $lang','$mob',92,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
  ...
  <title>Recherche emploi? ou une Offre d'emploi en cote d'ivoire <?php echo date("Y") ?>?</title>
  <meta name="description" content="✓ Retrouvez des Ofrres emploi en cote d'ivoire <?php echo date("Y") ?> et Postulez aux d’offres d'emploi ci et d'affaires à Abidjan sans vous déplacer. Télécharger notre application d'emploi ci gratuite"/>
    ...
    <div style="margin-left: 20px;margin-top: 12px">
	 <div style="text-align: center">
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="color: black"><strong>Télécharger & installer nos Outils  <span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu">
          <div style="text-align: center">
            <strong>Pour voir plus des offres d'emplois et d'affaires, téléchargez notre application gratuite </strong> <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
