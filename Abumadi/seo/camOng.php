...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkAyelefRec','JS',' $lang','$mob',706,'JS',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Offre d'emploi & recrutement ong cameroun <?php echo date("Y") ?> eGoZola</title>
  <meta name="description" content="✓ Retrouvez, Postulez aux d’offres d'emploi et recrutement ong cameroun <?php echo date("Y") ?>. Découvrez des toutes les emploi, recrutement ong cameroun et petits travaux autour de vous. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, recrutement ong cameroun <?php echo date("Y") ?>, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri">
	 ...
	 <div style="text-align: center">
        ...
        <div class="row"  style="text-align: center;border-top: 1px solid #ccc" >
          <div class="col-xs-6" style="border-right: 1px solid #ccc">
            <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="color: black">
            <img src="./assets/JS.png" style="width:45px;height:45px" class="img-rounded"  alt="recrutement ong cameroun <?php echo date("Y") ?>"><br>
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Recrutement ong cameroun <?php echo date("Y") ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Recrutement ong cameroun <?php echo date("Y") ?>: Trouve et Cherche travaile, petit travaux ou un emploi, recrutement ong rapidement à Doulala, Yaoundé et partout au cameroun sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une Offre d'emploi et recrutement ong cameroun <?php echo date("Y") ?> avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez une Offre d'emploi ou un recrutement ong cameroun <?php echo date("Y") ?> avec votre téléphone
<br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des Offres d'emploi et recrutement ong cameroun <?php echo date("Y") ?>, des opportuibités d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
