...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'adCarPhil','Abu',' $lang','$mob',65,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <meta name="viewport" content="width=device-width, initial-scale=1"/>
  <title>Looking for Rent or Car for Sale Ayosdito? Find a car </title>
  <meta name="description" content="✓ Find or Get deal or post free car for sale ayosdito ads online <?php echo date("Y") ?>. Find or rent your car or sell your services or your car for unlimited free Ads online. Get it now, download our free eGoZola app"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Post car for sale ayosdito or Quickly find a business or hot deal, services and Free car for sale ayosdito online advertising  near me <?php echo date("Y") ?> everywhere around you with your eGoZola app. Get it for free
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your knowledge, your services or advertising online everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find best deal, post free car for sale ayosdito near me <?php echo date("Y") ?> and business around me and much more. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
