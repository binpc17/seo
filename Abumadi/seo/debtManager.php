...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'debtManager','JS',' $lang','$mob',57,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Best Simple free debt manager app for android & web browser</title>
  <meta name="description" content="✓ Transform your smartphone into a real Simple free best debt manager app and start taking control of your money saving with an expense app integrated. downdload free with eGoZola debt manager."/>
...
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your Business, with our Best free debt manager app. download & Get it now and increase your income or debt in real time, every where yo go.
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free debt manager app for android with budgeting app and extra tools in real time. Get it now for free. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
