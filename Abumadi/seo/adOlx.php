...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'adOlx','JS',' $lang','$mob',71,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>Looking for web sites like olx Near me? Post your Ads for free</title>
  <meta name="description" content="✓ Make deal, Find Business offer or post on free classified web sites like olx , sell your services or your product near me for free on alternative classified websites like olx with your smartphone. Get it now"/>
  <meta name="keywords" content="Cherche Emploi,post free classified like olx, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Post unlimited Ads on our free Classified sites, Find a business or hot deal, services and post free ads on websites like olx advertising near me <?php echo date("Y") ?> everywhere around you with your eGoZola app. Get it for free
