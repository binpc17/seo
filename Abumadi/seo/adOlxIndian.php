...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'adOlxIndian','JS',' $lang','$mob',69,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>Looking for websites like olx in Indian <?php echo date("Y") ?> Near me? Get Free Classified Ads</title>
  <meta name="description" content="✓ Find or Make deal, Business offer or post on free classified websites like olx in Indian, sell your services or your product near me for free on Free Classified ads websites with your smartphone. Get it now, download our free eGoZola app"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get free india classified Ad websites, Post or find a business or hot deal, services and post free ads on websites like olx in Indian advertising near me <?php echo date("Y") ?> everywhere around you with your eGoZola app. Get it for free
