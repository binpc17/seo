...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (50,'ptEsInventarios5','JS',' $lang','$mob',405,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
 ...
 $dataJS="✓ Haz que tu teléfono sea el mejor aplicaciones para comprar y venderonline suas vendas ou compras usando eGoZola app para comprar y vender. Descargue e instale esta aplicación";
	?>
...
<head> 
 ...
 <title>Obtenga gratis Aplicaciones para Comprar y Vender online para android </title>
  <meta name="description" content="✓ Haz que tu teléfono sea el mejor aplicaciones para comprar y venderonline suas vendas ou compras usando eGoZola app para comprar y vender. Descargue e instale esta aplicación"/>
  <meta name="keywords" content="Cherche Emploi, aplicaciones para comprar y venderaplicaciones para comprar y vender, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri">
  ...
  <div class="col-md-7" >
    ...
    <strong>Para más ofertas de trabajo y negocios, descargue gratis aplicaciones para comprar y vender</strong> <strong style="color: darkgreen"> Haga clic aquí↓↓</strong> <br>
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Herramientas<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <div style="margin-top: 30px"></div>
    	    <div style="text-align:center"> <h1>Aplicaciones para Comprar y Vender</h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Obtén lo mejor de forma gratuita aplicaciones para comprar y vender online, rastrea tus Venta diarios gratis, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Toma el control de tus negócios con nuestro aplicaciones para comprar y vender. Pon tu tienda en el teléfono usando nuestro app para comprar y vender. Consiguelo ahora
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Descarga eGoZola, la mejor completa gratis aplicaciones para comprar y vender online, para registrar su producto y vender.  <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black">Consiguelo ahora <strong> Haga clic aquí↓↓ </strong> </a>.
	<br>
			<br>
