...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'Camerspace','JS',' $lang','$mob',4,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Recherche emploi? Camerspace offre d'emploi <?php echo date("Y") ?> à Youndé et Douala</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi <?php echo date("Y") ?> et recrutement Camerspace à Youndé et Douala en ligne. Télécharger notre application Camerspace emlpoi gratuite"/>
  <meta name="keywords" content="Cherche Emploi, camerspace offre d'emploi, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Camerspace offre d'emploi <?php echo date("Y") ?> à Yaoundé, Douala</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Camerspace offre d'emploi: Trouve et Cherche travaile ou un emploi rapidement à Yaoundé, Douala au cameroun sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou Camerspace offre d'emploi <?php echo date("Y") ?> à Yaoundé, Douala et partout au cameroun avec l'application eGoZola Camerspace emploi
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail sur Camerspace offre d'emploi avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Yaoundé, Douala et partout au cameroun. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez Camerspace offre d'emploi <?php echo date("Y") ?> et d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
