...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'Akwajobs','JS',' $lang','$mob',2,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <!-- 100K emploi jeune,
  10K offre d emploi -->
 <title>Recherche emploi? Offre d'emploi Akwajobs <?php echo date("Y") ?> à Youndé et Douala</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d emploi <?php echo date("Y") ?> et recrutement akwajobs à Youndé et Douala en ligne. Télécharger notre application Akwajobs emploi gratuite"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Offres d'emploi Akwajobs <?php echo date("Y") ?> à Yaoundé, Douala</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Akwajobs offre d'emploi <?php echo date("Y") ?>: Trouve et Cherche travaile ou un emploi rapidement à Yaoundé, Douala au cameroun sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou Akwajobs offre d emploi à Yaoundé, Douala et partout au cameroun gràce à l'aplication eGoZola Akwajobs emploi
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail sur Akwajobs <?php echo date("Y") ?> offre d'emploi avec votre téléphone
...
<br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi Akwajobs et d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
