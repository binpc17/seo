...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'jOPen2','JS',' $lang','$mob',18,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>Looking for deal or part-time jobs near me hiring immediately?</title>
  <meta name="description" content="✓ Find or Apply for deal, Business offer or part-time jobs near me hiring immediately with your smart phone. Get it now, download our free eGoZola part-time jobs app finder"/>
  <meta name="keywords" content="Cherche Emploi, part-time jobs near me hiring immediately, part-time jobs near me hiring immediately"/>
...
<div style="text-align:center;margin-top: 10px"> <h1> Find deal, part-time jobs near me hiring immediately <?php echo $cYear ?></h1> </div> 
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Quickly find a business or job offer, services and part-time jobs near me hiring immediately <?php echo $cYear ?> everywhere around you with your eGoZola app. Get it for free
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your knowledge, your services or advertise everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find job offers, part-time jobs near me hiring immediately <?php echo $cYear ?> and business around me and much more. <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
