...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'jsInDouala','JS',' $lang','$mob',15,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<title>Recherche emploi? Retrouvez jobs in cameroon douala <?php echo date("Y") ?> au cameroun</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi, jobs in cameroon douala <?php echo date("Y") ?> et recrutement à Youndé sans vous déplacer. Télécharger notre application jobs in cameroon"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou d'emploi jobs in cameroon douala et partout au cameroun avec jobs eGoZola in cameroon
