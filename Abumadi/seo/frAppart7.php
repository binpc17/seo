...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'frAppart7','HS',' $lang','$mob',89,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Location appartement de particulier a particulier sans agence ile de france?</title>
  <meta name="description" content="✓ Location appartement de particulier a particulier sans agence nimes: Retrouvez ou Publier ton annonce d'appartement ou maison en ligne et retrouvez un locataire en france. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Location appartement de particulier a particulier sans agence ile de france, camerspace offre d'emploi, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <strong>Télécharger l'Application de location appartement de particulier</strong> <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Télécharger & installer nos Outils  <span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        <div class="row"  style="text-align: center;border-top: 1px solid #ccc">
          <div style="margin-bottom: 2px;background-color:slategray;color:white;height: 3px "></div>
          <div class="col-xs-6" style="border-right: 1px solid #ccc" >
            <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black">
...
<div style="text-align:center"> <h1>location appartement de particulier</h1></div>  
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez des offres d'affaires, appartement et mason à faire louer ile de france autour de moi sur eGozola et bien plus encore. Télecharger l'application eGoZola <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> <strong>Cliquer ici↓↓ </strong> </a>.
