...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'Akwajobs','JS',' $lang','$mob',1,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Recherche emploi? Offre d'emploi Akwajobs <?php echo date("Y") ?> à Youndé et Douala</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi <?php echo date("Y") ?> et recrutement akwajobs à Youndé et Douala en ligne. Télécharger notre application d'emploi gratuite"/>
  <meta name="keywords" content="Cherche Emploi, Akwajobs, Offre d'emploi Akwajobs <?php echo date("Y") ?>"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou Akwajobs offre d emploi à Yaoundé, Douala et partout au cameroun avec eGoZola
