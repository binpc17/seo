...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expenseSimple','JS',' $lang','$mob',46,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Best Simple expense tracker app android <?php echo $cYear ?>. Get it Now</title>
  <meta name="description" content="✓ Transform your android smartphone into a free Simple expense tracker app android for your daily spending and start saving your money smartly for free with eGoZola expense app free download."/>
  <meta name="keywords" content="Cherche Emploi, best app for daily expenses, expense tracker app android"/>
	 ...
	 <div style="text-align: center">
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black">
  	    ...
  	    <div style="text-align:center"> <h1>Free Simple expense tracker app <?php echo $cYear ?> </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best Free Simple expense tracker app <?php echo $cYear ?> for android, track your daily spanding with free report, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your money saving, with our best Simple expense tracker app <?php echo $cYear ?> for all your daily expenses record. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete Simple expense tracker app android <?php echo $cYear ?> mobile and extra tools in real time. <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
