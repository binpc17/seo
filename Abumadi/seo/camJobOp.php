...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'jsOp','JS',' $lang','$mob',16,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<title>Retrouvez des job opportunities in douala <?php echo date("Y") ?> au cameroun</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi, des job opportunities in douala <?php echo date("Y") ?> et recrutement à Youndé et partout au cameroun sans vous déplacer. Télécharger notre application job in douala"/>
