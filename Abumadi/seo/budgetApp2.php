...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'budgetApp2','JS',' $lang','$mob',34,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Simple Free best budget app android <?php echo date("Y") ?>, save your money smartly </title>
  <meta name="description" content="✓ Track budget, Transform your smartphone into a real Free best budget app android <?php echo date("Y") ?> and start saving your money smartly for free with eGoZola."/>
    ...
    <div style="margin-left: 20px;margin-top: 12px">
	 <div style="text-align: center">
		   <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="color: black">
                <strong>To Get more job and business offers, download our Free best budget app </strong>  <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
...
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your budget and money saving, with our simple Best Budget app android <?php echo date("Y") ?>. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile budget app android and extra tools in real time. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
