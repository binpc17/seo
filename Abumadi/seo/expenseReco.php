...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expenseReco','JS',' $lang','$mob',44,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Simple expense record app android <?php echo $cYear ?>. Get it Now</title>
  <meta name="description" content="✓ Transform your android smartphone into a real free Simple expense record app android <?php echo $cYear ?> and start saving your money smartly, dowload eGoZola free expense manager app."/>
  <meta name="keywords" content="Cherche Emploi, retail job openings near me, expense record app android"/>
	 ...
	 <div style="text-align: center">
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black">
  	    ...
  	    <div style="text-align:center"> <h1>Best Free Simple expense record app android <?php echo $cYear ?> </h1> </div> 
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete Simple expense record app android mobile and extra tools in real time. <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
