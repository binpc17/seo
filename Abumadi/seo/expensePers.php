...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expensePers','JS',' $lang','$mob',40,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<title>GET Simple Best personal expense tracker app <?php echo $cYear ?> for android </title>
  <meta name="description" content="✓ Transform your android smartphone into a real free personal expense tracker app <?php echo $cYear ?> and start saving your money smartly for free with eGoZola expense tracking app."/>
  <meta name="keywords" content="Cherche Emploi, personal expense tracker app, personal expense tracker app"/>
  ...
  <div class="col-md-7" >
    ...
    <div style="margin-left: 20px;margin-top: 12px">
     ...
     <strong>To Get more job and business offers, download our free Personal expense app </strong> <strong style="color: darkgreen"> Cliquer ici ↓↓ </strong> <br>
  	    ...
  	    <div style="text-align:center"> <h1>Best Personal expense tracker app <?php echo $cYear ?> </h1> </div> 
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete Free simple mobile Best personal expense tracker app and extra tools in real time. <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
