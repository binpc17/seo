...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (50,'ptEsInventarios4','JS',' $lang','$mob',404,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
 ...
 $dataJS="✓ Haz que tu teléfono sea el mejor software de inventario gratis suas vendas, négocio ou compras usando eGoZola app de inventario gratis. Descargue e instale esta aplicación";
	?>
...
<head> 
 ...
 <title>Obtenga software de inventario gratis para android </title>
  <meta name="description" content="✓ Haz que tu teléfono sea el mejor software de inventario gratis suas vendas, négocio ou compras usando eGoZola app de inventario gratis. Descargue e instale esta aplicación"/>
  <meta name="keywords" content="Cherche Emploi, software de inventario gratis, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri">
  ...
  <div class="col-md-7" >
    ...
    <strong>Para más ofertas de trabajo y negocios, descargue gratis software para inventarios y ventas</strong> <strong style="color: darkgreen"> Haga clic aquí↓↓</strong> <br>
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Herramientas<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <div style="margin-top: 30px"></div>
    	    <div style="text-align:center"> <h1>Software de inventario gratis</h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Obtén lo mejor de forma gratuita software de inventario gratis, rastrea tus gastos diarios gratis, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Toma el control de tus negócios con nuestro software de inventario gratis. Pon tu tienda en el teléfono usando nuestro app inventario gratis. Consiguelo ahora
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Descarga eGoZola, la mejor completa software de inventario gratis, para registrar su producto y vender.  <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black">Consiguelo ahora <strong> Haga clic aquí↓↓ </strong> </a>.
	<br>
			<br>
