...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'posOnline','JS',' $lang','$mob',53,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Best Free Simple android pos software <?php echo $cYear ?></title>
  <meta name="description" content="✓ Transform your smartphone into a real free Simple android pos software for sale app <?php echo $cYear ?> and start taking control of your business with an expense app integrated for android pos app with eGoZola."/>
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free android pos software for sale with budgeting app and extra tools in real time. <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
