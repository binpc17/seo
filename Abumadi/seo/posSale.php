...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'posSale','JS',' $lang','$mob',49,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Free Simple pos system for sale app <?php echo $cYear ?>  for android</title>
  <meta name="description" content="✓ Transform your smartphone into a real free Simple pos system for sale app <?php echo $cYear ?>  and start taking control of your business with an expense app integrated for  android pos system with eGoZola."/>
     ...
     <strong>To Get more business offers, download our Free POS System app </strong> <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black">
  	    ...
  	    <div style="text-align:center"> <h1>Best Free Simple pos system for sale <?php echo $cYear ?>  </h1> </div> 
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free pos system for sale with budgeting app and extra tools in real time  <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
