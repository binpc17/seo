...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'rdcHumanitaire','JS',' $lang','$mob',75,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Retrouvez toutes les offres d'emploi humanitaire en rdc <?php echo date("Y") ?>?</title>
  <meta name="description" content="✓ Retrouvez et Postulez à toutes les offres d'emploi humanitaire en rdc <?php echo date("Y") ?> et recrutement en ligne partout en RDC. Télécharger notre application pour les emplois humanitaire"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à kinshasa, Lubumbashi et partout en RDC. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'affaires et toutes les offres d'emploi humanitaire en rdc kinshasa, Goma et Lubumbashi autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
