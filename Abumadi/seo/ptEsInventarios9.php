...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (50,'ptEsInventarios9','JS',' $lang','$mob',409,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
 ...
 $dataJS="✓ Haz que tu teléfono sea el mejor app para organizar gastos y comienza a ahorrar tu dinero gratis usando eGoZola app presupuesto o para organizar gastos. Descargue e instale esta aplicación";
	?>
...
<head> 
 ...
 <title>Obtenga gratis app para Organizar Gastos y presupuesto </title>
  <meta name="description" content="✓ Haz que tu teléfono sea el mejor app para organizar gastos y comienza a ahorrar tu dinero gratis usando eGoZola app presupuesto o para organizar gastos. Descargue e instale esta aplicación"/>
  <meta name="keywords" content="Cherche Emploi, app para organizar gastos, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri">
  ...
  <div class="col-md-7" >
    ...
    <strong>Para más ofertas de trabajo y negocios, descargue gratis app presupuesto</strong> <strong style="color: darkgreen"> Haga clic aquí↓↓</strong> <br>
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Herramientas<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <div style="margin-top: 30px"></div>
    	    <div style="text-align:center"> <h1>App para Organizar Gastos</h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Obtén lo mejor de forma gratuita app para organizar gastos, rastrea tus gastos diarios gratis, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Toma el control de tus negócios con nuestro app para organizar gastos y presupuesto. Pon tu tienda en el teléfono usando nuestro app presupuesto o para organizar gastos. Consiguelo ahora
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Descarga eGoZola, la mejor completa gratis app para organizar gastos o administrar dinero, para registrar su gastos y presupuesto.  <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black">Consiguelo ahora <strong> Haga clic aquí↓↓ </strong> </a>.
	<br>
			<br>
<div style="background-color: #5e5e5e;height: 2px;width: 100%"></div>     
        ...
        <div style="margin-top: 10px"></div>
          <div style="text-align: center">
  <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Para obter mais ofertas de emprego e negócios, faça o download gratuito app para organizar gastos</strong> <strong style="color: darkgreen">Haga clic aquí↓↓</strong> <br>
