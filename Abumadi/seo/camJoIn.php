...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkAyelefRec','JS',' $lang','$mob',708,'JS',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Recherche emploi? Jobinfocamer offres d'emploi et recrutement au cameroun</title>
  <meta name="description" content="✓ Retrouvez, Jobinfocamer offres d'emploi au cameroun <?php echo date("Y") ?> et postulez sans vous déplacer. Découvrez Jobinfocamer emploi et petits travaux autour de vous. Télécharger notre application gratuite"/>

  <meta name="keywords" content="Cherche Emploi, jobinfocamer offres d'emploi, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> jobinfocamer offres d'emploi <?php echo date("Y") ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Jobinfocamer offres d'emploi et recrutement <?php echo date("Y") ?>: Trouve et Cherche travaile, petit travaux ou un emploi rapidement à Doula, Yaoundé et partout au cameroun sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire sur jobinfocamer offres d'emploi au cameroun avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez une Offre d'emploi ou jobinfocamer offres d'emploi <?php echo date("Y") ?> au cameroun avec votre téléphone
<br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez jobinfocamer offres d'emploi cameroun et recrutement <?php echo date("Y") ?>, des opportuibités d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
