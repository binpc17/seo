...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expenseBusin','JS',' $lang','$mob',38,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Simple Best business Expense tracker app <?php echo date("Y") ?> for android</title>
  <meta name="description" content="✓ Transform your android smartphone into a real free best business expense tracker app and start saving your money smartly. download eGoZola the simplest expense tracker app."/>
  <meta name="keywords" content="Cherche Emploi, retail job openings near me, business Expense tracker app <?php echo date("Y") ?>"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <strong>To Get more job and business offers, download our free business expense app </strong>  <strong style="color: darkgreen"> Click here↓↓</strong> <br>
 ...
 <strong>To Get more job and business offers, download our free business expense app </strong>  <strong style="color: darkgreen"> Click here↓↓</strong> <br>
  	    ...
  	    <div style="text-align:center"> <h1>Best business Expense tracker app <?php echo date("Y") ?> </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Free Best business Expense tracker app android, track your dailly spending Expenses with free report, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your money saving, with our Free Best business Expense tracker app. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile Best business Expense tracker app and extra tools in real time.  <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
