...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (225,'ciOffreRecru','JS',' $lang','$mob',97,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
  ...
  <title> Recherche emploi? Boulot ou recrutement <?php echo date("Y") ?> en cote d'ivoire?</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi ci et recrutement <?php echo date("Y") ?> en cote d'ivoire autour de moi avec notre application mobile d'emploi et boulot à Abidjan gratuite"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire un recrutement <?php echo date("Y") ?> en cote d'ivoire ou une Offre d'emploi abidjan et partout Cote d'ivoia avec l'app de recrutement eGoZola gratuite 
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Abidjan et partout en Cote d'ivoir. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez facilement des Offres d'emploi abidjan  ou recrutement <?php echo date("Y") ?> en cote d'ivoire et d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
