...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (212,'MarocUemef','JS',' $lang','$mob',114,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Recherche emploi? ou uemf emploi <?php echo $cYear ?> en Algérie?</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi uemf <?php echo $cYear ?> et recrutement uemf  partout en algériea. Découvrez des emploi uemf et petits travaux autour de vous. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, Offre d'emploi au burkina <?php echo $cYear ?>, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> uemf Offre d'emploi <?php echo $cYear ?></h1> </div> 
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail ou Offre d'emploi uemf <?php echo $cYear ?> avec votre téléphone
<br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des Offres d'emploi uemf <?php echo $cYear ?> et d'affaire  partout en algérie autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
