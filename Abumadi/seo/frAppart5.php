...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'frAppart5','HS',' $lang','$mob',87,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Location appartement de particulier a particulier sans agence martinique?</title>
  <meta name="description" content="✓ Location appartement de particulier a particulier sans agence martinique: Retrouvez ou Publier ton annonce d'appartement ou maison en ligne et retrouvez un locataire à martinique. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Location appartement de particulier a particulier sans agence martinique, camerspace offre d'emploi, Emploi au cameroun"/>
...
<div style="text-align:center"> <h1>location appartement de particulier</h1></div>  
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola l'Application de location appartement de particulier a particulier sans agence martinique: Publier ton annonce, appartement ou maison ou vendez ton savoir et tes services. Retrouvez des partenaires d'affaire avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou ton appartement, maison. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness avec egoZola l'Application de location appartement de particulier a particulier sans agence martinique. 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez des offres d'affaires, appartement et mason à faire louer autour de moi sur eGozola et bien plus encore. Télecharger l'application eGoZola <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> <strong>Cliquer ici↓↓ </strong> </a>.
