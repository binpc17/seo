...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkAyeler','JS',' $lang','$mob',109,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Recherche emploi? sur Ayeler emploi burkina <?php echo date("Y") ?> et à Ouga?</title>
  <meta name="description" content="✓ Retrouvez et Postulez sur Ayeler aux d’offres d'emploi au burkina <?php echo date("Y") ?> et recrutement à Ouga. Découvrez des emplois et petits travaux autour de vous et sur Ayeler. Télécharger l'application gratuite eGoZola"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou Offre d'emploi burkina <?php echo date("Y") ?> à Ouaga avec l'application Ayeler eGoZola. Découvrez Ayeler emploi burkina. Télecharger l'application.
