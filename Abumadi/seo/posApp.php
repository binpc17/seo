...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'posApp','JS',' $lang','$mob',48,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Free Simple free pos system app <?php echo $cYear ?> for android</title>
  <meta name="description" content="✓ Transform your smartphone into a real free Simple free pos system app <?php echo $cYear ?> and start taking control of your business with an expense app integrated for free pos system app with eGoZola."/>
  <meta name="keywords" content="Cherche Emploi, free pos system app <?php echo $cYear ?>, Emploi au cameroun"/>
     ...
     <strong>To Get more business offers, download our Free POS System app </strong> <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black">
  	    ...
  	    <div style="text-align:center"> <h1>Best free pos system app <?php echo $cYear ?> </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best Free pos system app <?php echo $cYear ?>, track your salling, Business, your income and all your dailly expenses with free report and pos system app, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your Business, with our Best Free free pos system app <?php echo $cYear ?> for android device. Get it now and increase your income in real time, every where your profit Inventory.
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free free pos system app with budgeting app and extra tools in real time.  <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
