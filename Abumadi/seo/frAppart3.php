...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'frAppart3','HS',' $lang','$mob',83,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Location appartement de particulier a particulier sans agence lyon?</title>
  <meta name="description" content="✓ Location appartement de particulier a particulier sans agence lyon: Retrouvez ou Publier ton annonce d'appartement ou maison en ligne et retrouvez un locataire à lyon. Télécharger notre application gratuite"/>
