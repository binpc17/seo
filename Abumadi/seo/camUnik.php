...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkAyelefRec','JS',' $lang','$mob',707,'JS',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Recherche emploi? Unikportail cameroun offre d'emploi <?php echo date("Y") ?> |eGoZola</title>
  <meta name="description" content="✓ Retrouvez, Postulez aux d’offres d'emploi sur l'unikportail cameroun offre d'emploi à Youndé, Douala. Découvrez des emploi et petits travaux autour de vous. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, unikportail cameroun offre d'emploi, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Unikportail cameroun offre d'emploi <?php echo date("Y") ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ unikportail cameroun offre d'emploi: Trouve et Cherche travaile, petit travaux ou un emploi rapidement à Doulala, Youndé et partout au cameroun sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une Offre d'emploi sur l'unikportail cameroun offre d'emploi <?php echo date("Y") ?> avec notre l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez une Offre d'emploi ou unikportail cameroun offre d'emploi facile et rapide avec votre téléphone
<br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez unikportail cameroun offre d'emploi et recrutement <?php echo date("Y") ?>, des opportuibités d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
