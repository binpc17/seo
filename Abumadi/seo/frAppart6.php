...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'frAppart6','HS',' $lang','$mob',88,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Location appartement de particulier a particulier sans agence nimes? </title>
  <meta name="description" content="✓ Location appartement de particulier a particulier sans agence nimes: Retrouvez ou Publier ton annonce d'appartement ou maison en ligne et retrouvez un locataire à nimes. Télécharger notre application gratuite"/>
...
<div style="text-align:center"> <h1>location appartement de particulier</h1></div>  
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola l'Application de location appartement de particulier a particulier sans agence nimes: Publier ton annonce, appartement ou maison ou vendez ton savoir et tes services. Retrouvez des partenaires d'affaire avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou ton appartement, maison. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness avec egoZola l'Application de location appartement de particulier a particulier sans agence nimes. 
