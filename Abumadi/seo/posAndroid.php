...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'posAndroid','JS',' $lang','$mob',51,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Free Simple pos and inventory system for android <?php echo $cYear ?></title>
  <meta name="description" content="✓ Transform your smartphone into a real free Simple pos and inventory system for sale <?php echo $cYear ?> and start taking control of your business with an expense app and Simple pos integrated for free with eGoZola. Download it now"/>
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free pos and inventory system for sale with budgeting app and extra tools in real time. <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
