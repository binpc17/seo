...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'jCar','JS',' $lang','$mob',19,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
  ...
  <meta name="description" content="✓ Find or Apply for deal, Business offer or part time careers near me with your smart phone. Get it now, download our free eGoZola fre careers near app"/>
