...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'budgetPersonel','JS',' $lang','$mob',35,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Simple personal accounting software free download full version <?php echo date("Y") ?></title>
  <meta name="description" content="✓ Transform your smartphone into a real private Simple personal accounting software free download <?php echo date("Y") ?> and start saving your expense accounting and money smartly for free on Android with eGoZola."/>
  ...
  <div class="col-md-7" >
    ...
    <div style="margin-left: 20px;margin-top: 12px">
	 <div style="text-align: center">
      ...
      <strong>To Get more job and business offers, download our free Personal Budgeting app </strong> <strong style="color: darkgreen"> Click here↓↓</strong> <br>
...
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your money saving, with our Best Free personal accounting software. Get it now and increase your income in real time with free accounting app, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free Personal accounting software and extra tools for android in real time.  <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
