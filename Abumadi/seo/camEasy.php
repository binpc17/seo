...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'Easy','JS',' $lang','$mob',7,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Easy job cameroun Offre d'emploi <?php echo date("Y") ?> à Youndé et Douala</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi <?php echo date("Y") ?> et recrutement Easy job cameroun à Youndé et Douala. Télécharger notre application Easy job cameroun gratuite"/>
  <meta name="keywords" content="Cherche Emploi, Easy job cameroun, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Offres d'emploi Easy job cameroun <?php echo date("Y") ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Easy job cameroun <?php echo date("Y") ?>: Trouve et Cherche travaile ou un emploi rapidement à Yaoundé, Douala au cameroun sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une offre d'emploi <?php echo date("Y") ?> Easy job cameroun à Yaoundé, Douala et partout au cameroun avec l'application Easy eGoZola au cameroun
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez une offre d'emploi <?php echo date("Y") ?> sur Easy job cameroun avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Yaoundé, Douala et partout au cameroun. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi Easy job cameroun et d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
