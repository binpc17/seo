...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (243,'unicef','JS',' $lang','$mob',9,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<title>Recherche emploi? Offre d'emploi unicef rdc <?php echo date("Y") ?>, Kishasa, Lubumbshi</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’Offre d'emploi unicef rdc et recrutement en ligne partout en RDC, Kinshasa, Goma, Lubumbashi. Télécharger notre application d'emploi unicef gratuite"/>
...
<div style="text-align:center;margin-top: 10px"> <h1> Offre d'emploi unicef rdc <?php echo date("Y") ?> </h1> </div> 
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à kinshasa, Lubumbashi et partout en RDC. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'affaires et Offre d'emploi unicef rdc <?php echo date("Y") ?>, kinshasa, lumbumashi et autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
