...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (50,'ptEsInventarios6','JS',' $lang','$mob',406,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
 ...
 $dataJS="✓ Haz que tu teléfono sea el mejor app control de gastos y comienza a ahorrar tu dinero gratis usando eGoZola app control de gastos y presupuesto. Descargue e instale esta aplicación";
	?>
...
<head> 
 ...
 <title>Obtenga gratis App Control de Gastos para android </title>
  <meta name="description" content="✓ Haz que tu teléfono sea el mejor app control de gastos y comienza a ahorrar tu dinero gratis usando eGoZola app control de gastos y presupuesto. Descargue e instale esta aplicación"/>
  <meta name="keywords" content="Cherche Emploi, aplicaciones para vender productos, Emploi au cameroun"/>
    ...
    <strong>Para más ofertas de trabajo y negocios, descargue gratis presupuesto app</strong> <strong style="color: darkgreen"> Haga clic aquí↓↓</strong> <br>
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Herramientas<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <div style="margin-top: 30px"></div>
    	    <div style="text-align:center"> <h1>App de Control de Gastos</h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Obtén lo mejor de forma gratuita app de control de gastos, rastrea tus gastos diarios gratis, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Toma el control de tus negócios con nuestro app de control de gastos. Pon tu tienda en el teléfono usando nuestro app presupuesto y control de gastos. Consiguelo ahora
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Descarga eGoZola, la mejor completa gratis app de control de gastos, para registrar su gastos y presupuesto.  <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black">Consiguelo ahora <strong> Haga clic aquí↓↓ </strong> </a>.
	<br>
			<br>
