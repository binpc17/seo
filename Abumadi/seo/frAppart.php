...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'frAppart','HS',' $lang','$mob',86,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<title>Location appartement de particulier a particulier sans agence 93?</title>
  <meta name="description" content="✓ Location appartement de particulier a particulier sans agence 93: Retrouvez ou Publier ton annonce, appartement, maison en ligne et retrouvez un partenaire d'affaires. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Location appartement de particulier a particulier sans agence 93, camerspace offre d'emploi, Emploi au cameroun"/>
...
<div style="text-align:center"> <h1>location appartement de particulier</h1></div>  
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola l'Application de location appartement de particulier a particulier sans agence 93: Publier ton annonce, appartement ou maison ou vendez ton savoir et tes services. Retrouvez des partenaires d'affaire avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou ton appartement, maison. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness avec egoZola l'Application de location appartement de particulier a particulier sans agence 93: 
