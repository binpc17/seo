...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (55,'expenseRep','JS',' $lang','$mob',206,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
 ...
 $dataJS="✓ Transforme gratis seu telefone no melhor controle de gastos pessoais app and comece a economizar seu dinheiro de graça usando aplicativo gastos diarios com eGoZola. Gratuito Baixe e instale este aplicativo";
	?>
...
<head> 
 ...
 <title>Aplicativo para controle de gastos pessoais gratis </title>
  <meta name="description" content="✓ Transforme gratis seu telefone no melhor controle de gastos pessoais app and comece a economizar seu dinheiro de graça usando aplicativo gastos diarios com eGoZola. Gratuito Baixe e instale este aplicativo"/>
...
<div class="row" style="font-family: Calibri">
  ...
  <div class="col-md-7" >
    ...
    <strong>Para obter mais ofertas de emprego e negócios, faça o download livre app para controlar gastos  </strong> <strong style="color: darkgreen"> Clique aqui↓↓</strong> <br>
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="color: black"><strong>Baixe nossas ferramentas<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <div style="margin-top: 30px"></div>
    	    <div style="text-align:center"> <h1>App para controle de gastos </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Obtenha o melhor de gratis aplicativo para controle de gastos pessoais gratis, acompanhe suas despesas diárias gratuitamente, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Assuma o controle de suas finanças com nosso aplicativo gastos diarios. Obtenha agora, seja o mestre do seu apps controle de gastos, em qualquer lugar com seu smartphone.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Faça o download do eGoZola, o melhor completo gratuito apps controle de gastos , para registrar suas despesas e receitas.  <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Obtê-lo agora  <strong> Clique aqui ↓↓ </strong> </a>.
	<br>
			<br>
<div style="background-color: #5e5e5e;height: 2px;width: 100%"></div>     
        ...
        <div style="margin-top: 10px"></div>
          <div style="text-align: center">
  <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="color: black"><strong>Para obter mais ofertas de emprego e negócios, faça o download gratuito aplicativo gastos diarios  </strong> <strong style="color: darkgreen"> Clique aqui↓↓</strong> <br>
