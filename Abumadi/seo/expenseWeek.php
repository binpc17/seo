...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expenseWeek','JS',' $lang','$mob',47,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Simple best weekly expense tracker app for android 2021. Get it Now</title>
  <meta name="description" content="✓ Transform your android smartphone into a real free Simple weekly expense tracker app or daily expenses 2021 for android and start saving your money smartly with eGoZola tracking expense app with free download."/>
	 ...
	 <div style="text-align: center">
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Download & install our Tools<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black">
  	    ...
  	    <div style="text-align:center"> <h1>Free weekly expense tracker app <?php echo $cYear ?> </h1> </div> 
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete Simple best weekly expense tracker app record for android mobile and extra tools in real time.  <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
