...
require_once ("./connJS.php");
 ...
 $dataJS="✓ Transforme gratis seu telefone no melhor aplicativo de gastos mensais and comece a economizar seu dinheiro de graça usando aplicativo de gastos mensais financeiro com eGoZola. Gratuito Baixe e instale este aplicativo";
	?>
...
<head> 
 ...
 <title>Obtenha gratuito Aplicativo de Gastos Mensais para android </title>
  <meta name="description" content="✓ Transforme gratis seu telefone no melhor aplicativo de gastos mensais and comece a economizar seu dinheiro de graça usando aplicativo de gastos mensais financeiro com eGoZola. Gratuito Baixe e instale este aplicativo"/>
...
<div class="row" style="font-family: Calibri">
  ...
  <div class="col-md-7" >
    ...
    <strong>Para obter mais ofertas de emprego e negócios, faça o download livre aplicativo de gastos mensais  </strong> <strong style="color: darkgreen"> Clique aqui↓↓</strong> <br>
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="color: black"><strong>Baixe nossas ferramentas<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <div style="margin-top: 30px"></div>
    	    <div style="text-align:center"> <h1>Aplicativo de Gastos Mensais </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Obtenha o melhor de gratis aplicativo de gastos mensais, acompanhe suas despesas diárias gratuitamente, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Assuma o controle de suas finanças com nosso aplicativo de gastos mensais. Obtenha agora, seja o mestre do seu app de gastos mensais, em qualquer lugar com seu smartphone.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Faça o download do eGoZola, o melhor completo gratuito aplicativo de gastos mensais , para registrar suas despesas e receitas.  <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Obtê-lo agora  <strong> Clique aqui ↓↓ </strong> </a>.
	<br>
			<br>
<div style="background-color: #5e5e5e;height: 2px;width: 100%"></div>     
        ...
        <div style="margin-top: 10px"></div>
          <div style="text-align: center">
  <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="color: black"><strong>Para obter mais ofertas de emprego e negócios, faça o download gratuito app de gastos mensais  </strong> <strong style="color: darkgreen"> Clique aqui↓↓</strong> <br>
