...
require_once ("./connJS.php");
 ...
 $dataJS="✓ Transforme gratis seu telefone no melhor app para controlar gastos and comece a economizar seu dinheiro de graça usando aplicativo controle de gastos pessoais com eGoZola. Gratuito Baixe e instale este aplicativo";
	?>
...
<head> 
 ...
 <title>Obtenha gratuito app para controlar gastos</title>
  <meta name="description" content="✓ Transforme gratis seu telefone no melhor app para controlar gastos and comece a economizar seu dinheiro de graça usando aplicativo controle de gastos pessoais com eGoZola. Gratuito Baixe e instale este aplicativo"/>
    ...
    <strong>Para obter mais ofertas de emprego e negócios, faça o download livre app para controlar gastos  </strong> <strong style="color: darkgreen"> Clique aqui↓↓</strong> <br>
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="color: black"><strong>Baixe nossas ferramentas<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <div style="margin-top: 30px"></div>
    	    <div style="text-align:center"> <h1>App para Controlar Gastos <?php echo date("Y") ?> </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Obtenha o melhor de gratis app para controlar gastos, acompanhe suas despesas diárias gratuitamente, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Assuma o controle de suas finanças com nosso app para controlar gastos. Obtenha agora, seja o mestre do seu aplicativo de gastos mensais, em qualquer lugar com seu smartphone.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Faça o download do eGoZola, o melhor completo gratuito app para controlar gastos , para registrar suas despesas e receitas.  <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Obtê-lo agora  <strong> Clique aqui ↓↓ </strong> </a>.
	<br>
			<br>
<div style="background-color: #5e5e5e;height: 2px;width: 100%"></div>     
        ...
        <div style="margin-top: 10px"></div>
          <div style="text-align: center">
  <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="color: black"><strong>Para obter mais ofertas de emprego e negócios, faça o download gratuito app para controlar de gastos  </strong> <strong style="color: darkgreen"> Clique aqui↓↓</strong> <br>
