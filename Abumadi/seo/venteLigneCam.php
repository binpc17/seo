...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'venteLigneCam','SHOP',' $lang','$mob',80,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Recherchez-vous une application de vente en ligne au cameroun? </title>
...
<div style="text-align:center"> <h1>Application de vente en ligne</h1></div>  
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Retrouvez des offres d'affaires autour de moi sur eGozola et bien plus encore. Télecharger l'application eGoZola <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> <strong>Cliquer ici↓↓ </strong> </a>.
