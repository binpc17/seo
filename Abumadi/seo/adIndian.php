...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'adIndian','JS',' $lang','$mob',68,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>Looking for indian free classified sites for ad posting <?php echo date("Y") ?> Near me? Post your Ads</title>
  <meta name="description" content="✓ Find or Make deal, Business offer or post for free in indian free classified sites for ad posting posting sites near me online <?php echo date("Y") ?>, sell your services or your product on indian free classified sites with your smart phone. Download our free eGoZola app"/>
  <meta name="keywords" content="Cherche Emploi, indian free classified sites for ad posting, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Indian free classified sites for ad posting</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get or Post free ads indian free classified sites for ad posting: Are you looking for new deal or Business opportuinity near me? Try ou app eGoZola for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get Indian free classified, post unlimited Ads or find a business or hot deal, services and indian free classified sites for ad posting me online advertising everywhere around you with your eGoZola app. Get it for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ With eGoZola it's easy to find hot deal, services or free ads indian free classified sites for ad posting near me and everywhere you go with your phone
