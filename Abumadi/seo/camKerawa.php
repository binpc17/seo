...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'CamKerawa','JS',' $lang','$mob',6,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
  ...
  <title>Kerawa Offre d'emploi au cameroun <?php echo date("Y") ?> à Youndé et Douala</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi kerawa <?php echo date("Y") ?> et recrutement à Youndé et Douala en ligne. Télécharger notre application Kerawa emploi gratuite"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou Kerawa Offre d'emploi au cameroun <?php echo date("Y") ?> à Yaoundé, Douala avec Kerawa eGoZola emploi app
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Yaoundé, Douala et partout au cameroun. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez Kerawa offres d'emploi <?php echo date("Y") ?> au cameroun et d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
