...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'jobNoExp','JS',' $lang','$mob',32,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>Looking for jobs that require no experience near me <?php echo $cYear ?>? i'ts fast and easy</title>
  <meta name="description" content="✓ Find or Apply for deal, Business offer or jobs that require no experience near me with your smart phone. Get it now, download our free eGoZola jobs no experience app"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Find deal, jobs that require no experience near me <?php echo $cYear ?></h1> </div> 
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Quickly find a business or job offer, services and jobs that require no experience near me <?php echo $cYear ?> everywhere around you with your eGoZola app. Get it for free
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your knowledge, your services or advertise everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find job offers, jobs that require no experience near me <?php echo $cYear ?> and business around me and much more. <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
