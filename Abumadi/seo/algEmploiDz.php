...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (213,'algEmploiDz','JS',' $lang','$mob',103,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<title>Recherche emploi? Retrouvez les sites d'emploi dz <?php echo date("Y") ?> et Petit travaux</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi dz <?php echo date("Y") ?>, petit travaux et d'affaires sur les meileur sites d'emploi en algérie et autour de moi. Découvrez des emploi et petit travaux avec ton téléphone"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez une offre d’affaire ou d'emploi dz <?php echo date("Y") ?> sur les sites d'emploi dz grace à son meilleur application eGoZola
