...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkOnefRec','JS',' $lang','$mob',108,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Recherche emploi? ou Offre d'emploi au burkina Onef recrutement <?php echo date("Y") ?>?</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi au burkina et onef recrutement <?php echo date("Y") ?> à Ouga. Découvrez des emploi onef burkina et petits travaux autour de vous. Télécharger notre application gratuite"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou Offre d'emploi sur onef recrutement <?php echo date("Y") ?> au burkina à Ouaga avec l'application eGoZola onef emploi gratuite
...
<br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des Offres d'emploi au burkina et onef recrutement <?php echo date("Y") ?>, des opportuibités d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
