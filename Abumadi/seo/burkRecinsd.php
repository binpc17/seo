...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkRecinsd','JS',' $lang','$mob',106,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<title>Recherche emploi? Découvrez insd Burkina recrutement <?php echo date("Y") ?> et emploi</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi, insd burkina recrutement <?php echo date("Y") ?>, petit travaux et d'affaires sur les meilleur sites d'emploi insd au burkina faso. Télécharger eGoZola et decouvrez des emploi et petit travaux"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou d'emploi et recrutement insd <?php echo date("Y") ?> sur les sites d'emploi insd Burkina grace à son meilleur application eGoZola
