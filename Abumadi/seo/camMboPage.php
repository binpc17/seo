...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkAyelefRec','JS',' $lang','$mob',705,'JS',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Recherche emploi? mboapages emploi cameroun <?php echo date("Y") ?> |eGoZola</title>
  <meta name="description" content="✓ Retrouvez, Postulez aux d’offres d'emploi, mboapages emploi cameroun <?php echo date("Y") ?>. Découvrez des emploi et petits travaux mboapages emploi cameroun autour de vous. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, mboapages emploi cameroun <?php echo date("Y") ?>, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri">
    ...
    <div style="margin-left: 20px;margin-top: 12px">
	 <div style="text-align: center">
		   <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="color: black">
            <strong>Pour voir plus des offres d'emplois et d'affaires au cameroun, téléchargez notre application gratuite </strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Mboapages emploi cameroun <?php echo date("Y") ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ mboapages emploi cameroun <?php echo date("Y") ?>: Trouve et Cherche travaile, petit travaux ou un emploi rapidement au cameroun sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une Offre d'emploi sur mboapages emploi cameroun à Ouaga Douala et Yauondé avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez une Offre d'emploi ou mboapages emploi cameroun avec votre téléphone
<br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des Offres d'emploi mboapages emploi cameroun et recrutement <?php echo date("Y") ?>, des opportuibités d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
