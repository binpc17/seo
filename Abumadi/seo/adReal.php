...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'adReal','JS',' $lang','$mob',67,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>Looking for free ads posting sites for real estate Near me? Get Free Classified Ads</title>
  <meta name="description" content="✓ Find or Make deal, Business offer or post for free ads posting sites for real estate for sale or fo rent near me online <?php echo date("Y") ?>, sell your services or your real estate product for free on Free Classified ads websites with your smart phone. Get it now"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get free real estate Ads, post or Quickly find a business or hot deal, services and Free free ads posting sites for real estate near me online advertising everywhere around you with your eGoZola app. Get it for free
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your knowledge, your services or advertising online everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find best deal, post for free ads posting sites for real estate for sale or  for rent near me <?php echo date("Y") ?> and business around me and much more. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
