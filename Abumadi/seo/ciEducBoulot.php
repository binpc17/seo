...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (225,'ciEducBoulot','JS',' $lang','$mob',94,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
  ...
  <title>Recherche emploi? ou un Petit Boulot à abidjan et partout en Cote d'ivoir</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi et d'affaires, petit boulot abidjan autour de moi partout en cote d'ivoir. Télécharger notre application de boulot abidjan gratuite"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou de petit boulot abidjan et partout Cote d'ivoir avec l'appli eGoZola pour les petit boulot gratuite
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Abidjan et partout en Cote d'ivoir. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sur Educarriere emploi ci <?php echo date("Y") ?>, télecharger l'application eGoZola et retrouvez facilement des Offres d'emploi et petit boulot abidjan en Cote d'ivoir et d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
