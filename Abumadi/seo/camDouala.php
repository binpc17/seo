...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'jsDouala','JS',' $lang','$mob',13,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Recherche travail? Retrouvez des offres d'emploi à douala <?php echo date("Y") ?> et partout au cameroun </title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi douala <?php echo date("Y") ?> et recrutement partout au cameroun. Télécharger notre application d'emploi à douala gratuite"/>
...
<div class="row" style="font-family: Calibri">
  ...
  <div style="text-align:center;margin-top: 10px"> <h1> Offre d'emploi à douala <?php echo date("Y") ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Offre d'emploi à douala <?php echo date("Y") ?>: Trouve et Cherche travaile ou un emploi rapidement à Yaoundé, Douala au cameroun sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une Offre d'emploi à douala <?php echo date("Y") ?> et partout au cameroun avec eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail ou une offre d'emploi douala <?php echo date("Y") ?> avec votre téléphone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Yaoundé, Douala et partout au cameroun. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi douala <?php echo date("Y") ?> et d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
