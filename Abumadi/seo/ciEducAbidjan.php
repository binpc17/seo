...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (225,'ciEducAbidjan','JS',' $lang','$mob',93,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
  ...
  <title>Recherche emploi abidjan <?php echo date("Y") ?>? et partout en Cote d'ivoire </title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi abidjan <?php echo date("Y") ?>et d'affaires sur educarriere emploi ci en Cote d'ivoire. Télécharger notre application d'emploi gratuite à abidjan"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Abidjan et partout en Cote d'ivoir. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger l'application eGoZola et retrouvez facilement des Offres d'emploi abidjan en Cote d'ivoir et d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
