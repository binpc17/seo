...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expenseRep','JS',' $lang','$mob',39,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Simple expense report app <?php echo $cYear ?> for android</title>
  <meta name="description" content="✓ Transform your android smartphone into a real free Best expense report app <?php echo $cYear ?> and start saving your money smartly for free with eGoZola expense record app free download."/>
  <meta name="keywords" content="Cherche Emploi, retail job openings near me, Simple expense report app"/>
...
<div class="row" style="font-family: Calibri">
  ...
  <div class="col-md-7" >
    ...
    <strong>To Get more job and business offers, download our free expense report app</strong> <strong style="color: darkgreen"> Click here↓↓</strong> <br>
     ...
     <strong>To Get more job and business offers, download our free expense report app</strong> <strong style="color: darkgreen"> Click here↓↓</strong> <br>
  	    ...
  	    <div style="text-align:center"> <h1>Best Free expense report app <?php echo $cYear ?> </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best Free expense report app android, track your dailly spending Expenses with free report, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your money saving, with our Best Free android expense report app. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile expense report app and extra tools in real time.  <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
