...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expenseDayS','JS',' $lang','$mob',33,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Simple Best Daily spending app android <?php echo date("Y") ?>. Get it Now</title>
  <meta name="description" content="✓ Transform your android smartphone into a real free Simple best daily spending app android <?php echo date("Y") ?> and start saving your money smartly with our eGoZola free spending app."/>
  <meta name="keywords" content="Cherche Emploi, best app for daily expenses, Daily spending app"/>
  ...
  <div class="col-md-7" >
    ...
    <div style="margin-left: 20px;margin-top: 12px">
	 <div style="text-align: center">
	  ...
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best Free daily spending app android <?php echo date("Y") ?>, track your daily Expenses with free report spending manager app, 
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete Simple best app for Daily spending app android <?php echo date("Y") ?> mobile and extra tools in real time. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
