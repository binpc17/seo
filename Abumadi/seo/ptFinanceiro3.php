...
<head> 
 ...
 <title>Obtenha melhor app finanças pessoais Gratuito <?php echo $cYear ?> </title>
  <meta name="description" content="✓ Transforme gratis seu telefone no melhor app finanças pessoais gratuito and comece a economizar seu dinheiro de graça usando app para finanças <?php echo $cYear ?> com eGoZola. Gratuito Baixe e instale este aplicativo"/>
...
<div class="row" style="font-family: Calibri">
  ...
  <div class="col-md-7" >
    ...
    <strong>Para obter mais ofertas de emprego e negócios, faça o download livre app para finanças  </strong> <strong style="color: darkgreen"> Clique aqui↓↓</strong> <br>
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Baixe nossas ferramentas<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <div style="margin-top: 30px"></div>
    	    <div style="text-align:center"> <h1>Melhor app finanças pessoais <?php echo $cYear ?></h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Obtenha o melhor de gratis app finanças pessoais, acompanhe suas despesas diárias gratuitamente, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Assuma o controle de suas finanças com nosso app para finanças pessoais. Obtenha agora, seja o mestre do seu aplicativo de organização financeira, em qualquer lugar com seu smartphone.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Faça o download do eGoZola, o melhor completo gratuito aplicativo de finanças pessoais , para registrar suas despesas e receitas.  <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Obtê-lo agora  <strong> Clique aqui ↓↓ </strong> </a>.
	<br>
			<br>
<div style="background-color: #5e5e5e;height: 2px;width: 100%"></div>     
        ...
        <div style="margin-top: 10px"></div>
          <div style="text-align: center">
  <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Para obter mais ofertas de emprego e negócios, faça o download gratuito XXX  </strong> <strong style="color: darkgreen"> Clique aqui↓↓</strong> <br>
