...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkJobEtude','JS',' $lang','$mob',702,'JS',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title> Appartement & maison a louer a ouaga annonces recente <?php echo date("Y") ?> |eGoZola</title>
  <meta name="description" content="✓ Retrouvez toutes les Appartements & maison a louer a ouaga annonces recente burkina <?php echo date("Y") ?>. Publier ou faie louer autour de vous des maison a louer à ouaga annonces recente. Télécharger notre application gratuite"/>
  <meta name="keywords" content="Cherche Emploi, maison a louer a ouaga annonces recente <?php echo date("Y") ?>"/>
...
<div class="row" style="font-family: Calibri">
    ...
    <div style="margin-left: 20px;margin-top: 12px">
	 <div style="text-align: center">
		   <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="color: black">
            <strong>Pour voir plus des maisons et appartement, téléchargez notre application gratuite </strong> <strong style="color: darkgreen"> Cliquer ici↓↓</strong> <br>
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Maison à louer à ouaga annonces recente</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Maison a louer a ouaga annonces recente <?php echo date("Y") ?>: Publier ou recherche un appartement, une maison à louer à ouaga, petits annonces au Burkina sur eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Faire louer ta maison et retrouvez un locateur rapidement et facil à Ougaga et autours de vous  avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola,retrouvez toutes les Maison à louer à ouaga annonces recente <?php echo date("Y") ?> avec votre téléphone
<br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des maison à louer à ouaga annonces recente <?php echo date("Y") ?> et des opportuibités d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
