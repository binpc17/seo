...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (11,'weatherBurk','Tool',' $lang','$mob',704,'WT',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Météo ouagadougou satellite gratuit application android gratuite</title>
  <meta name="description" content="✓ Télécharger la meilleur simple Application météo ouagadougou satellite pour android gratuite, avec coordonées GPS et en bonus une application de gestion dépenses quotidiennes intégrée"/>
  <meta name="keywords" content="Cherche Emploi, météo ouagadougou satellite gratuit"/>  
	 ...
	 <div style="text-align: center">
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="color: black"><strong>Télécharger & installer nos Outils  <span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="color: black">
  	    ...
  	    <div style="text-align:center"> <h1>Météo ouagadougou satellite gratuit</h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Consulter la météo ouagadougou satellite gratuit, méteo pour demain avec la meilleur l'Application android gratuite eGoZola, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Obtenez les prévision météo jusqu'à 15 jours sans internet avec la météo ouagadougou satellite gratuit avec l'Application Méteo france android.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Utiliser le GPS pour une meilleur pécision météo ouagadougou satellite gratuit avec ton téléphone gràce à eGoZola l'Application Météo ouagadougou satellite Burkina gratuite la plus simplifié. Télécharger l'application <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="color: black"> <strong> Cliquer, ici ↓↓ </strong> </a>
		<br>
		<br>
