...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expenseManager','JS',' $lang','$mob',72,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Simple app to Manage Expenses <?php echo date("Y") ?> for android</title>
  <meta name="description" content="✓ Transform your android smartphone into a real free Best app to manage expenses <?php echo $cYear ?> and start saving your money smartly. download for free expenses manage app. get it now"/>
  <meta name="keywords" content="Cherche Emploi, app to Manage Expenses <?php echo date("Y") ?>, Manage Expenses <?php echo $cYear ?>"/>
...
<div class="row" style="font-family: Calibri">
  ...
  <strong>To Get more business offers, download our Free Expenses Manager App </strong> <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
      ...
      <strong>To Get more business offers, download our Free Expenses Manager App</strong> <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
  	    ...
  	    <div style="text-align:center"> <h1>Best Free app to manage expenses <?php echo $cYear ?> </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best Free app to manage expenses, track your dailly spending Expenses with free report, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your money saving, with our Best Free android app to manage expenses. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best Free complete simple mobile app to manage expenses and extra tools in real time. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
