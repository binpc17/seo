...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'budgeApp','JS',' $lang','$mob',38,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Simple Best Free Budgeting apps <?php echo date("Y") ?> for android</title>
  <meta name="description" content="✓ Transform your android smart phone into a real Best Free Budgeting apps and start saving your money smartly. Take control of your budget for free with eGoZola app."/>
  <meta name="keywords" content="Cherche Emploi, Best Free Budgeting apps <?php echo date("Y") ?>, Emploi au cameroun"/>
  ...
  <div class="col-md-7" >
    ...
    <div style="margin-left: 20px;margin-top: 12px">
     ...
     <strong>To Get more job and business offers, download our free Personal Budgeting app </strong> <strong style="color: darkgreen"> Click here↓↓</strong> <br>
  	    ...
  	    <div style="text-align:center"> <h1>Best Free Budgeting apps <?php echo date("Y") ?> </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best android Free Budgeting apps, track your dailly spending Budgeting with free report, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your budget & money saving with our best Free android Budgeting apps <?php echo date("Y") ?>. Get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile Budgeting apps and extra tools in real time.  <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
