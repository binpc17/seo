...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'debtLoan','JS',' $lang','$mob',55,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Best Simple free loan tracker app for android </title>
  <meta name="description" content="✓ Transform your smartphone into a real Simple free best loan tracker app and start taking control of your money saving with an expense app integrated for free with eGoZola loan tracker. Download it now"/>
...
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your Business, with our Best free loan tracker app. Get it now and increase your income in real time, every where your go with a android loan tracker.
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free loan tracker app for android with budgeting app and extra tools in real time. Get it now for free. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
