...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'adCraigs','JS',' $lang','$mob',64,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>Looking for free classified sites like craigslist <?php echo date("Y") ?> near me? Post for free Ads</title>
  <meta name="description" content="✓ Find or Make deal, Get Business offer or post free classified sites like craigslist near me <?php echo date("Y") ?>, sell your services or your product. Post Ads for free classified Ads. Get it now, download our free eGoZola app"/>
  <meta name="keywords" content="Cherche Emploi, free classified sites like craigslist, Emploi au cameroun"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Free classified sites like craigslist <?php echo date("Y") ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get or Post for free classified sites like craigslist: Are you looking for new deal or Business opportuinity near me? Try ou app eGoZola for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get free alternative craigslist sites. Post unlimited Ads or find a business or hot deal, services and post for free classified sites like craigslist online advertising near me <?php echo date("Y") ?> everywhere around you with your eGoZola app. Get it for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ With eGoZola it's easy to find hot deal, services or post free classified sites like craigslist near me and everywhere you go with your phone
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your knowledge, your services or advertising online everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find best deal, post free classified sites like craigslist near me <?php echo date("Y") ?> and business around me and much more. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
