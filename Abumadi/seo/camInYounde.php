...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'jsInYounde','JS',' $lang','$mob',14,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<title>Recherche emploi? Retrouvez jobs in Yaoundé <?php echo date("Y") ?>, Douala au cameroun</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi, jobs in Yaoundé <?php echo date("Y") ?> et recrutement à Youndé et Douala sans vous déplacer. Télécharger notre application jobs in Yaoundé gratuite"/>
