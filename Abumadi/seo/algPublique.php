...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (213,'algPublique','JS',' $lang','$mob',102,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<title>Recherche emploi? Offre emploi algerie fonction publique au tour de moi?</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi algerie fonction publique, petit travaux et d'affaires sur les meiileur sites d'emploi publique ou privée autour de moi. Télécharger notre application et decouvrez des emploi et petit travaux"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez des offres d’affaire, une Offre emploi algerie fonction publique sur les sites d'emploi grace à son meilleur application d'emploi publique et privée eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce autour de moi. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi algerie fonction publique, et meilleurs sites d'emploi et d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
