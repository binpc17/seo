...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expenseDay','JS',' $lang','$mob',45,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Simple best app for daily expenses for android <?php echo date("Y") ?>. Get it Now</title>
  <meta name="description" content="✓ Transform your android smartphone into a real free Simple best app for daily expenses <?php echo date("Y") ?> for android and start saving your money smartly for free our eGoZola daily expenses app."/>
  <meta name="keywords" content="Cherche Emploi, best app for daily expenses, best app for daily expenses"/>
  ...
  <div class="col-md-7" >
    ...
    <div style="margin-left: 20px;margin-top: 12px">
	 <div style="text-align: center">
	  ...
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Get The Best Free app for daily expenses, track your daily spending Expenses with free report. Download it for free , 
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete Simple best app for daily expenses record mobile and extra tools in real time. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
