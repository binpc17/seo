...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'adRent','JS',' $lang','$mob',66,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>Looking for Classified for Rent Near me? Get Free Classified Ads</title>
  <meta name="description" content="✓ Find or Make deal, Business offer or post on free classified for rent near me online <?php echo date("Y") ?>, rent and sell your services or your product for free with your smart phone. Get it now, download our free eGoZola app"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get Free Classified Ads, post or rent and find a business or hot deal, services and Free classified for rent near me online advertising everywhere around you with your eGoZola app. Get it for free
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your knowledge, your services or advertising online everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find best deal, post for free on classified for rent near me <?php echo date("Y") ?> and business around me and much more. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
