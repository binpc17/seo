...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkAyelerAnc','JS',' $lang','$mob',703,'JS',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Ayeler burkina faso petites annonces toutes les offres <?php echo date("Y") ?></title>
  <meta name="description" content="✓ Postulez ou Retrouvez sur ayeler burkina faso petites annonces toutes les offres d'emploi et d'affaires. Découvrez tous les petites annonces d'offre d'emploi et petits travaux autour de vous. Télécharger notre application gratuite"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Ayeler burkina faso petites annonces toutes les offres</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Ayeler burkina faso petites annonces toutes les offres: Trouve et Cherche travaile, petit travaux ou un emploi rapidement à Ouaga et partout au Burkina faso sans vous déplacer sur eGoZola
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile et affaires rapidement sur ayeler burkina faso petites annonces toutes les offres facile et rapide avec votre téléphone
