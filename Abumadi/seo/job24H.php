...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'job24H','JS',' $lang','$mob',23,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<title>Looking for 24 hour jobs near me? i'ts fast and easy</title>
  <meta name="description" content="✓ Find or Apply for deal, Business offer or 24 hour jobs near me with your smart phone. Get it now, download our free eGoZola 24 hour jobs app"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Find deal, 24 hour jobs near me <?php echo $cYear ?></h1> </div> 
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Quickly find a business or job offer, services and 24 hour jobs near me <?php echo $cYear ?> everywhere around you with your eGoZola app. Get it for free
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your knowledge, your services or advertise everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find job offers, 24 hour jobs near me <?php echo $cYear ?> and business around me and much more. <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
