...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'posOffline','JS',' $lang','$mob',54,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Best Simple free offline pos software download for android</title>
  <meta name="description" content="✓ Transform your smartphone into a real Simple free offline pos software download for sale app 2021 and start taking control of your business with an expense app integrated for offline pos software with eGoZola."/>
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free offline pos software downlaod for sale with budgeting app and extra tools in real time. Get it now for free. <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
