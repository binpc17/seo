...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'budgetingSimple','JS',' $lang','$mob',43,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<title>GET Free Simple budgeting app <?php echo date("Y") ?> for android & web browser</title>
  <meta name="description" content="✓ Transform your smartphone into a real private free Simple budgeting app <?php echo date("Y") ?> and start saving your expense & money smartly  with free budget app using eGoZola download for free."/>
  ...
  <div class="col-md-7" >
    ...
    <div style="margin-left: 20px;margin-top: 12px">
	 <div style="text-align: center">
         ...
         <strong>To Get more job and business offers, download our Free Simple budgeting app </strong> <strong style="color: darkgreen"> Click here ↓↓ </strong> <br>
...
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your money saving, with our Best Free Personal Simple budgeting app. Get free buget app and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free Personal Simple budgeting app and extra tools in real time. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
