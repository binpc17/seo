...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (50,'ptEsInventarios2','JS',' $lang','$mob',402,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
 ...
 $dataJS="✓ Haz que tu teléfono sea el mejor gratis programa para control de stock y ventas suas vendas ou compras usando eGoZola app para control de stock y ventas gratis. Descargue e instale esta aplicación";
	?>
...
<head> 
 ...
 <title>Obtenga Programa para Control de Stock y Ventas gratis para android </title>
  <meta name="description" content="✓ Haz que tu teléfono sea el mejor gratis programa para control de stock y ventas suas vendas ou compras usando eGoZola app para control de stock y ventas gratis. Descargue e instale esta aplicación"/>
...
<div class="row" style="font-family: Calibri">
  ...
  <div class="col-md-7" >
    ...
    <strong>Para más ofertas de trabajo y negocios, descargue gratis programa para control de stock y ventas</strong> <strong style="color: darkgreen"> Haga clic aquí↓↓</strong> <br>
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Herramientas<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <div style="margin-top: 30px"></div>
    	    <div style="text-align:center"> <h1>Programa para Control de Stock y Ventas gratis</h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Obtén lo mejor de forma gratuita programa para control de stock y ventas, rastrea tus ventas diarios gratis, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Toma el control de tus negócios con nuestro programa para control de stock y ventas gratis. Pon tu tienda en el teléfono usando nuestro app para control de stock y ventas. Consiguelo ahora
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Descarga eGoZola, la mejor completa gratis programa para control de stock y ventas, para registrar su producto y vender.  <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black">Consiguelo ahora <strong> Haga clic aquí↓↓ </strong> </a>.
	<br>
			<br>
