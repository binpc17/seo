...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (213,'algRec','JS',' $lang','$mob',104,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<title>Recherche emploi? Découvrez les sites d'emploi et recrutement dz <?php echo date("Y") ?> partout en algérie </title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi, petit travaux et d'affaires sur les meiileur sites d'emploi et recrutement dz <?php echo date("Y") ?> en algérie. Télécharger notre application et decouvrez des emploi, recrutement et petit travaux"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou d'emploi et recrutement dz <?php echo date("Y") ?> sur les sites d'emploi et recrutement grace à son meilleur application eGoZola
