...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (213,'algOued','JS',' $lang','$mob',101,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<title>Cherche travail ouedkniss? Retrouvez les sites d'emploi et Petit travaux autour de moi</title>
  <meta name="description" content="✓ Découvrez et Postulez aux d’offres d'emploi, petit travaux sur les meiileur sites d'emploi et travail ouedkniss autour de moi. Télécharger eGoZola et decouvrez des emploi et petit travaux"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez des offres de travail ou d'emplois sur les sites d'emploi ou de travail ouedkniss grace à son meilleur application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce autour de vous. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi, travail ouedkniss et d'autres meilleurs sites d'emploi et d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
