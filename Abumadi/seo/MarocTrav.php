...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (213,'MarocTrav','JS',' $lang','$mob',115,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<title>Découvrez les sites de cherche travail a marrakech et partout en algérie</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi, travail a marrakech et d'affaires sur les meilleur sites de cherche d'emploi et recrutement au Maroc et autour de moi. Découvrez des emploi et petit travaux"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Decouvrez les meilleur sites d'emploi: Trouve et Cherche travaile à marrakech, un emploi ou petit travaux rapidement sans vous déplacer avec l'application eGoZola partout au maroc
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce autour de moi. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'emploi ou travail à marrakech sur le meilleurs sites d'emploi et d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
