...
$cYear=date("Y");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'jOPen','JS',' $lang','$mob',17,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>Looking for job openings near me part-time <?php echo $cYear ?>? i'ts fast and easy</title>
  <meta name="description" content="✓ Find or Apply for deal, Business offer or job openings near me part-time with your smart phone. Get it now, download our free eGoZola job openings app finder"/>
...
<div class="row" style="font-family: Calibri">
  ...
  <div class="col-md-7" >
    ...
    <div style="margin-left: 20px;margin-top: 12px">
	 ...
	 <div style="text-align:center;margin-top: 10px"> <h1> Find deal, job openings near me part-time <?php echo $cYear ?></h1> </div> 

 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get job openings near me part-time <?php echo $cYear ?>: Are you looking for new Jobs, deal or Business opportuinity near me? Try ou app eGoZola for free
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Quickly find a business or job offer, services and job openings near me part-time <?php echo $cYear ?> everywhere around you with your eGoZola app. Get it for free
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Sell ​​your knowledge, your services or advertise everywhere in the world for free. Earn confidential money and quickly develop your business network and Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Download eGoZola and find job offers, job openings near me part-time <?php echo $cYear ?> and business around me and much more. <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Get it now <strong>Click here↓↓ </strong> </a>.
			<br>
			<br>
