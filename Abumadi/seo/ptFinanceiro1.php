...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (55,'expenseRep','JS',' $lang','$mob',201,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
 ...
 $dataJS="✓ Transforme gratis seu telefone no melhor aplicativo para controle financeiro and comece a economizar seu dinheiro de graça usando aplicativo de controle financeiro com eGoZola. Gratuito Baixe e instale este aplicativo";
	?>
...
<head> 
 ...
 <title>Obtenha gratuito aplicativo de controle financeiro para android </title>
  <meta name="description" content="✓ Transforme gratis seu telefone no melhor aplicativo para controle financeiro and comece a economizar seu dinheiro de graça usando aplicativo de controle financeiro com eGoZola. Gratuito Baixe e instale este aplicativo"/>
...
<div class="row" style="font-family: Calibri">
  ...
  <div class="col-md-7" >
    ...
    <strong>Para obter mais ofertas de emprego e negócios, faça o download livre aplicativo para controle financeiro </strong> <strong style="color: darkgreen"> Clique aqui↓↓</strong> <br>
      ...
      <div style="text-align: center"> <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Baixe nossas ferramentas<span class="glyphicon glyphicon-download"></span> </strong>  </a> </div>
        ...
        <div style="margin-top: 30px"></div>
    	    <div style="text-align:center"> <h1>Aplicativo de controle financeiro </h1> </div> 
	  <br><span class="glyphicon glyphicon-play"> </span> ✓ Obtenha o melhor de gratuito aplicativo para controle financeiro, acompanhe suas despesas diárias gratuitamente, 
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Assuma o controle de suas finanças com nosso aplicativo de controle financeiro. Obtenha agora, seja o mestre do seu aplicativo controle financeiro, em qualquer lugar com seu smartphone.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Faça o download do eGoZola, o melhor completo gratuito aplicativo de controle financeiro , para registrar suas despesas e receitas.  <a href="https://egozola.com/GooglePlay.php?apID=old" style="clolor:black"> Obtê-lo agora  <strong> Clique aqui ↓↓ </strong> </a>.
	<br>
			<br>
<div style="background-color: #5e5e5e;height: 2px;width: 100%"></div>     
        ...
        <div style="margin-top: 10px"></div>
          <div style="text-align: center">
  <a href="https://egozola.com/GooglePlay.php?apID=old" style="color: black"><strong>Para obter mais ofertas de emprego e negócios, faça o download gratuito aplicativo controle financeiro  </strong> <strong style="color: darkgreen"> Clique aqui↓↓</strong> <br>
