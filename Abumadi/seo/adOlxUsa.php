...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'adOlxUsa','JS',' $lang','$mob',70,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<title>Looking for websites like olx in usa <?php echo date("Y") ?> Near me? i'ts fast and easy |eGoZola</title>
  <meta name="description" content="✓ Find or Make deal, Business offer or post on free classified websites like olx in usa, sell your services or your product near me for free on free Classified ads websites with your smartphone. Get it now, download our free eGoZola app"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Get free usa websites classified sites. Post or Quickly find a business or hot deal, services and post free ads on websites like olx in usa advertising near me <?php echo date("Y") ?> everywhere around you with your eGoZola app. Get it for free
