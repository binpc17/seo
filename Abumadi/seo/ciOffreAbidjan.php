...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (225,'ciOffreAbidjan','JS',' $lang','$mob',90,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
  ...
  <title>Recherche emploi? ou Offre d'emploi abidjan <?php echo date("Y") ?>? en Cote d'ivoir</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi ci et d'affaires ou Offre d'emploi abidjan <?php echo date("Y") ?>. Télécharger notre application d'emploi ci à abidjan gratuite"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Abidjan et partout en Cote d'ivoir. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez facilement des Offres d'emploi abidjan en Cote d'ivoir et d'affaire autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
