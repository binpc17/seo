...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (243,'jsLushi','JS',' $lang','$mob',11,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Recherche travail? Retrouvez des offres d'emploi lubumbashi <?php echo date("Y") ?></title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi <?php echo date("Y") ?> et recrutement à lubumbashi en ligne partout en RDC. Télécharger eGoZola l'application de recherche d'emploi à lubumbashi"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à kinshasa, Lubumbashi et partout en RDC. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'affaires et Offre d'emploi Lubumbashi <?php echo date("Y") ?>, mediacongo à kinshasa et autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
		<br>
		<br>
