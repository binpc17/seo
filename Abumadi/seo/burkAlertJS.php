...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkAlertJob','JS',' $lang','$mob',700,'JS',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Recherchez-vous emploi? Alerte job burkina eGoZola</title>
  <meta name="description" content="✓ Retrouvez, Postulez aux d’offres d'emploi alerte job burkina <?php echo date("Y") ?> à Ouga. Découvrez des alerte job emploi et petits travaux autour de vous. Télécharger notre application gratuite"/>

  <meta name="keywords" content="Cherche Emploi, Alerte job burkina"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <div style="text-align:center;margin-top: 10px"> <h1> Offre d'emploi Alerte job burkina <?php echo date("Y") ?></h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Alerte job burkina: Trouve et Cherche travaile, petit travaux ou un emploi rapidement à Ouaga et partout au Burkina faso sans vous déplacer avec Alerte job burkina eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou une Offre d'emploi sur Alerte job burkina à Ouaga avec l'application eGoZola
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez une Offre d'emploi et Alerte job burkina avec votre téléphone
