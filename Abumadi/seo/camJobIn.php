...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (237,'Akwajobs','JS',' $lang','$mob',3,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Recherche emploi? Offre d'emploi jobinfocamer <?php echo date("Y") ?> à Youndé et Douala </title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d emploi <?php echo date("Y") ?> et recrutement jobinfocamer à Youndé et Douala en ligne. Télécharger notre application jobinfocamer gratuite"/>
...
<div style="text-align:center;margin-top: 10px"> <h1> Offres d'emploi jobinfocamer <?php echo date("Y") ?> à Yaoundé, Douala</h1> </div> 
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ jobinfocamer offre d'emploi <?php echo date("Y") ?>: Trouve et Cherche travaile ou un emploi rapidement à Yaoundé, Douala au cameroun sans vous déplacer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou jobinfocamer offre d'emploi à Yaoundé, Douala et partout au cameroun avec eGoZola jobinfocamer
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Avec eGoZola, Cherche travaile rapidement et retrouvez un travail sur jobinfocamer <?php echo date("Y") ?> offre d'emploi avec votre téléphone
