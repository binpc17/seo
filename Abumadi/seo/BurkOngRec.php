...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'BurkOngRec','JS',' $lang','$mob',111,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Recherchez-vous un Emploi ou Ong recrutement burkina <?php echo date("Y") ?>?</title>
  <meta name="description" content="✓ Retrouvez et Postulez à toutes les offres d'emploi humanitaire et Ong recrutement burkina <?php echo date("Y") ?> à Ouaga et partout au Burkinafaso. Télécharger notre application eGoZola Ong recrutement"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Trouvez rapidement une offre d’affaire ou toutes les offres d'emploi humanitaire, Ong recrutement burkina avec l'application eGoZola emploi recrutement pour les Ong
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Vendez ton savoir faire, tes services ou annonce à Ouaga et partout au Burkina RDC. Gagnez confidentiellement ton argent et développez rapidement ton réseau d’affaire et du Busness.
    <br> <span class="glyphicon glyphicon-tags"> </span>✓ Télecharger eGoZola et retrouvez des offres d'affaires et toutes les offres d'emploi humanitaire, Ong recrutement burkina <?php echo date("Y") ?> autour de moi et bien plus encore. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Télécharger l'application <strong>Cliquer ici↓↓ </strong> </a>.
