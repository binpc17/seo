...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'budgetSoft','JS',' $lang','$mob',36,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Simple private free Personal budget software <?php echo date("Y") ?> for android</title>
  <meta name="description" content="✓ Transform your smartphone into a real private free Personal budget software apps <?php echo date("Y") ?> and start saving your expense. Download and Get free Personal budget app using with eGoZola."/>
...
<br><span class="glyphicon glyphicon-ok-sign"> </span> ✓ Take control of your money saving, with our Best Free Personal budget software. Get free budget for android, get it now and increase your income in real time, every where your profit Inventory.
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best complete simple mobile free Personal budget software <?php echo date("Y") ?> and extra tools in real time.  <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
