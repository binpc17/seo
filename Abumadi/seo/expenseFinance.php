...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (10,'expenseFinance','JS',' $lang','$mob',42,'Abuma',NOW())");
    $ps->execute( array());
 }else{
	 $mob="Web";
 }
...
<head> 
 ...
 <title>GET Free Simple budgeting app $cYear=date("Y"); for android & web browser</title>
  <meta name="description" content="✓ Transform your smartphone into a real private free Simple budgeting app <?php echo date("Y") ?> and start saving your budget expense, money smartly for free with eGoZola budgeting app. Get it now."/>
  <meta name="keywords" content="Cherche Emploi, free Simple budgeting app <?php echo date("Y") ?>, budgeting app <?php echo date("Y") ?>"/>
...
<br><span class="glyphicon glyphicon-tags"> </span> ✓ Download eGoZola the best Free complete simple mobile finance tracking apps and extra tools in real time. <a href="https://egozola.com/GooglePlay.php?apID=old&page=abu" style="clolor:black"> Get it now  <strong> Click here ↓↓ </strong> </a>.
			<br>
			<br>
