...
require_once ("./connJS.php");
 ...
 if($uDev>0){
	 $mob="Mob";
	 	$ps=$pdoJS->prepare("INSERT INTO webUsers (contryCD,countryN,twn,lng,app,track,track2,dateCreated) VALUES (226,'burkOffre','JS',' $lang','$mob',107,'Abuma',NOW())");
    $ps->execute( array());
 }
 }
	?>
...
<head> 
 ...
 <title>Recherche emploi? ou Offre d'emploi au burkina <?php echo date("Y") ?> et à Ouga?</title>
  <meta name="description" content="✓ Retrouvez et Postulez aux d’offres d'emploi au burkina <?php echo date("Y") ?> et recrutement à Ouga. Découvrez des emploi et petits travaux au burkina & autour de vous. Télécharger notre application gratuite"/>
...
<div class="row" style="font-family: Calibri">
 ...
 <br> <span class="glyphicon glyphicon-tags"> </span>✓ Découvrez et Trouvez rapidement des offres d'Offre d'emploi au burkina <?php echo date("Y") ?> et à Ouaga avec l'application eGoZola emploi
